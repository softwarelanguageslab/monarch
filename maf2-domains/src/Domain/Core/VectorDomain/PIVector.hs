...
instance (Lattice.Joinable i, Lattice.Joinable c) => Lattice.Joinable (PIVector i c bln str rea) where
...
instance (IntDomain i bln str rea, Eq c, Lattice.Joinable c) => VectorDomain (PIVector i c bln str rea) where
