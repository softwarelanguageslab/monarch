...
deriving instance (HMapKey m, ForAll (KeyKind m) (AtKey1 Eq m), ForAll (KeyKind m) (AtKey1 Joinable m), ForAll (KeyKind m) (AtKey1 JoinLattice m)) => JoinLattice (HMapAbs m)

instance (HMapKey m, 
          ForAll k (AtKey1 Eq m), 
          ForAll k (AtKey1 Joinable m), 
          ForAll k (AtKey1 JoinLattice m)) 
