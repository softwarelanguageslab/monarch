...
class (
    ...
    IntDomain      (Abs obj IntPrm) (Abs obj BlnPrm) (Abs obj StrPrm) (Abs obj ReaPrm),
    RealDomain     (Abs obj ReaPrm) (Abs obj BlnPrm) (Abs obj IntPrm),
    StringDomain   (Abs obj StrPrm) (Abs obj BlnPrm) (Abs obj IntPrm) (CP Char),
