...
module ASE.Domain.SymbolicVariable(SymbolicVariable(..), symbolicVariable, adaptModel, discardContext, removeContextPC, removeContextPC', PC, SymbolicCountMap) where
