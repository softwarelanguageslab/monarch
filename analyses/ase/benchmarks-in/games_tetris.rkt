...
(provide
 (contract-out
  ...
  [block=? (-> BLOCK/C BLOCK/C boolean?/c)]
  [block-move (-> real?/c real?/c BLOCK/C  BLOCK/C)]
  ;; bset
  [blocks-contains? (-> BSET/C BLOCK/C boolean?/c)]
  [blocks=? (-> BSET/C BSET/C  boolean?/c)]
  [blocks-subset? (-> BSET/C BSET/C boolean?/c)]
  [blocks-intersect (-> BSET/C BSET/C BSET/C)]
  [blocks-count (-> BSET/C real?/c)]
  [blocks-overflow? (-> BSET/C boolean?/c)]
  [blocks-move (-> real?/c real?/c BSET/C BSET/C)]
  ...
  [full-row? (-> BSET/C real?/c boolean?/c)]
  [blocks-union (-> BSET/C BSET/C BSET/C)]
  [blocks-max-x (-> BSET/C real?/c)]
  [blocks-min-x (-> BSET/C real?/c)]
  [blocks-max-y (-> BSET/C real?/c)]
  ;; elim
  [eliminate-full-rows (-> BSET/C BSET/C)]
  ;; tetras
  [tetra-move (-> integer?/c integer?/c TETRA/C TETRA/C)]
  [tetra-rotate-ccw (-> TETRA/C TETRA/C)]
  [tetra-rotate-cw (-> TETRA/C TETRA/C)]
  [tetra-overlaps-blocks? (-> TETRA/C BSET/C boolean?/c)]
  [build-tetra-blocks (-> COLOR/C real?/c real?/c integer?/c integer?/c integer?/c integer?/c integer?/c integer?/c integer?/c integer?/c TETRA/C)]
  [tetra-change-color (-> TETRA/C COLOR/C TETRA/C)]
  ;; world
  [world-key-move (-> WORLD/C string?/c WORLD/C)]
  [next-world (-> WORLD/C (and/c cons?/c (listof TETRA/C)) WORLD/C)]
