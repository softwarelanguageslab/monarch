                           ...
                           (letrec*
                            ((x8006
                              (letrec*
                               ((x8007
                                 (begin
                                   (write '(funapp 1707 54))
                                   (display "\n")
                                   (cdr l))))
                               (begin
                                 (write '(funapp 1707 64))
                                 (display "\n")
                                 (cdr x8007)))))
                            (begin
                              (write '(funapp 1708 29))
                              (display "\n")
                              (recursive-div2 x8006)))))
                         (begin
                                              ...
                                              (letrec*
                                               ((x8019
                                                 (letrec*
                                                  ((x8020
                                                    (begin
                                                      (write '(funapp 1744 53))
                                                      (display "\n")
                                                      (even-list/c))))
                                                  (begin
                                                    (write '(funapp 1745 45))
                                                    (display "\n")
                                                    (x8020
                                                     j7405
                                                     k7406
