                        ...
                        (if x-cnd7834
                          ...
                          (letrec*
                           ...
                           (begin
                             ...
                             (gcd b x7835)))))))
                     g7833)))
                 (do-something (lambda () (letrec* ((g7836 10)) g7836)))
                 (id
                  (lambda (y)
                    (letrec*
                     ((g7837
                       (begin
                         (write '(funapp 1352 38))
                         (display "\n")
                         (do-something)))
                      (g7838 y))
                     g7838))))
                      ...
                      (letrec*
                       ((x7842
                         (letrec*
                          ((x7843
                            (begin
                              (write '(funapp 1358 49))
                              (display "\n")
                              (a))))
                          (begin
                            (write '(funapp 1358 55))
                            (display "\n")
                            (λ x7843 a)))))
                       (begin
                      ...
                      (letrec*
                       ((x7845
                         (letrec*
                          ((x7846
                            (begin
                              (write '(funapp 1365 49))
                              (display "\n")
                              (b))))
                          (begin
                            (write '(funapp 1365 55))
                            (display "\n")
                            (λ x7846 b)))))
                       (begin
                         (write '(funapp 1366 24))
                         (display "\n")
                         (id x7845)))))
                    (begin
                      (write '(funapp 1367 21))
                      (display "\n")
                      (x7844 #f)))))
                 g7840))))
             g7340))))
