                      ...
                      (if x-cnd7855
                        ...
                        (letrec*
                         ...
                         (begin
                           ...
                           (gcd b x7856)))))))
                   g7854)))
               (do-something (lambda () (letrec* ((g7857 10)) g7857)))
               (id
                (lambda (y)
                  (letrec*
                   ((g7858
                     (begin
                       (write '(funapp 1402 36))
                       (display "\n")
                       (do-something)))
                    (g7859 y))
                   g7859))))
                  ...
                  ((x7862
                    (letrec*
                     ...
                     (begin
                       ...
                       (display "\n")
                       (id x7863)))))
                  (begin (write '(funapp 1410 19)) (display "\n") (x7862 #t))))
                (g7861
                 (letrec*
                  ((x7865
                    (letrec*
                     ((x7866
                       (letrec*
                        ((x7867
                          (begin
                            (write '(funapp 1415 47))
                            (display "\n")
                            (b))))
                        (begin
                          (write '(funapp 1415 53))
                          (display "\n")
                          (λ x7867 b)))))
                     (begin
                       (write '(funapp 1416 22))
                       (display "\n")
                       (id x7866)))))
                  (begin
                    (write '(funapp 1417 19))
                    (display "\n")
                    (x7865 #f)))))
               g7861))))
           g7340))))
