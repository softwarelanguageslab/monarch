                      ...
                      (if x-cnd7853
                        ...
                        (letrec*
                         ...
                         (begin
                           ...
                           (gcd b x7854)))))))
                   g7852)))
               (do-something (lambda () (letrec* ((g7855 10)) g7855)))
               (id
                (lambda (y)
                  (letrec*
                   ((g7856
                     (begin
                       (write '(funapp 1427 36))
                       (display "\n")
                       (do-something)))
                    (g7857 y))
                   g7857))))
                  ...
                  ((x7860
                    (letrec*
                     ...
                     (begin
                       ...
                       (display "\n")
                       (id x7861)))))
                  (begin (write '(funapp 1435 19)) (display "\n") (x7860 #t))))
                (g7859
                 (letrec*
                  ((x7863
                    (letrec*
                     ((x7864
                       (letrec*
                        ((x7865
                          (begin
                            (write '(funapp 1440 47))
                            (display "\n")
                            (b))))
                        (begin
                          (write '(funapp 1440 53))
                          (display "\n")
                          (λ x7865 b)))))
                     (begin
                       (write '(funapp 1441 22))
                       (display "\n")
                       (id x7864)))))
                  (begin
                    (write '(funapp 1442 19))
                    (display "\n")
                    (x7863 #f)))))
               g7859))))
           g7344))))
