                      ...
                      (if x-cnd7973
                        ...
                        (letrec*
                         ...
                         (begin
                           ...
                           (gcd b x7974)))))))
                   g7972)))
               (do-something (lambda () (letrec* ((g7975 10)) g7975)))
               (id
                (lambda (y)
                  (letrec*
                   ((g7976
              ...
              (letrec*
               ((g7978
                 (letrec*
                  ((x7980
                    (begin
                      (write '(funapp 1659 27))
                      (display "\n")
                      (id (lambda (a) (letrec* ((g7981 a)) g7981))))))
                  (begin (write '(funapp 1660 19)) (display "\n") (x7980 #t))))
                (g7979
                 (letrec*
                  ((x7982
                    (begin
                      (write '(funapp 1663 27))
                      (display "\n")
                      (id (lambda (b) (letrec* ((g7983 b)) g7983))))))
                  (begin
                    (write '(funapp 1664 19))
                    (display "\n")
                    (x7982 #f)))))
               g7979))))
           g7421))))
