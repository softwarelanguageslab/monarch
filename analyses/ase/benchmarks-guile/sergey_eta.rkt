                      ...
                      (if x-cnd7880
                        ...
                        (letrec*
                         ...
                         (begin
                           ...
                           (gcd b x7881)))))))
                   g7879)))
               (do-something (lambda () (letrec* ((g7882 10)) g7882)))
               (id
                (lambda (y)
                  (letrec*
                   ((g7883
                    ...
                    (letrec*
                     ((x7888
                       (letrec*
                        ((x7889
                          (begin
                            (write '(funapp 1480 47))
                            (display "\n")
                            (a))))
                        (begin
                          (write '(funapp 1480 53))
                          (display "\n")
                          (λ x7889 a)))))
                     (begin
                       ...
                       (display "\n")
                       (id x7888)))))
                  (begin (write '(funapp 1482 19)) (display "\n") (x7887 #t))))
                (g7886
                 (letrec*
                  ((x7890
                    (letrec*
                       ...
                       (letrec*
                        ((x7892
                          (begin
                            ...
                            (b))))
                        (begin
                          (write '(funapp 1487 53))
                          (display "\n")
                          (λ x7892 b)))))
                     (begin
                       (write '(funapp 1488 22))
                       (display "\n")
                       (id x7891)))))
                  (begin
