                      ...
                      (if x-cnd7996
                        ...
                        (letrec*
                         ...
                         (begin
                           ...
                           (gcd b x7997)))))))
                   g7995)))
               (do-something (lambda () (letrec* ((g7998 10)) g7998)))
               (id
                (lambda (y)
                  (letrec*
                   ((g7999
                     (begin
                       (write '(funapp 1699 36))
                       (display "\n")
                       (do-something)))
                    (g8000 y))
                   g8000))))
                 ...
                 (letrec*
                  ((x8003
                    (begin
                      ...
                      (display "\n")
                      (id (lambda (a) (letrec* ((g8004 a)) g8004))))))
                  (begin (write '(funapp 1704 19)) (display "\n") (x8003 #t))))
                (g8002
                 (letrec*
                  ((x8005
                    (begin
                      ...
                      (display "\n")
                      (id (lambda (b) (letrec* ((g8006 b)) g8006))))))
                  (begin
