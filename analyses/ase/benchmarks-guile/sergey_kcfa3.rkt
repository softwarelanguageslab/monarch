                      ...
                      (x7879
                       (letrec*
                        ...
                        (letrec*
                         ...
                         g7880))))
                     (begin
                       (write '(funapp 1433 22))
                       (display "\n")
                       (λ x7881 x7879))))
                   (x7856
                    (letrec*
                     ((x7877
                       (begin (write '(funapp 1436 30)) (display "\n") (x1)))
                      (x7857
                       (letrec*
                        ((x7873
                          (letrec*
                                 ...
                                 ((x7871
                                  ...
                                  (x7869
                                   (letrec*
                                    ((c
                                      (begin
                                        (write '(funapp 1457 41))
                                        (display "\n")
                                        (f3 #t))))
                                    (letrec*
                                     ((g7870
                                       (begin
                                         (write '(funapp 1458 54))
                                         (display "\n")
                                         (f3 #f))))
                                     g7870))))
                                 (begin
                                    ...
                                    ((x7864
                                      (letrec*
                                       ((x7866
                                        ...
                                        (x7865
                                         (begin
                                           (write '(funapp 1467 60))
                                           (display "\n")
                                           (z x1 x2 x3))))
                                       (begin
                                         (write '(funapp 1468 40))
                                         (display "\n")
                                         (λ x7866 x7865))))
                                     (x7862
                                      (letrec*
                                       ((x7863
                                         (begin
                                           (write '(funapp 1471 48))
                                           (display "\n")
                                           (y1 y2 y3))))
                                       (begin
                                         (write '(funapp 1472 40))
                                         (display "\n")
                                         (λ x7863 y1)))))
                                    (begin
                        ...
                        (begin
                          ...
                          (x7873 x7858)))))
                     (begin
                       (write '(funapp 1478 22))
                       (display "\n")
                       (λ x7877 x7857)))))
                  (begin
                    (write '(funapp 1479 19))
                    (display "\n")
                    (x7878 x7856)))))
               g7855))))
           g7344))))
