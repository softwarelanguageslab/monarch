                 ...
                 ((g7836
                   (letrec*
                    ((x7859
                      (letrec*
                       ((x7862
                         (begin (write '(funapp 1354 32)) (display "\n") (f1)))
                        (x7860
                         (letrec*
                          ((a
                            (begin
                              (write '(funapp 1357 31))
                              (display "\n")
                              (f1 #t))))
                          (letrec*
                           ((g7861
                             (begin
                               (write '(funapp 1358 44))
                               (display "\n")
                               (f1 #f))))
                           g7861))))
                       (begin
                         (write '(funapp 1359 24))
                         (display "\n")
                         (λ x7862 x7860))))
                     (x7837
                      (letrec*
                       ((x7858
                         (begin (write '(funapp 1362 32)) (display "\n") (x1)))
                        (x7838
                         (letrec*
                          ((x7854
                            (letrec*
                              ...
                              (x7855
                               (letrec*
                                ...
                                (letrec*
                                 ((g7856
                                   (begin
                                     (write '(funapp 1371 50))
                                     (display "\n")
                                     (f2 #f))))
                                 g7856))))
                             (begin
                               (write '(funapp 1372 30))
                               (display "\n")
                               (λ x7857 x7855))))
                           (x7839
                            (letrec*
                                   ...
                                   ((x7852
                                    ...
                                    (x7850
                                     (letrec*
                                      ((c
                                        (begin
                                          (write '(funapp 1383 43))
                                          (display "\n")
                                          (f3 #t))))
                                      (letrec*
                                       ((g7851
                                         (begin
                                           (write '(funapp 1384 56))
                                           (display "\n")
                                           (f3 #f))))
                                       g7851))))
                                   (begin
                                     (write '(funapp 1385 36))
                                     (display "\n")
                                     (λ x7852 x7850))))
                                 (x7841
                                  (letrec*
                                      ...
                                      ((x7845
                                        (letrec*
                                         ((x7847
                                          ...
                                          (x7846
                                           (begin
                                             (write '(funapp 1393 62))
                                             (display "\n")
                                             (z x1 x2 x3))))
                                         (begin
                                           (write '(funapp 1394 42))
                                           (display "\n")
                                           (λ x7847 x7846))))
                                       (x7843
                                        (letrec*
                                         ((x7844
                                           (begin
                                             (write '(funapp 1397 50))
                                             (display "\n")
                                             (y1 y2 y3))))
                                         (begin
                                           (write '(funapp 1398 42))
                                           (display "\n")
                                           (λ x7844 y1)))))
                                      (begin
                                        (write '(funapp 1399 39))
                                        (display "\n")
                                        (x7845 x7843)))))
                                   (begin
                                     (write '(funapp 1400 36))
                                     (display "\n")
                                     (λ x7848 x7842)))))
                                (begin
                                  (write '(funapp 1401 33))
                                  (display "\n")
                                  (x7849 x7841)))))
                             (begin
                               (write '(funapp 1402 30))
                               (display "\n")
                               (λ x7853 x7840)))))
                          (begin
                            (write '(funapp 1403 27))
                            (display "\n")
                            (x7854 x7839)))))
                       (begin
                         (write '(funapp 1404 24))
                         (display "\n")
                         (λ x7858 x7838)))))
                    (begin
                      (write '(funapp 1405 21))
                      (display "\n")
                      (x7859 x7837)))))
                 g7836))))
             g7340))))
