               ...
               ((g7850
                 (letrec*
                  ((x7873
                    (letrec*
                     ((x7876
                       (begin (write '(funapp 1420 30)) (display "\n") (f1)))
                      (x7874
                       (letrec*
                        ((a
                          (begin
                            (write '(funapp 1423 29))
                            (display "\n")
                            (f1 #t))))
                        (letrec*
                         ((g7875
                           (begin
                             (write '(funapp 1424 42))
                             (display "\n")
                             (f1 #f))))
                         g7875))))
                     (begin
                         ...
                         (x7853
                          (letrec*
                                    ...
                                    ((x7859
                                      (letrec*
                                       ((x7861
                                        ...
                                        (x7860
                                         (begin
                                           (write '(funapp 1459 60))
                                           (display "\n")
                                           (z x1 x2 x3))))
                                       (begin
                                         (write '(funapp 1460 40))
                                         (display "\n")
                                         (λ x7861 x7860))))
                                     (x7857
                                      (letrec*
                                       ((x7858
                                         (begin
                                           (write '(funapp 1463 48))
                                           (display "\n")
                                           (y1 y2 y3))))
                                       (begin
                                         (write '(funapp 1464 40))
                                         (display "\n")
                                         (λ x7858 y1)))))
                                    (begin
                                      (write '(funapp 1465 37))
                                      (display "\n")
                                      (x7859 x7857)))))
                                 (begin
                           ...
                           (begin
                             ...
                             (λ x7867 x7854)))))
                        (begin
                          (write '(funapp 1469 25))
                          (display "\n")
                          (x7868 x7853)))))
                     (begin
                       (write '(funapp 1470 22))
                       (display "\n")
                       (λ x7872 x7852)))))
                  (begin
                    (write '(funapp 1471 19))
                    (display "\n")
                    (x7873 x7851)))))
               g7850))))
           g7341))))
