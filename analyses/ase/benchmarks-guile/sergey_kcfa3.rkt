               ...
               ((g8156
                 (letrec*
                  ((x8179
                    (letrec*
                     ((x8182
                       (begin (write '(funapp 1476 30)) (display "\n") (f1)))
                      (x8180
                       (letrec*
                        ((a
                          (begin
                            (write '(funapp 1479 29))
                            (display "\n")
                            (f1 #t))))
                        (letrec*
                         ((g8181
                         ...
                         g8181))))
                     (begin
                       (write '(funapp 1481 22))
                       (display "\n")
                       (λ x8182 x8180))))
                   (x8157
                    (letrec*
                     ((x8178
                       (begin (write '(funapp 1484 30)) (display "\n") (x1)))
                      (x8158
                       (letrec*
                        ((x8174
                          (letrec*
                                     ...
                                     (x8163
                                      (letrec*
                                       ...
                                       (begin
                                         ...
                                         (λ x8164 y1)))))
                                    (begin
                                      (write '(funapp 1521 37))
                                      (display "\n")
                                      (x8165 x8163)))))
                                 (begin
                                   (write '(funapp 1522 34))
                                   (display "\n")
                                   (λ x8168 x8162)))))
                              (begin
                        ...
                        (begin
                          ...
                          (x8174 x8159)))))
                     (begin
                       (write '(funapp 1526 22))
                       (display "\n")
                       (λ x8178 x8158)))))
                  (begin
                    (write '(funapp 1527 19))
                    (display "\n")
                    (x8179 x8157)))))
               g8156))))
           g7636))))
