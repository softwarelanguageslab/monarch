                              ...
                              (letrec*
                               ((g7983
                                 (letrec*
                                  ((b
                                    (begin
                                      (write '(funapp 1668 35))
                                      (display "\n")
                                      (f2 #t))))
                                  (letrec*
                                   ((g7984
                                     (begin
                                       (write '(funapp 1669 48))
                                       (display "\n")
                                       (f2 #f))))
                                   g7984))))
                               g7983))
