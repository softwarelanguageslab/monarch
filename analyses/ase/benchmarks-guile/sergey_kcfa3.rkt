                         ...
                         (x7858
                          (letrec*
                                   ...
                                   (letrec*
                                    ((x7864
                                      (letrec*
                                       ((x7866
                                         (begin
                                           (write '(funapp 1468 48))
                                           (display "\n")
                                           (z)))
                                        (x7865
                                         (begin
                                           (write '(funapp 1468 60))
                                           (display "\n")
                                           (z x1 x2 x3))))
                                       (begin
                                         (write '(funapp 1469 40))
                                         (display "\n")
                                         (λ x7866 x7865))))
                                     (x7862
                                      (letrec*
                           ...
                           (begin
                             ...
                             (λ x7872 x7859)))))
                        (begin
                          (write '(funapp 1478 25))
                          (display "\n")
                          (x7873 x7858)))))
                     (begin
                       (write '(funapp 1479 22))
                       (display "\n")
                       (λ x7877 x7857)))))
                  (begin
