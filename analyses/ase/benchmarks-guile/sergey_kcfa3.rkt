               ...
               ((g7857
                 (letrec*
                  ((x7880
                    (letrec*
                     ((x7883
                       (begin (write '(funapp 1404 30)) (display "\n") (f1)))
                      (x7881
                       (letrec*
                        ((a
                          (begin
                            (write '(funapp 1407 29))
                            (display "\n")
                            (f1 #t))))
                        (letrec*
                         ((g7882
                           (begin
                             (write '(funapp 1408 42))
                             (display "\n")
                             (f1 #f))))
                         g7882))))
                     (begin
                       (write '(funapp 1409 22))
                       (display "\n")
                       (λ x7883 x7881))))
                   (x7858
                    (letrec*
                     ((x7879
                       (begin (write '(funapp 1412 30)) (display "\n") (x1)))
                      (x7859
                       (letrec*
                        ((x7875
                          (letrec*
                            ...
                            (x7876
                             (letrec*
                              ...
                              (letrec*
                               ((g7877
                                 (begin
                                   (write '(funapp 1421 48))
                                   (display "\n")
                                   (f2 #f))))
                               g7877))))
                           (begin
                             (write '(funapp 1422 28))
                             (display "\n")
                             (λ x7878 x7876))))
                         (x7860
                          (letrec*
                                  ...
                                  (x7871
                                   (letrec*
                                    ...
                                    (letrec*
                                     ((g7872
                                       (begin
                                         (write '(funapp 1434 54))
                                         (display "\n")
                                         (f3 #f))))
                                     g7872))))
                                 (begin
                                   (write '(funapp 1435 34))
                                   (display "\n")
                                   (λ x7873 x7871))))
                               (x7862
                                (letrec*
                        ...
                        (begin
                          ...
                          (x7875 x7860)))))
                     (begin
                       (write '(funapp 1454 22))
                       (display "\n")
                       (λ x7879 x7859)))))
                  (begin
                    (write '(funapp 1455 19))
                    (display "\n")
                    (x7880 x7858)))))
               g7857))))
           g7340))))
