                     ...
                     (letrec*
                      ((x-cnd8007
                        (begin
                          ...
                          (equal? old t))))
                      (if x-cnd8007
                        (letrec* ((g8008 new)) g8008)
                        (letrec*
                         ((x-cnd8009
                           (begin
                             (write '(funapp 1705 38))
                             (display "\n")
                             (pair? t))))
                         (if x-cnd8009
                           (letrec*
                      ...
                      (parallel
                       (letrec*
                        ((x8020
                                           ...
                                           (letrec*
                                            ((x8024
                                              (letrec*
                                               ((x8027
                                                 (begin
                                                   (write '(funapp 1741 50))
                                                   (display "\n")
                                                   (any?/c j7407 k7408 g7404)))
                                                (x8026
                                                 (begin
                                               ...
                                               (begin
                                                 ...
                                                 (display "\n")
                                                 (f7409 x8027 x8026 x8025)))))
                                            (begin
                                              (write '(funapp 1745 39))
                                              (display "\n")
                                              (any?/c j7407 k7408 x8024)))))
                                         g8023))))
                                    g8022))
                                 xj7402
                                 xk7403
                         ...
                         (x8017 (input)))
                        (begin
                          (write '(funapp 1755 21))
                          (display "\n")
                          (x8020 x8019 x8018 x8017)))))))))
               g8016))))
           g7438))))
       g7421)))
    g7420)))
