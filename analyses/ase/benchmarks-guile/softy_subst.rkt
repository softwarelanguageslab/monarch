                     ...
                     (letrec*
                      ((x-cnd7655
                        (begin
                          (write '(funapp 101 25))
                          (display "\n")
                          ((lambda (v) (letrec* ((g7656 #t)) g7656)) g7544))))
                      (if x-cnd7655
                        g7544
                        (begin
                     ...
                     (letrec*
                      ((x-cnd7658
                        (begin
                          (write '(funapp 110 25))
                          (display "\n")
                          ((lambda (v) (letrec* ((g7659 #t)) g7659)) g7547))))
                      (if x-cnd7658
                        g7547
                        (begin
                     ...
                     (letrec*
                      ((x-cnd8165
                        (begin
                          ...
                          (equal? old t))))
                      (if x-cnd8165
                        (letrec* ((g8166 new)) g8166)
                        (letrec*
                         ((x-cnd8167
                           (begin
                             (write '(funapp 1480 38))
                             (display "\n")
                             (pair? t))))
                         (if x-cnd8167
                           (letrec*
                               ...
                               ((x8171
                                ...
                                (x8169
                                 (letrec*
                                  ((x8170
                                    (begin
                                      (write '(funapp 1491 43))
                                      (display "\n")
                                      (cdr t))))
                                  (begin
                                    (write '(funapp 1492 35))
                                    (display "\n")
                                    (subst* new old x8170)))))
                               (begin
                                 (write '(funapp 1493 32))
                                 (display "\n")
                                 (cons x8171 x8169)))))
                            g8168)
                           (letrec* ((g8173 t)) g8173)))))))
                   g8164))))
              (letrec*
               ((g8174
                 (begin
                                           ...
                                           (letrec*
                                            ((x8182
                                              (letrec*
                                               ((x8185
                                                 (begin
                                                   (write '(funapp 1516 50))
                                                   (display "\n")
                                                   (any?/c j7628 k7629 g7625)))
                                                (x8184
                                                 (begin
                                                   (write '(funapp 1517 50))
                                                   (display "\n")
                                                   (any?/c j7628 k7629 g7626)))
                                                (x8183
                                                 (begin
                                                   (write '(funapp 1518 50))
                                                   (display "\n")
                                                   (any?/c
                                                    j7628
                                                    k7629
                                               ...
                                               (begin
                                                 ...
                                                 (display "\n")
                                                 (f7630 x8185 x8184 x8183)))))
                                            (begin
                                              (write '(funapp 1520 39))
                                              (display "\n")
                                              (any?/c j7628 k7629 x8182)))))
                                         g8181))))
                                    g8180))
                                 xj7623
                                 xk7624
