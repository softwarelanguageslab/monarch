                                 ...
                                 (letrec*
                                  ((x7878
                                    (letrec*
                                     ((x7881
                                       (begin
                                         (write '(funapp 1462 44))
                                         (display "\n")
                                         (any?/c j7334 k7335 g7331)))
                                      (x7880
                                       (begin
                                         (write '(funapp 1463 44))
                                         (display "\n")
                                     ...
                                     (begin
                                       ...
                                       (display "\n")
                                       (f7336 x7881 x7880 x7879)))))
                                  (begin
                                    (write '(funapp 1466 33))
                                    (display "\n")
                                    (any?/c j7334 k7335 x7878)))))
                               g7877))))
                          g7876))
