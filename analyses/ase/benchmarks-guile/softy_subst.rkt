                     ...
                     (letrec*
                      ((x-cnd7989
                        (begin
                          ...
                          (equal? old t))))
                      (if x-cnd7989
                        (letrec* ((g7990 new)) g7990)
                        (letrec*
                         ((x-cnd7991
                           (begin
                             (write '(funapp 1669 38))
                             (display "\n")
                             (pair? t))))
                         (if x-cnd7991
                           (letrec*
                                           ...
                                           (letrec*
                                            ((x8006
                                              (letrec*
                                               ((x8009
                                                 (begin
                                                   (write '(funapp 1705 50))
                                                   (display "\n")
                                                   (any?/c j7402 k7403 g7399)))
                                                (x8008
                                                 (begin
                                                   (write '(funapp 1706 50))
                                                   (display "\n")
                                                   (any?/c j7402 k7403 g7400)))
                                                (x8007
                                                 (begin
                                                   (write '(funapp 1707 50))
                                                   (display "\n")
                                                   (any?/c
                                                    j7402
                                                    k7403
                                               ...
                                               (begin
                                                 ...
                                                 (display "\n")
                                                 (f7404 x8009 x8008 x8007)))))
                                            (begin
                                              (write '(funapp 1709 39))
                                              (display "\n")
                                              (any?/c j7402 k7403 x8006)))))
                                         g8005))))
                                    g8004))
                                 xj7397
                                 xk7398
