                     ...
                     (letrec*
                      ((x-cnd7857
                        (begin
                          ...
                          (equal? old t))))
                      (if x-cnd7857
                        (letrec* ((g7858 new)) g7858)
                        (letrec*
                         ((x-cnd7859
                           (begin
                             (write '(funapp 1424 38))
                             (display "\n")
                             (pair? t))))
                         (if x-cnd7859
                           (letrec*
                                  ...
                                  ((x7873
                                    (letrec*
                                     ((x7876
                                      ...
                                      (x7874
                                       (begin
                                         (write '(funapp 1456 44))
                                         (display "\n")
                                         (any?/c j7331 k7332 g7330))))
                                     (begin
                                       (write '(funapp 1457 36))
                                       (display "\n")
                                       (f7333 x7876 x7875 x7874)))))
                                  (begin
                                    (write '(funapp 1458 33))
                                    (display "\n")
                                    (any?/c j7331 k7332 x7873)))))
                               g7872))))
                          g7871))
