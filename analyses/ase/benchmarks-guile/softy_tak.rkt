                         ...
                         ((x8170
                          ...
                          (x8166
                           (letrec*
                            ((x8167
                              (begin
                                (write '(funapp 1481 51))
                                (display "\n")
                                (- z 1))))
                            (begin
                              (write '(funapp 1481 61))
                              (display "\n")
                              (tak x8167 x y)))))
                         (begin
                           (write '(funapp 1482 26))
                           (display "\n")
                           (tak x8170 x8168 x8166)))
                        z))))
                   g8164))))
              (letrec*
               ((g8172
                                            ...
                                            ((x8180
                                              (letrec*
                                               ...
                                               (begin
                                                 ...
                                                 (display "\n")
                                                 (f7630 x8183 x8182 x8181)))))
                                            (begin
                                              (write '(funapp 1509 39))
                                              (display "\n")
                                              (number?/c j7628 k7629 x8180)))))
                                         g8179))))
                                    g8178))
                                 xj7623
                                 xk7624
