                             ...
                             (letrec*
                              ((x7845
                                (begin
                                  ...
                                  (- z 1))))
                              (begin
                                (write '(funapp 1360 57))
                                (display "\n")
                                (tak x7845 x y)))))
                           (begin
                             (write '(funapp 1361 28))
                             (display "\n")
                             (tak x7848 x7846 x7844)))
                          z))))
                     g7842))))
                (letrec*
                 ((g7850
                                   ...
                                   (letrec*
                                    ((x7857
                                      (letrec*
                                       ((x7860
                                         (begin
                                           (write '(funapp 1377 46))
                                           (display "\n")
                                           (number?/c j7330 k7331 g7327)))
                                        (x7859
                                         (begin
                                           (write '(funapp 1378 46))
                                           (display "\n")
                                           (number?/c j7330 k7331 g7328)))
                                        (x7858
                                         (begin
                                           (write '(funapp 1379 46))
                                           (display "\n")
                                           (number?/c j7330 k7331 g7329))))
                                       (begin
                                         (write '(funapp 1380 38))
                                         (display "\n")
                                         (f7332 x7860 x7859 x7858)))))
                                    (begin
                                      (write '(funapp 1381 35))
                                      (display "\n")
                                      (number?/c j7330 k7331 x7857)))))
                                 g7856))))
                            g7855))
                         (begin
                           (write '(funapp 1384 23))
                           (display "\n")
                           'module)
                         (begin
