                                 ...
                                 (letrec*
                                  ((x7871
                                    (letrec*
                                     ((x7874
                                       (begin
                                         (write '(funapp 1442 44))
                                         (display "\n")
                                         (number?/c j7331 k7332 g7328)))
                                      (x7873
                                       (begin
                                     ...
                                     (begin
                                       ...
                                       (display "\n")
                                       (f7333 x7874 x7873 x7872)))))
                                  (begin
                                    (write '(funapp 1446 33))
                                    (display "\n")
                                    (number?/c j7331 k7332 x7871)))))
                               g7870))))
                          g7869))
                       (begin (write '(funapp 1449 21)) (display "\n") 'module)
                       (begin
