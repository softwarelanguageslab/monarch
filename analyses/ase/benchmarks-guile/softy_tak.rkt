                        ...
                        (letrec*
                         ((x7896
                           (letrec*
                            ((x7897
                              (begin
                                (write '(funapp 1478 51))
                                (display "\n")
                                (- x 1))))
                            (begin
                              (write '(funapp 1478 61))
                              (display "\n")
                              (tak x7897 y z))))
                          (x7894
                           (letrec*
                       ...
                       (letrec*
                        ((x7904
                          (begin
                            ...
                            (loc))))
                        (begin
                          (write '(funapp 1491 49))
                          (display "\n")
                          (cons
                           (begin
                             (write '(funapp 1491 54))
                             (display "\n")
                             'importer)
                           x7904)))))
                     (letrec*
                                  ...
                                  (letrec*
                                   ((g7907
                                     (letrec*
                                        ...
                                        (letrec*
                                         ((x7911
                                           (begin
                                             ...
                                             (display "\n")
                                             (number?/c j7354 k7355 g7351)))
                                          (x7910
                                           (begin
                                             (write '(funapp 1504 48))
                                             (display "\n")
                                             (number?/c j7354 k7355 g7352)))
                                          (x7909
                                           (begin
                                             (write '(funapp 1505 48))
                                             (display "\n")
                                      ...
                                      (begin
                                        (write '(funapp 1507 37))
                                        (display "\n")
                                        (number?/c j7354 k7355 x7908)))))
                                   g7907))))
                              g7906))
                           xj7349
                           xk7350
