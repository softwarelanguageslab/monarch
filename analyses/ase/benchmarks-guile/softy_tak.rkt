                        ...
                        (letrec*
                         ((x7869
                           (letrec*
                            ((x7870
                              (begin
                                (write '(funapp 1407 51))
                                (display "\n")
                                (- x 1))))
                            (begin
                              (write '(funapp 1407 61))
                              (display "\n")
                              (tak x7870 y z))))
                          (x7867
                           (letrec*
                          ...
                          (x7865
                           (letrec*
                            ((x7866
                              (begin
                                (write '(funapp 1409 51))
                                (display "\n")
                                (- z 1))))
                            (begin
                              (write '(funapp 1409 61))
                              (display "\n")
                              (tak x7866 x y)))))
                         (begin
                           (write '(funapp 1410 26))
                           (display "\n")
                           (tak x7869 x7867 x7865)))
                        z))))
                   g7863))))
              (letrec*
               ((g7871
                 (letrec*
                  ((x7875
                                  ...
                                  ((x7878
                                    (letrec*
                                     ((x7881
                                      ...
                                      (x7879
                                       (begin
                                         (write '(funapp 1428 44))
                                         (display "\n")
                                         (number?/c j7330 k7331 g7329))))
                                     (begin
                                       (write '(funapp 1429 36))
                                       (display "\n")
                                       (f7332 x7881 x7880 x7879)))))
                                  (begin
                                    (write '(funapp 1430 33))
                                    (display "\n")
                                    (number?/c j7330 k7331 x7878)))))
                               g7877))))
                          g7876))
                       (begin (write '(funapp 1433 21)) (display "\n") 'module)
                       (begin
                         (write '(funapp 1434 21))
                         (display "\n")
                         'importer)
                       tak)))
                   (x7874 (input))
                   ...
                   (x7872 (input)))
                  (begin
                    (write '(funapp 1439 19))
                    (display "\n")
                    (x7875 x7874 x7873 x7872)))))
               g7871))))
           g7346))))
       g7344)))
    g7343)))
