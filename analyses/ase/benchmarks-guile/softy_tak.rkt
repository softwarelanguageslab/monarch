                        ...
                        (letrec*
                         ((x7989
                           (letrec*
                            ((x7990
                              (begin
                                (write '(funapp 1660 51))
                                (display "\n")
                                (- x 1))))
                            (begin
                              (write '(funapp 1660 61))
                              (display "\n")
                              (tak x7990 y z))))
                          (x7987
                           (letrec*
                          ...
                          (x7985
                           (letrec*
                            ((x7986
                              (begin
                                (write '(funapp 1662 51))
                                (display "\n")
                                (- z 1))))
                            (begin
                              (write '(funapp 1662 61))
                              (display "\n")
                              (tak x7986 x y)))))
                         (begin
                           (write '(funapp 1663 26))
                           (display "\n")
                           (tak x7989 x7987 x7985)))
                        z))))
                   g7983))))
              (letrec*
               ((g7991
                 (begin
                   (write '(funapp 1668 18))
                   (display "\n")
                   (parallel
                    (begin
                      (write '(funapp 1669 19))
                      (display "\n")
                      (parallel
                       (letrec*
                        ((x7995
                          (letrec*
                           ((xj7394
                             (begin
                               (write '(funapp 1673 33))
                               (display "\n")
                               (loc
                                (begin
                                  (write '(funapp 1673 37))
                                  (display "\n")
                                  'module))))
                            (xk7395
                             (begin
                               (write '(funapp 1673 56))
                               (display "\n")
                               (loc
                                (begin
                                  (write '(funapp 1673 60))
                                  (display "\n")
                                  'importer)))))
                           (letrec*
                            ((g7996
                              (begin
                                (write '(funapp 1676 27))
                                (display "\n")
                                                ...
                                                (x8000
                                                 (begin
                                                   ...
                                                   (number?/c
                                                    ...
                                                    g7398))))
                                               (begin
                                                 (write '(funapp 1689 42))
                                                 (display "\n")
                                                 (f7401 x8002 x8001 x8000)))))
                                            (begin
                                              (write '(funapp 1690 39))
                                              (display "\n")
                                              (number?/c j7399 k7400 x7999)))))
                                         g7998))))
                                    g7997))
                                 xj7394
                                 xk7395
                         ...
                         (x7992 (input)))
                        (begin
                          (write '(funapp 1700 21))
                          (display "\n")
                          (x7995 x7994 x7993 x7992)))))))))
               g7991))))
           g7429))))
       g7413)))
    g7412)))
