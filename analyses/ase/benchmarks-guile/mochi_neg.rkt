             ...
             (letrec*
              ((empty (begin (write '(funapp 104 22)) (display "\n") '()))
               ...
               (g
                (lambda (x)
                  (letrec*
                   ((g8005 (lambda (_) (letrec* ((g8006 x)) g8006))))
                   g8005)))
               (twice
                (lambda (f x y)
                  (letrec*
              ...
              (letrec*
               ((g8016
                 (begin
                   (write '(funapp 1731 18))
                   (display "\n")
                   (parallel
                    (begin
                      (write '(funapp 1732 19))
                      (display "\n")
                      (parallel
                       (letrec*
                        ((x8018
                          (letrec*
                           ((xj7402
                             (begin
                               (write '(funapp 1736 33))
                               (display "\n")
                               (loc
                                (begin
                                  (write '(funapp 1736 37))
                                  (display "\n")
                                  'module))))
                            (xk7403
                             (begin
                               ...
                               (loc
                                (begin
                                  (write '(funapp 1736 60))
                                  (display "\n")
                                  'importer)))))
                           (letrec*
                            ((g8019
                              (begin
                                (write '(funapp 1739 27))
                                (display "\n")
                                           ...
                                           (letrec*
                                            ((x8024
                                              (letrec*
                                               ((x8025
                                                 (begin
                                                   (write '(funapp 1748 50))
                                                   (display "\n")
                                                   (>=/c 0))))
                                               (begin
                                                 (write '(funapp 1749 42))
                                                 (display "\n")
                                                 (and/c integer?/c x8025))))
                                             (x8022
                                              (letrec*
                                               ((x8023
                                                 (begin
