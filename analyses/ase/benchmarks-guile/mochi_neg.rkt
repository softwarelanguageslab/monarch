                    ...
                    (letrec*
                     ((g7840
                       (letrec*
                        ((x7841
                          (begin
                            (write '(funapp 1352 47))
                            (display "\n")
                            (_))))
                        (begin
                          (write '(funapp 1352 53))
                          (display "\n")
                          (λ x7841 x)))))
                     g7840)))
                 (twice
                  ...
                  (lambda (x)
                    (letrec*
                     ((g7845
                       (letrec*
                        ((x7848
                          (begin (write '(funapp 1367 33)) (display "\n") (_)))
                         (x7846
                          (letrec*
                           ((x7847
                             (begin
                               (write '(funapp 1368 50))
                               (display "\n")
                               (x #f))))
                           (begin
                       ...
                       (letrec*
                        ...
                        (if x-cnd7850
                          (letrec*
                           ((x7851
                             (begin
                               (write '(funapp 1378 44))
                               (display "\n")
                               (g n))))
                           (begin
                             (write '(funapp 1378 52))
                             (display "\n")
                             (twice
                              neg
                              x7851
                              (begin
                                (write '(funapp 1378 68))
                                (display "\n")
                                'unit))))
                          42))))
                     g7849))))
                                   ...
                                   (letrec*
                                    ((x7859
                                      (letrec*
                                       ((x7860
                                         (begin
                                           (write '(funapp 1394 46))
                                           (display "\n")
                                           (>=/c 0))))
                                       (begin
                                         (write '(funapp 1395 38))
                                         (display "\n")
                                         (and/c integer?/c x7860))))
                                     (x7857
                                      (letrec*
                                       ((x7858
                                         (begin
                                           (write '(funapp 1398 46))
                                           (display "\n")
                                           (integer?/c j7328 k7329 g7327))))
                                       (begin
                                         (write '(funapp 1399 38))
                                         (display "\n")
                                         (f7330 x7858)))))
                                    (begin
                                      (write '(funapp 1400 35))
                                      (display "\n")
                                      (x7859 j7328 k7329 x7857)))))
                                 g7856))))
                            g7855))
                         (begin
