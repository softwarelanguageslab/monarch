                ...
                (lambda (x)
                  (letrec*
                   ((g7854
                     (letrec*
                      ((x7855
                        (begin (write '(funapp 1418 45)) (display "\n") (_))))
                      (begin
                        ...
                        (letrec*
                         ((x7858
                           (begin
                             ...
                             (f x))))
                         (begin
                           (write '(funapp 1425 56))
                           (display "\n")
                           (f x7858)))))
                      (begin
                        (write '(funapp 1426 23))
                        (display "\n")
                        (x7857 y)))))
                   g7856)))
               (neg
                (lambda (x)
                  (letrec*
                   ((g7859
                     (letrec*
                      ((x7862
                        (begin (write '(funapp 1433 31)) (display "\n") (_)))
                       (x7860
                        (letrec*
                         ((x7861
                           (begin
                                  ...
                                  ((x7873
                                    (letrec*
                                     ...
                                     (begin
                                       ...
                                       (display "\n")
                                       (and/c integer?/c x7874))))
                                   (x7871
                                    (letrec*
                                     ((x7872
                                       (begin
                                         (write '(funapp 1464 44))
                                         (display "\n")
                                         (integer?/c j7329 k7330 g7328))))
                                     (begin
                                       (write '(funapp 1465 36))
                                       (display "\n")
                                       (f7331 x7872)))))
                                  (begin
                                    (write '(funapp 1466 33))
                                    (display "\n")
                                    (x7873 j7329 k7330 x7871)))))
                               g7870))))
                          g7869))
                       (begin (write '(funapp 1469 21)) (display "\n") 'module)
                       (begin
