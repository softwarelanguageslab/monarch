                ...
                (lambda (x)
                  (letrec*
                   ((g8162
                     (letrec*
                      ((x8163
                        (begin (write '(funapp 1474 45)) (display "\n") (_))))
                      (begin
                        (write '(funapp 1474 51))
                        (display "\n")
                        (λ x8163 x)))))
                   g8162)))
               (twice
                ...
                (lambda (x)
                  (letrec*
                   ((g8167
                     (letrec*
                      ((x8170
                        (begin (write '(funapp 1489 31)) (display "\n") (_)))
                       (x8168
                        (letrec*
                         ((x8169
                           (begin
                        ...
                        (letrec*
                         ((x8173
                           (begin
                             ...
                             (g n))))
                         (begin
                           (write '(funapp 1500 50))
                           (display "\n")
                           (twice
                            neg
                            x8173
                            (begin
                              (write '(funapp 1500 66))
                              (display "\n")
                              'unit))))
                        42))))
                   g8171))))
                           ...
                           ((xj7623
                            ...
                            (xk7624
                             (begin
                               ...
                               (loc
                                (begin
                                  (write '(funapp 1510 60))
                                  (display "\n")
                                  'importer)))))
                           (letrec*
                            ((g8177
                              (begin
                                (write '(funapp 1513 27))
                                (display "\n")
                                           ...
                                           (letrec*
                                            ((x8182
                                              (letrec*
                                               ((x8183
                                                 (begin
                                                   (write '(funapp 1522 50))
                                                   (display "\n")
                                                   (>=/c 0))))
                                               (begin
                                                 (write '(funapp 1523 42))
                                                 (display "\n")
                                                 (and/c integer?/c x8183))))
                                             (x8180
                                              (letrec*
                                               ((x8181
                                                 (begin
                                                   (write '(funapp 1527 44))
                                                   (display "\n")
                                                   (integer?/c
                                                    j7626
                                                    k7627
                                                    g7625))))
                                               (begin
                                                 (write '(funapp 1528 42))
                                                 (display "\n")
                                                 (f7628 x8181)))))
                                            (begin
                                              (write '(funapp 1529 39))
                                              (display "\n")
                                              (x8182 j7626 k7627 x8180)))))
                                         g8179))))
                                    g8178))
                                 xj7623
                                 xk7624
