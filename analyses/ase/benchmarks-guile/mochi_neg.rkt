                  ...
                  ((x7902
                    (letrec*
                     ((xj7349
                      ...
                      (xk7350
                       (begin
                         (write '(funapp 1508 54))
                         (display "\n")
                         (loc
                          (begin
                            (write '(funapp 1508 58))
                            (display "\n")
                            'importer)))))
                     (letrec*
                      ((g7903
                        (begin
                          (write '(funapp 1511 25))
                          (display "\n")
                                      ...
                                      ((x7908
                                       ...
                                       (x7906
                                        (letrec*
                                         ...
                                         (begin
                                           (write '(funapp 1525 40))
                                           (display "\n")
                                           (f7354 x7907)))))
                                      (begin
                                        (write '(funapp 1526 37))
                                        (display "\n")
                                        (x7908 j7352 k7353 x7906)))))
                                   g7905))))
                              g7904))
                           xj7349
                           xk7350
