             ...
             (letrec*
              ((empty (begin (write '(funapp 104 22)) (display "\n") '()))
               ...
               (g
                (lambda (x)
                  (letrec*
                   ((g8004 (lambda (_) (letrec* ((g8005 x)) g8005))))
                   g8004)))
               (twice
                (lambda (f x y)
                  (letrec*
              ...
              (letrec*
               ((g8015
                 (begin
                   (write '(funapp 1730 18))
                   (display "\n")
                   (parallel
                    (begin
                      (write '(funapp 1731 19))
                      (display "\n")
                      (parallel
                       (letrec*
                        ((x8017
                           ...
                           ((xj7402
                            ...
                            (xk7403
                             (begin
                               ...
                               (loc
                                (begin
                                  (write '(funapp 1735 60))
                                  (display "\n")
                                  'importer)))))
                           (letrec*
                            ((g8018
                              (begin
                                (write '(funapp 1738 27))
                                (display "\n")
                                           ...
                                           (letrec*
                                            ((x8023
                                              (letrec*
                                               ((x8024
                                                 (begin
                                                   (write '(funapp 1747 50))
                                                   (display "\n")
                                                   (>=/c 0))))
                                               (begin
                                                 (write '(funapp 1748 42))
                                                 (display "\n")
                                                 (and/c integer?/c x8024))))
                                             (x8021
                                              (letrec*
                                               ((x8022
                                                 (begin
