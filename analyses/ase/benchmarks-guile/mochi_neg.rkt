             ...
             (letrec*
              ((empty (begin (write '(funapp 104 22)) (display "\n") '()))
               ...
               (g
                (lambda (x)
                  (letrec*
                   ((g8003 (lambda (_) (letrec* ((g8004 x)) g8004))))
                   g8003)))
               (twice
                (lambda (f x y)
                  (letrec*
                        ...
                        (letrec*
                         ((x8013
                           (begin
                             ...
                             (g n))))
                         (begin
                           (write '(funapp 1724 50))
                           (display "\n")
                           (twice
                            neg
                            x8013
                            (begin
                              (write '(funapp 1724 66))
                              (display "\n")
                              'unit))))
                        42))))
                   g8011))))
