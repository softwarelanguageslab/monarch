             ...
             (letrec*
              ((empty (begin (write '(funapp 99 22)) (display "\n") '()))
               ...
               (g
                (lambda (x)
                  (letrec*
                   ((g7981 (lambda (_) (letrec* ((g7982 x)) g7982))))
                   g7981)))
               (twice
                (lambda (f x y)
                  (letrec*
                        ...
                        (letrec*
                         ((x7985
                           (begin
                             ...
                             (f x))))
                         (begin
                           (write '(funapp 1662 56))
                           (display "\n")
                           (f x7985)))))
                      (begin
                        (write '(funapp 1663 23))
                        (display "\n")
                        (x7984 y)))))
                   g7983)))
               (neg
