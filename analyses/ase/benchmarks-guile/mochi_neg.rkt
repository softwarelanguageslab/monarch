                ...
                (lambda (x)
                  (letrec*
                   ((g7861
                     (letrec*
                      ((x7862
                        (begin (write '(funapp 1402 45)) (display "\n") (_))))
                      (begin
                ...
                (lambda (x)
                  (letrec*
                   ((g7866
                     (letrec*
                      ((x7869
                        (begin (write '(funapp 1417 31)) (display "\n") (_)))
                       (x7867
                        (letrec*
                         ((x7868
                           (begin
                             (write '(funapp 1418 48))
                             (display "\n")
                             (x #f))))
                         (begin
                     ...
                     (letrec*
                      ...
                      (if x-cnd7871
                        (letrec*
                         ((x7872
                           (begin
                             (write '(funapp 1428 42))
                             (display "\n")
                             (g n))))
                         (begin
                           (write '(funapp 1428 50))
                           (display "\n")
                           (twice
                            neg
                            x7872
                                  ...
                                  ((x7880
                                    (letrec*
                                     ...
                                     (begin
                                       ...
                                       (display "\n")
                                       (and/c integer?/c x7881))))
                                   (x7878
                                    (letrec*
                                     ((x7879
                                       (begin
                                         (write '(funapp 1448 44))
                                         (display "\n")
