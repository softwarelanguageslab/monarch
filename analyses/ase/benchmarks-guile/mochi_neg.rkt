                ...
                (lambda (x)
                  (letrec*
                   ((g7859
                     (letrec*
                      ((x7860
                        (begin (write '(funapp 1426 45)) (display "\n") (_))))
                      (begin
                ...
                (lambda (x)
                  (letrec*
                   ((g7864
                     (letrec*
                      ((x7867
                        (begin (write '(funapp 1441 31)) (display "\n") (_)))
                       (x7865
                        (letrec*
                         ((x7866
                           (begin
                                  ...
                                  ((x7878
                                    (letrec*
                                     ...
                                     (begin
                                       ...
                                       (display "\n")
                                       (and/c integer?/c x7879))))
                                   (x7876
                                    (letrec*
                                     ((x7877
                                       (begin
                                         (write '(funapp 1472 44))
                                         (display "\n")
                                         (integer?/c j7332 k7333 g7331))))
                                     (begin
                                       (write '(funapp 1473 36))
                                       (display "\n")
                                       (f7334 x7877)))))
                                  (begin
                                    (write '(funapp 1474 33))
                                    (display "\n")
                                    (x7878 j7332 k7333 x7876)))))
                               g7875))))
                          g7874))
                       (begin (write '(funapp 1477 21)) (display "\n") 'module)
                       (begin
