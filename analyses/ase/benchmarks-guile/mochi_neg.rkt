                ...
                (lambda (x)
                  (letrec*
                   ((g7888
                     (letrec*
                      ((x7889
                        (begin (write '(funapp 1473 45)) (display "\n") (_))))
                      (begin
                ...
                (lambda (x)
                  (letrec*
                   ((g7893
                     (letrec*
                      ((x7896
                        (begin (write '(funapp 1488 31)) (display "\n") (_)))
                       (x7894
                        (letrec*
                         ((x7895
                           (begin
                     ...
                     ((xj7349
                      ...
                      (xk7350
                       (letrec*
                        ((x7904
                          (begin
                            (write '(funapp 1509 41))
                            (display "\n")
                            (loc))))
                        (begin
                          (write '(funapp 1509 49))
                          (display "\n")
                          (cons
                           (begin
                             (write '(funapp 1509 54))
                             (display "\n")
                             'importer)
                           x7904)))))
                     (letrec*
