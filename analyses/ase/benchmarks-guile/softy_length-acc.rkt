                               ...
                               ((g7870
                                 (letrec*
                                    ...
                                    (letrec*
                                     ((x7875
                                       (begin
                                         ...
                                         (>=/c 0))))
                                     (begin
                                       (write '(funapp 1426 36))
                                       (display "\n")
                                       (and/c integer?/c x7875))))
                                   (x7871
                                    (letrec*
                                     ((x7872
                                       (letrec*
                                        ((x7873
                                          (begin
                                            ...
                                            (listof any/c))))
                                        (begin
                                          (write '(funapp 1432 39))
                                          (display "\n")
                                          (x7873 j7328 k7329 g7327)))))
                                     (begin
                                  ...
                                  (begin
                                    ...
                                    (display "\n")
                                    (x7874 j7328 k7329 x7871)))))
                               g7870))))
                          g7869))
                       (begin (write '(funapp 1437 21)) (display "\n") 'module)
                       (begin
