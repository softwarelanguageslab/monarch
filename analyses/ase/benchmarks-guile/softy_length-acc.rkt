                                    ...
                                    (letrec*
                                     ((x7870
                                       (letrec*
                                        ((x7871
                                          (begin
                                            (write '(funapp 1456 47))
                                            (display "\n")
                                            (listof any/c))))
                                        (begin
                                          (write '(funapp 1457 39))
                                          (display "\n")
                                          (x7871 j7332 k7333 g7331)))))
                                     (begin
                                       (write '(funapp 1458 36))
                                       (display "\n")
                                       (f7334 x7870)))))
                                  (begin
                                    (write '(funapp 1459 33))
                                    (display "\n")
                                    (x7872 j7332 k7333 x7869)))))
                               g7868))))
                          g7867))
                       (begin (write '(funapp 1462 21)) (display "\n") 'module)
                       (begin
