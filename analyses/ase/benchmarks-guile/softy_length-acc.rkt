            ...
            (g7427
             (letrec*
              ...
              (letrec*
               ((g7986
                 (begin
                   (write '(funapp 1667 18))
                   (display "\n")
                   (parallel
                    (begin
                      (write '(funapp 1668 19))
                      (display "\n")
                      (parallel
                       (letrec*
                        ((x7988
                          (letrec*
                           ((xj7394
                            ...
                            (xk7395
                             (begin
                               (write '(funapp 1672 56))
                               (display "\n")
                               (loc
                                (begin
                                  (write '(funapp 1672 60))
                                  (display "\n")
                                  'importer)))))
                           (letrec*
                            ((g7989
                              (begin
                                (write '(funapp 1675 27))
                                (display "\n")
                                              ...
                                              (letrec*
                                               ((x7996
                                                 (begin
                                                   ...
                                                   (>=/c 0))))
                                               (begin
                                                 (write '(funapp 1685 42))
                                                 (display "\n")
                                                 (and/c integer?/c x7996))))
                                             (x7992
                                              (letrec*
                                               ((x7993
                                                 (letrec*
                                                  ((x7994
                                                    (begin
                                                      (write '(funapp 1690 53))
                                                      (display "\n")
                                                      (listof any/c))))
                                                  (begin
                                                    (write '(funapp 1691 45))
                                                    (display "\n")
                                                    (x7994
                                                     j7397
                                                     k7398
                                               ...
                                               (begin
                                                 ...
                                                 (f7399 x7993)))))
                                            (begin
                                              (write '(funapp 1693 39))
                                              (display "\n")
                                              (x7995 j7397 k7398 x7992)))))
                                         g7991))))
                                    g7990))
                                 xj7394
                                 xk7395
