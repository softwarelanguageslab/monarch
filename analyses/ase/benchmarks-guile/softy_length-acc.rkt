            ...
            (g7431
             (letrec*
              ...
              (letrec*
               ((g7991
                 (begin
                   (write '(funapp 1675 18))
                   (display "\n")
                   (parallel
                    (begin
                      (write '(funapp 1676 19))
                      (display "\n")
                      (parallel
                       (letrec*
                        ((x7993
                          (letrec*
                           ((xj7397
                            ...
                            (xk7398
                             (begin
                               (write '(funapp 1680 56))
                               (display "\n")
                               (loc
                                (begin
                                  (write '(funapp 1680 60))
                                  (display "\n")
                                  'importer)))))
                           (letrec*
                            ((g7994
                              (begin
                                (write '(funapp 1683 27))
                                (display "\n")
                                              ...
                                              (letrec*
                                               ((x7998
                                                 (letrec*
                                                  ((x7999
                                                    (begin
                                                      (write '(funapp 1698 53))
                                                      (display "\n")
                                                      (listof any/c))))
                                                  (begin
                                                    (write '(funapp 1699 45))
                                                    (display "\n")
                                                    (x7999
                                                     j7400
                                                     k7401
