                        ...
                        ((x7988
                          (letrec*
                           ((xj7394
                            ...
                            (xk7395
                             (begin
                               (write '(funapp 1676 56))
                               (display "\n")
                               (loc
                                (begin
                                  (write '(funapp 1676 60))
                                  (display "\n")
                                  'importer)))))
                           (letrec*
                            ((g7989
                              (begin
                                (write '(funapp 1679 27))
                                (display "\n")
                                              ...
                                              (letrec*
                                               ((x7993
                                                 (letrec*
                                                  ((x7994
                                                    (begin
                                                      (write '(funapp 1694 53))
                                                      (display "\n")
                                                      (listof any/c))))
                                                  (begin
                                                    (write '(funapp 1695 45))
                                                    (display "\n")
                                                    (x7994
                                                     j7397
                                                     k7398
