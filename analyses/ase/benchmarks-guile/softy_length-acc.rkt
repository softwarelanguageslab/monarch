                     ...
                     ((xj7349
                      ...
                      (xk7350
                       (letrec*
                        ((x7897
                          (begin
                            (write '(funapp 1490 41))
                            (display "\n")
                            (loc))))
                        (begin
                          (write '(funapp 1490 49))
                          (display "\n")
                          (cons
                           (begin
                                     ...
                                     (letrec*
                                      ((x7904
                                        (letrec*
                                         ((x7905
                                           (begin
                                             (write '(funapp 1502 48))
                                             (display "\n")
                                             (>=/c 0))))
                                         (begin
                                           (write '(funapp 1503 40))
                                           (display "\n")
                                           (and/c integer?/c x7905))))
                                       (x7901
                                        (letrec*
                                         ((x7902
                                           (letrec*
                                            ((x7903
                                              (begin
                                                ...
                                                (listof any/c))))
                                            (begin
                                              (write '(funapp 1509 43))
                                              (display "\n")
                                              (x7903 j7352 k7353 g7351)))))
                                         (begin
                                           (write '(funapp 1510 40))
                                           (display "\n")
                                           (f7354 x7902)))))
                                      (begin
                                        (write '(funapp 1511 37))
                                        (display "\n")
                                        (x7904 j7352 k7353 x7901)))))
                                   g7900))))
                              g7899))
                           xj7349
                           xk7350
