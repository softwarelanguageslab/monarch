              ...
              ((empty (begin (write '(funapp 56 22)) (display "\n") '()))
               ...
               (c
                (lambda (_)
                  (letrec*
                   ((g7861
                     (begin (write '(funapp 1399 47)) (display "\n") 'unit)))
                   g7861)))
               (b
                (lambda (x _)
                  (letrec*
                   ((g7862
                     (begin (write '(funapp 1400 50)) (display "\n") (x 1))))
                   g7862)))
               (a
                (lambda (x y q)
                  (letrec*
                     ...
                     (letrec*
                      ((x-cnd7868
                        (begin
                          ...
                          (<= n 0))))
                      (if x-cnd7868
                        (begin (write '(funapp 1418 25)) (display "\n") (x q))
                        (letrec*
                         ((x7869
                           (letrec*
                            ((x7875
                              (begin
                                (write '(funapp 1422 37))
                                (display "\n")
                                (p)))
                             (x7870
                              (letrec*
                                ...
                                (x7871
                                 (letrec*
                                  ...
                                  (begin
                                    ...
                                    (λ x7873 x7872)))))
                               (begin
                                 (write '(funapp 1430 32))
                                 (display "\n")
                                 (f x7874 x7871 p)))))
                            (begin
                              (write '(funapp 1431 29))
                              (display "\n")
                              (λ x7875 x7870)))))
                         (begin
               ...
               (main
                (lambda (n)
                  (letrec*
                   ((g7877
                     (begin (write '(funapp 1435 51)) (display "\n") (s n 0))))
                   g7877))))
              (letrec*
               ((g7878
                 (letrec*
                          ...
                          ((g7881
                            (lambda (g7327)
                              (letrec*
                               ...
                               g7882))))
                          g7881))
                       (begin (write '(funapp 1454 21)) (display "\n") 'module)
                       (begin
