              ...
              ((empty (begin (write '(funapp 56 22)) (display "\n") '()))
               ...
               (c
                (lambda (_)
                  (letrec*
                   ((g7854
                     (begin (write '(funapp 1415 47)) (display "\n") 'unit)))
                   g7854)))
               (b
                (lambda (x _)
                  (letrec*
                   ((g7855
                     (begin (write '(funapp 1416 50)) (display "\n") (x 1))))
                   g7855)))
               (a
                (lambda (x y q)
                  (letrec*
                     ...
                     (letrec*
                      ...
                      (if x-cnd7857
                        (letrec*
                         ...
                         g7859)
                        (begin
                          (write '(funapp 1425 25))
                          (display "\n")
                          (error
                           (begin
                             (write '(funapp 1425 31))
                             (display "\n")
                             'invalid)))))))
                   g7856)))
               (f
                     ...
                     (letrec*
                      ((x-cnd7861
                        (begin
                          ...
                          (<= n 0))))
                      (if x-cnd7861
                        (begin (write '(funapp 1434 25)) (display "\n") (x q))
                        (letrec*
                         ((x7862
                           (letrec*
                            ((x7868
                             ...
                             (x7863
                              (letrec*
                               ...
                               (begin
                                 ...
                                 (f x7867 x7864 p)))))
                            (begin
                              (write '(funapp 1447 29))
                              (display "\n")
                              (λ x7868 x7863)))))
                         (begin
                           (write '(funapp 1448 26))
                           (display "\n")
                           (a x x7862 q)))))))
                   g7860)))
               (s
               ...
               (main
                (lambda (n)
                  (letrec*
                   ((g7870
                     (begin (write '(funapp 1451 51)) (display "\n") (s n 0))))
                   g7870))))
              (letrec*
               ((g7871
                 (letrec*
