                ...
                ((empty (begin (write '(funapp 57 24)) (display "\n") '()))
                 ...
                 (c
                  (lambda (_)
                    (letrec*
                     ((g7840
                       (begin (write '(funapp 1349 49)) (display "\n") 'unit)))
                     g7840)))
                 (b
                  (lambda (x _)
                    (letrec*
                     ((g7841
                       (begin (write '(funapp 1350 52)) (display "\n") (x 1))))
                     g7841)))
                 (a
                  (lambda (x y q)
                    (letrec*
                       ...
                       (letrec*
                        ...
                        (if x-cnd7843
                          (letrec*
                           ...
                           g7845)
                          (begin
                            (write '(funapp 1359 27))
                            (display "\n")
                            (error
                             (begin
                               (write '(funapp 1359 33))
                               (display "\n")
                               'invalid)))))))
                     g7842)))
                 (f
                                  ...
                                  (x7850
                                   (letrec*
                                    ((x7852
                                     ...
                                     (x7851
                                      (begin
                                        (write '(funapp 1378 57))
                                        (display "\n")
                                        (b x _))))
                                    (begin
                                      (write '(funapp 1379 37))
                                      (display "\n")
                                      (λ x7852 x7851)))))
                                 (begin
                                   (write '(funapp 1380 34))
                                   (display "\n")
                                   (f x7853 x7850 p)))))
                              (begin
                                (write '(funapp 1381 31))
                                (display "\n")
                                (λ x7854 x7849)))))
                           (begin
                                   ...
                                   (letrec*
                                    ((x7862
                                      (letrec*
                                       ((x7863
                                         (begin
                                           (write '(funapp 1399 46))
                                           (display "\n")
                                           (integer?/c j7328 k7329 g7327))))
                                       (begin
                                         (write '(funapp 1400 38))
                                         (display "\n")
                                         (f7330 x7863)))))
                                    (begin
                                      (write '(funapp 1401 35))
                                      (display "\n")
                                      (any/c j7328 k7329 x7862)))))
                                 g7861))))
                            g7860))
                         (begin
