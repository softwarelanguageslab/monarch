              ...
              ((empty (begin (write '(funapp 104 22)) (display "\n") '()))
               ...
               (c
                (lambda (_)
                  (letrec*
                   ((g8004
                     (begin (write '(funapp 1696 47)) (display "\n") 'unit)))
                   g8004)))
               (b
                (lambda (x _)
                  (letrec*
                     ...
                     (letrec*
                      ((x-cnd8011
                        (begin
                          ...
                          (<= n 0))))
                      (if x-cnd8011
                        (begin (write '(funapp 1715 25)) (display "\n") (x q))
                        (begin
               ...
               (main
                (lambda (n)
                  (letrec*
                   ((g8016
                     (begin (write '(funapp 1731 51)) (display "\n") (s n 0))))
                   g8016))))
              (letrec*
               ((g8017
                 (begin
