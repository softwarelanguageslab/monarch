              ...
              ((empty (begin (write '(funapp 56 22)) (display "\n") '()))
               ...
               (c
                (lambda (_)
                  (letrec*
                   ((g7859
                     (begin (write '(funapp 1424 47)) (display "\n") 'unit)))
                   g7859)))
               (b
                (lambda (x _)
                  (letrec*
                   ((g7860
                     (begin (write '(funapp 1425 50)) (display "\n") (x 1))))
                   g7860)))
               (a
                (lambda (x y q)
                  (letrec*
                     ...
                     (letrec*
                      ((x-cnd7866
                        (begin
                          ...
                          (<= n 0))))
                      (if x-cnd7866
                        (begin (write '(funapp 1443 25)) (display "\n") (x q))
                        (letrec*
                         ((x7867
                           (letrec*
                            ((x7873
                              (begin
                                (write '(funapp 1447 37))
                                (display "\n")
                                (p)))
                             (x7868
                              (letrec*
                               ((x7872
                                ...
                                (x7869
                                 (letrec*
                                  ((x7871
                                    (begin
                                      (write '(funapp 1453 43))
                                      (display "\n")
                                      (_)))
                                   (x7870
                                    (begin
                                      (write '(funapp 1453 55))
                                      (display "\n")
                                      (b x _))))
                                  (begin
               ...
               (main
                (lambda (n)
                  (letrec*
                   ((g7875
                     (begin (write '(funapp 1460 51)) (display "\n") (s n 0))))
                   g7875))))
              (letrec*
               ((g7876
                 (letrec*
