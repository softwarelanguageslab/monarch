              ...
              ((empty (begin (write '(funapp 104 22)) (display "\n") '()))
               ...
               (c
                (lambda (_)
                  (letrec*
                   ((g8003
                     (begin (write '(funapp 1695 47)) (display "\n") 'unit)))
                   g8003)))
               (b
                (lambda (x _)
                  (letrec*
                   ((g8004
                     (begin (write '(funapp 1696 50)) (display "\n") (x 1))))
                   g8004)))
               (a
                (lambda (x y q)
                  (letrec*
                      ...
                      (if x-cnd8006
                        (letrec*
                         ((g8007
                          ...
                          (g8008
                           (begin
                             (write '(funapp 1704 56))
                             (display "\n")
                             (y 0))))
                         g8008)
                        (begin
                          (write '(funapp 1705 25))
                          (display "\n")
                          (error
                           (begin
                             (write '(funapp 1705 31))
                             (display "\n")
                             'invalid)))))))
                   g8005)))
               (f
                     ...
                     (letrec*
                      ((x-cnd8010
                        (begin
                          ...
                          (<= n 0))))
                      (if x-cnd8010
                        (begin (write '(funapp 1714 25)) (display "\n") (x q))
                        (begin
                             ...
                             (letrec*
                              ((g8011
                                (letrec*
                                 ((x8013
                                   (begin
                                     (write '(funapp 1721 40))
                                     (display "\n")
                                     (- n 1))))
                                 (begin
                                   (write '(funapp 1722 32))
                                   (display "\n")
                                   (f
                                    x8013
                                    (lambda (_)
               ...
               (main
                (lambda (n)
                  (letrec*
                   ((g8015
                     (begin (write '(funapp 1730 51)) (display "\n") (s n 0))))
                   g8015))))
              (letrec*
               ((g8016
                 (begin
                   (write '(funapp 1733 18))
                   (display "\n")
                   (parallel
                    (begin
                      (write '(funapp 1734 19))
                      (display "\n")
                      (parallel
                       (letrec*
                        ((x8018
                          (letrec*
                           ((xj7402
                             (begin
                               (write '(funapp 1738 33))
                               (display "\n")
                               (loc
                                (begin
                                  (write '(funapp 1738 37))
                                  (display "\n")
                                  'module))))
                            (xk7403
                             (begin
                               (write '(funapp 1738 56))
                               (display "\n")
                               (loc
                                (begin
                                  (write '(funapp 1738 60))
                                  (display "\n")
                                  'importer)))))
                           (letrec*
                            ((g8019
                                               ...
                                               ((x8023
                                                 (begin
                                                   ...
                                                   (integer?/c
                                                    ...
                                                    g7404))))
                                               (begin
                                                 (write '(funapp 1752 42))
                                                 (display "\n")
                                                 (f7407 x8023)))))
                                            (begin
                                              (write '(funapp 1753 39))
                                              (display "\n")
                                              (any/c j7405 k7406 x8022)))))
                                         g8021))))
                                    g8020))
                                 xj7402
                                 xk7403
