              ...
              ((empty (begin (write '(funapp 99 22)) (display "\n") '()))
               ...
               (c
                (lambda (_)
                  (letrec*
                   ((g7981
                     (begin (write '(funapp 1652 47)) (display "\n") 'unit)))
                   g7981)))
               (b
                (lambda (x _)
                  (letrec*
                   ((g7982
                     (begin (write '(funapp 1653 50)) (display "\n") (x 1))))
                   g7982)))
               (a
                (lambda (x y q)
                  (letrec*
                     ...
                     (letrec*
                      ...
                      (if x-cnd7984
                        (letrec*
                         ((g7985
                           (begin
                             (write '(funapp 1661 42))
                             (display "\n")
                             (x 0)))
                          (g7986
                           (begin
                             (write '(funapp 1661 56))
                             (display "\n")
                             (y 0))))
                         g7986)
                        (begin
                     ...
                     (letrec*
                      ((x-cnd7988
                        (begin
                          ...
                          (<= n 0))))
                      (if x-cnd7988
                        (begin (write '(funapp 1671 25)) (display "\n") (x q))
                        (begin
                          (write '(funapp 1672 25))
                          (display "\n")
                          (a
                           x
                           (lambda (p)
                             (letrec*
                              ((g7989
                                (letrec*
                                 ((x7991
                                   (begin
                                     (write '(funapp 1678 40))
                                     (display "\n")
                                     (- n 1))))
                                 (begin
                                   (write '(funapp 1679 32))
                                   (display "\n")
                                   (f
                                    x7991
                                    (lambda (_)
               ...
               (main
                (lambda (n)
                  (letrec*
                   ((g7993
                     (begin (write '(funapp 1687 51)) (display "\n") (s n 0))))
                   g7993))))
              (letrec*
               ((g7994
                 (begin
