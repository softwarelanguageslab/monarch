              ...
              ((empty (begin (write '(funapp 57 22)) (display "\n") '()))
               ...
               (c
                (lambda (_)
                  (letrec*
                   ((g8162
                     (begin (write '(funapp 1471 47)) (display "\n") 'unit)))
                   g8162)))
               (b
                (lambda (x _)
                  (letrec*
                   ((g8163
                     (begin (write '(funapp 1472 50)) (display "\n") (x 1))))
                   g8163)))
               (a
                (lambda (x y q)
                  (letrec*
                      ...
                      (if x-cnd8165
                        (letrec*
                         ((g8166
                          ...
                          (g8167
                           (begin
                             (write '(funapp 1480 56))
                             (display "\n")
                             (y 0))))
                         g8167)
                        (begin
                          (write '(funapp 1481 25))
                          (display "\n")
                          (error
                           (begin
                             (write '(funapp 1481 31))
                             (display "\n")
                             'invalid)))))))
                   g8164)))
               (f
                     ...
                     (letrec*
                      ((x-cnd8169
                        (begin
                          ...
                          (<= n 0))))
                      (if x-cnd8169
                        (begin (write '(funapp 1490 25)) (display "\n") (x q))
                        (letrec*
                         ((x8170
                           (letrec*
                            ((x8176
                              (begin
                                (write '(funapp 1494 37))
                                (display "\n")
                                (p)))
                             (x8171
                              (letrec*
                               ((x8175
                                ...
                                (x8172
                                 (letrec*
                                  ((x8174
                                    (begin
                                      (write '(funapp 1500 43))
                                      (display "\n")
                                      (_)))
                                   (x8173
                                    (begin
                                      (write '(funapp 1500 55))
                                      (display "\n")
                                      (b x _))))
                                  (begin
                                    ...
                                    (λ x8174 x8173)))))
                               (begin
                                 (write '(funapp 1502 32))
                                 (display "\n")
                                 (f x8175 x8172 p)))))
                            (begin
                              (write '(funapp 1503 29))
                              (display "\n")
                              (λ x8176 x8171)))))
                         (begin
                           (write '(funapp 1504 26))
                           (display "\n")
                           (a x x8170 q)))))))
                   g8168)))
               (s
               ...
               (main
                (lambda (n)
                  (letrec*
                   ((g8178
                     (begin (write '(funapp 1507 51)) (display "\n") (s n 0))))
                   g8178))))
              (letrec*
               ((g8179
                 (begin
                   (write '(funapp 1510 18))
                   (display "\n")
                   (parallel
                    (begin
                      (write '(funapp 1511 19))
                      (display "\n")
                      (parallel
                       (letrec*
                        ((x8181
                                               ...
                                               ((x8186
                                                 (begin
                                                   ...
                                                   (integer?/c
                                                    ...
                                                    g7625))))
                                               (begin
                                                 (write '(funapp 1529 42))
                                                 (display "\n")
                                                 (f7628 x8186)))))
                                            (begin
                                              (write '(funapp 1530 39))
                                              (display "\n")
                                              (any/c j7626 k7627 x8185)))))
                                         g8184))))
                                    g8183))
                                 xj7623
                                 xk7624
