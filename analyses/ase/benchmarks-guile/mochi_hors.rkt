              ...
              ((empty (begin (write '(funapp 56 22)) (display "\n") '()))
               ...
               (c
                (lambda (_)
                  (letrec*
                   ((g7888
                     (begin (write '(funapp 1470 47)) (display "\n") 'unit)))
                   g7888)))
               (b
                (lambda (x _)
                  (letrec*
                   ((g7889
                     (begin (write '(funapp 1471 50)) (display "\n") (x 1))))
                   g7889)))
               (a
                (lambda (x y q)
                  (letrec*
                     ...
                     (letrec*
                      ...
                      (if x-cnd7891
                        (letrec*
                         ((g7892
                           (begin
                             (write '(funapp 1479 42))
                             (display "\n")
                             (x 0)))
                          (g7893
                           (begin
                             (write '(funapp 1479 56))
                             (display "\n")
                             (y 0))))
                         g7893)
                        (begin
                     ...
                     (letrec*
                      ((x-cnd7895
                        (begin
                          ...
                          (<= n 0))))
                      (if x-cnd7895
                        (begin (write '(funapp 1489 25)) (display "\n") (x q))
                        (letrec*
                         ((x7896
                           (letrec*
                            ((x7902
                              (begin
                                (write '(funapp 1493 37))
                                (display "\n")
                                (p)))
                             (x7897
                              (letrec*
                               ...
                               (begin
                                 ...
                                 (f x7901 x7898 p)))))
                            (begin
                              (write '(funapp 1502 29))
                              (display "\n")
                              (λ x7902 x7897)))))
                         (begin
                           (write '(funapp 1503 26))
                           (display "\n")
                           (a x x7896 q)))))))
                   g7894)))
               (s
               ...
               (main
                (lambda (n)
                  (letrec*
                   ((g7904
                     (begin (write '(funapp 1506 51)) (display "\n") (s n 0))))
                   g7904))))
              (letrec*
               ((g7905
                 (letrec*
                     ...
                     ((xj7349
                      ...
                      (xk7350
                       (letrec*
                        ((x7909
                          (begin
                            (write '(funapp 1514 41))
                            (display "\n")
                            (loc))))
                        (begin
                          (write '(funapp 1514 49))
                          (display "\n")
                          (cons
                           (begin
                                     ...
                                     (letrec*
                                      ((x7913
                                        (letrec*
                                         ((x7914
                                           (begin
                                             (write '(funapp 1526 48))
                                             (display "\n")
                                             (integer?/c j7352 k7353 g7351))))
                                         (begin
                                           (write '(funapp 1527 40))
                                           (display "\n")
                                           (f7354 x7914)))))
                                      (begin
                                        (write '(funapp 1528 37))
                                        (display "\n")
                                        (any/c j7352 k7353 x7913)))))
                                   g7912))))
                              g7911))
                           xj7349
                           xk7350
