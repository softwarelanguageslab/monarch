              ...
              ((empty (begin (write '(funapp 104 22)) (display "\n") '()))
               ...
               (c
                (lambda (_)
                  (letrec*
                   ((g7987
                     (begin (write '(funapp 1660 47)) (display "\n") 'unit)))
                   g7987)))
               (b
                (lambda (x _)
                  (letrec*
                   ((g7988
                     (begin (write '(funapp 1661 50)) (display "\n") (x 1))))
                   g7988)))
               (a
                (lambda (x y q)
                  (letrec*
                     ...
                     (letrec*
                      ...
                      (if x-cnd7990
                        (letrec*
                         ((g7991
                           (begin
                             (write '(funapp 1669 42))
                             (display "\n")
                             (x 0)))
                          (g7992
                           (begin
                             (write '(funapp 1669 56))
                             (display "\n")
                             (y 0))))
                         g7992)
                        (begin
                          (write '(funapp 1670 25))
                          (display "\n")
                          (error
                           (begin
                             (write '(funapp 1670 31))
                             (display "\n")
                             'invalid)))))))
                   g7989)))
               (f
                     ...
                     (letrec*
                      ((x-cnd7994
                        (begin
                          ...
                          (<= n 0))))
                      (if x-cnd7994
                        (begin (write '(funapp 1679 25)) (display "\n") (x q))
                        (begin
                             ...
                             (letrec*
                              ((g7995
                                (letrec*
                                 ((x7997
                                   (begin
                                     (write '(funapp 1686 40))
                                     (display "\n")
                                     (- n 1))))
                                 (begin
                                   (write '(funapp 1687 32))
                                   (display "\n")
                                   (f
                                    x7997
                                    (lambda (_)
               ...
               (main
                (lambda (n)
                  (letrec*
                   ((g7999
                     (begin (write '(funapp 1695 51)) (display "\n") (s n 0))))
                   g7999))))
              (letrec*
               ((g8000
                 (begin
