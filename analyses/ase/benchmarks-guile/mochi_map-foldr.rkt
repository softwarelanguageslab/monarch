    ...
    (nonzero?
     (lambda (v)
       (letrec*
        ((g7381
          (letrec*
           ((x7382 (begin (write '(funapp 38 42)) (display "\n") (= v 0))))
      ...
      (letrec*
       ((g7384
         (letrec*
          ...
          (letrec*
           ((g7385 (begin (write '(funapp 54 19)) (display "\n") '()))
            (g7386
             (letrec*
                                         ...
                                         ((x7929
                                          ...
                                          (x7926
                                           (letrec*
                                            ((x7927
                                              (begin
                                                (write '(funapp 1547 51))
                                                (display "\n")
                                                (listof any/c))))
                                            (begin
                                              (write '(funapp 1548 43))
                                              (display "\n")
                                              (x7927 j7354 k7355 g7353)))))
                                         (begin
                                           (write '(funapp 1549 40))
                                           (display "\n")
                                           (f7356 x7929 x7928 x7926)))))
                                      (begin
                                        (write '(funapp 1550 37))
                                        (display "\n")
                                        (any/c j7354 k7355 x7925)))))
                                   g7924))))
                              g7923))
                           xj7349
                           xk7350
                 ...
                 (letrec*
                  ((x7937
                    (letrec*
                     ((xj7362
                       (begin
                         (write '(funapp 1565 31))
                         (display "\n")
                         (loc
                          (begin
                            (write '(funapp 1565 35))
                            (display "\n")
                            'module))))
                      (xk7363
                       (begin
                                         ...
                                         ((x7944
                                          ...
                                          (x7942
                                           (letrec*
                                            ((x7943
                                              (begin
                                                (write '(funapp 1605 51))
                                                (display "\n")
                                                (listof any/c))))
                                            (begin
                                              (write '(funapp 1606 43))
                                              (display "\n")
                                              (x7943 j7366 k7367 g7365)))))
                                         (begin
                                           (write '(funapp 1607 40))
                                           (display "\n")
                                           (f7368 x7944 x7942)))))
                                      (begin
                                        (write '(funapp 1608 37))
                                        (display "\n")
                                        (x7949 j7366 k7367 x7941)))))
                                   g7940))))
                              g7939))
                           xj7362
                           xk7363
