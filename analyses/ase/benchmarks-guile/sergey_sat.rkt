                     ...
                     (letrec*
                      ((x-cnd7445
                        (begin
                          (write '(funapp 148 25))
                          (display "\n")
                          ((lambda (v) (letrec* ((g7446 #t)) g7446)) g7281))))
                      (if x-cnd7445
                        g7281
                        (begin
                          (write '(blame g7279 149 42))
                          (display "\n")
                          (error
                           (format
                            "contract violation, blaming ~a~%"
                     ...
                     (letrec*
                      ((x-cnd7448
                        (begin
                          (write '(funapp 157 25))
                          (display "\n")
                          ((lambda (v) (letrec* ((g7449 #t)) g7449)) g7284))))
                      (if x-cnd7448
                        g7284
                        (begin
                          (write '(blame g7282 158 42))
                          (display "\n")
                          (error
                           (format
                            "contract violation, blaming ~a~%"
