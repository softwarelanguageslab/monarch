                     ...
                     (letrec*
                      ((x-cnd7444
                        (begin
                          (write '(funapp 148 25))
                          (display "\n")
                          ((lambda (v) (letrec* ((g7445 #t)) g7445)) g7280))))
                      (if x-cnd7444
                        g7280
                        (begin
                          (write '(blame g7278 149 42))
                          (display "\n")
                          (error
                           (format
                            "contract violation, blaming ~a~%"
                     ...
                     (letrec*
                      ((x-cnd7447
                        (begin
                          (write '(funapp 157 25))
                          (display "\n")
                          ((lambda (v) (letrec* ((g7448 #t)) g7448)) g7283))))
                      (if x-cnd7447
                        g7283
                        (begin
                          (write '(blame g7281 158 42))
                          (display "\n")
                          (error
                           (format
                            "contract violation, blaming ~a~%"
