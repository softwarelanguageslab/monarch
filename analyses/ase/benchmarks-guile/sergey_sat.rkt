                     ...
                     (letrec*
                      ((x-cnd7426
                        (begin
                          (write '(funapp 105 25))
                          (display "\n")
                          ((lambda (v) (letrec* ((g7427 #t)) g7427)) g7280))))
                      (if x-cnd7426
                        g7280
                        (begin
                          (write '(blame g7278 106 42))
                          (display "\n")
                          (error
                           (format
                            "contract violation, blaming ~a~%"
                     ...
                     (letrec*
                      ((x-cnd7429
                        (begin
                          (write '(funapp 114 25))
                          (display "\n")
                          ((lambda (v) (letrec* ((g7430 #t)) g7430)) g7283))))
                      (if x-cnd7429
                        g7283
                        (begin
                          (write '(blame g7281 115 42))
                          (display "\n")
                          (error
                           (format
                            "contract violation, blaming ~a~%"
