                     ...
                     (letrec*
                      ((x-cnd7440
                        (begin
                          (write '(funapp 143 25))
                          (display "\n")
                          ((lambda (v) (letrec* ((g7441 #t)) g7441)) g7280))))
                      (if x-cnd7440
                        g7280
                        (begin
                          (write '(blame g7278 144 42))
                          (display "\n")
                          (error
                           (format
                            "contract violation, blaming ~a~%"
                     ...
                     (letrec*
                      ((x-cnd7443
                        (begin
                          (write '(funapp 152 25))
                          (display "\n")
                          ((lambda (v) (letrec* ((g7444 #t)) g7444)) g7283))))
                      (if x-cnd7443
                        g7283
                        (begin
                          (write '(blame g7281 153 42))
                          (display "\n")
                          (error
                           (format
                            "contract violation, blaming ~a~%"
