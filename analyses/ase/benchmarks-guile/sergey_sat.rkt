            ...
            (g7352
             (letrec*
              ((empty (begin (write '(funapp 56 22)) (display "\n") '()))
               ...
               (phi
                (letrec*
                 ((x7888 (begin (write '(funapp 1426 26)) (display "\n") (x1)))
                  (x7863
                   (letrec*
                    ((x7887
                      (begin (write '(funapp 1429 29)) (display "\n") (x2)))
                     (x7864
                      (letrec*
                       ((x7886
                         (begin (write '(funapp 1432 32)) (display "\n") (x3)))
                        (x7865
                         (letrec*
                          ((x7885
                            (begin
                              (write '(funapp 1435 35))
                              (display "\n")
                              (x4)))
                           (x7866
                            (letrec*
                              ...
                              (x7867
                               (letrec*
                                ...
                                (begin
                                  ...
                                  (λ x7883 x7868)))))
                             (begin
                               (write '(funapp 1516 30))
                               (display "\n")
                               (λ x7884 x7867)))))
                          (begin
                            (write '(funapp 1517 27))
                            (display "\n")
                            (λ x7885 x7866)))))
                       (begin
                         (write '(funapp 1518 24))
                         (display "\n")
                         (λ x7886 x7865)))))
                    (begin
               ...
               (try
                (letrec*
                 ((x7891 (begin (write '(funapp 1523 26)) (display "\n") (f)))
                  (x7889
                   (letrec*
                    ((val7266
                      (begin (write '(funapp 1526 31)) (display "\n") (f #t))))
                    (letrec*
                     ((g7890
                       (if val7266
                         val7266
                     ...
                     g7890))))
                 (begin
                   (write '(funapp 1528 18))
                   (display "\n")
                   (λ x7891 x7889))))
               (sat-solve-7
                (letrec*
                 ((x7920 (begin (write '(funapp 1531 26)) (display "\n") (p)))
                  (x7892
                   (letrec*
                    ((x7893
                      (letrec*
                       ((x7919
                         (begin (write '(funapp 1536 32)) (display "\n") (n1)))
                        (x7894
                         (letrec*
                          ((x7895
                            (letrec*
                              ...
                              (x7896
                               (letrec*
                                                ...
                                                (x7902
                                                 (letrec*
                                                  ...
                                                  (begin
                                                    ...
                                                    (try x7903)))))
                                               (begin
                                                 (write '(funapp 1596 48))
                                                 (display "\n")
                                                 (λ x7915 x7902)))))
                                            (begin
                                              (write '(funapp 1597 45))
                                              (display "\n")
                                              (try x7901)))))
                                         (begin
                                           (write '(funapp 1598 42))
                                           (display "\n")
                                           (λ x7916 x7900)))))
                                      (begin
                                ...
                                (begin
                                  ...
                                  (try x7897)))))
                             (begin
                               (write '(funapp 1602 30))
                               (display "\n")
                               (λ x7918 x7896)))))
                          (begin
                            (write '(funapp 1603 27))
                            (display "\n")
                            (try x7895)))))
                       (begin
                         (write '(funapp 1604 24))
                         (display "\n")
                         (λ x7919 x7894)))))
                    (begin
                      (write '(funapp 1605 21))
                      (display "\n")
                      (try x7893)))))
                 (begin
                   (write '(funapp 1606 18))
                   (display "\n")
                   (λ x7920 x7892)))))
              (letrec*
               ((g7921
                 (begin
                   (write '(funapp 1607 32))
                   (display "\n")
                   (sat-solve-7 phi))))
               g7921))))
           g7352))))
