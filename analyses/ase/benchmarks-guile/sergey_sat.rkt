            ...
            (g7370
             (letrec*
              ((empty (begin (write '(funapp 57 22)) (display "\n") '()))
               ...
               (phi
                (letrec*
                 ((x7915 (begin (write '(funapp 1473 26)) (display "\n") (x1)))
                  (x7890
                   (letrec*
                    ((x7914
               ...
               (try
                (letrec*
                 ((x7918 (begin (write '(funapp 1570 26)) (display "\n") (f)))
                  (x7916
                   (letrec*
                    ((val7266
               ...
               (sat-solve-7
                (letrec*
                 ((x7947 (begin (write '(funapp 1578 26)) (display "\n") (p)))
                  (x7919
                   (letrec*
                    ((x7920
                      (letrec*
