               ...
               ((g7872
                 (letrec*
                  ((x7876
                          ...
                          ((g7877
                            (lambda (g7332 g7333)
                              (letrec*
                               ...
                               g7878))))
                          g7877))
                       (begin (write '(funapp 1464 21)) (display "\n") 'module)
                       (begin
                   ...
                   (x7874 (input)))
                  (begin
                    (write '(funapp 1469 19))
                    (display "\n")
                    (x7876 x7875 x7874))))
                (g7873
                 (begin
                   (write '(funapp 1471 18))
                   (display "\n")
                       ...
                       ((g7884
                         (lambda (g7337)
                           (letrec*
                            ...
                            g7885))))
                       g7884))
                    (begin (write '(funapp 1496 18)) (display "\n") 'module)
