                               ...
                               ((g7880
                                 (letrec*
                                  ...
                                  (begin
                                    ...
                                    (display "\n")
                                    (x7884 j7330 k7331 x7881)))))
                               g7880))))
                          g7879))
                       (begin (write '(funapp 1440 21)) (display "\n") 'module)
                       (begin
                                             ...
                                             (letrec*
                                              ((x7892
                                                (begin
                                                  ...
                                                  (>=/c n))))
                                              (begin
                                                (write '(funapp 1464 43))
                                                (display "\n")
                                                (and/c integer?/c x7892)))))
                                           g7891))
                                        x7337)))
                                    (x7889
                                     (begin
                                       ...
                                       (f7336 x7337))))
                                   (begin
                                     (write '(funapp 1468 34))
                                     (display "\n")
                                     (x7890 j7334 k7335 x7889)))))
                                g7888))))
                            g7887))))
                       g7886))
                    (begin (write '(funapp 1472 18)) (display "\n") 'module)
                    (begin (write '(funapp 1473 18)) (display "\n") 'importer)
                    sqr))))
               g7875))))
           g7351))))
       g7349)))
