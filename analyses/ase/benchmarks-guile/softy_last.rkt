                                     ...
                                     ((x7874
                                      ...
                                      (x7872
                                       (letrec*
                                        ((x7873
                                          (begin
                                            (write '(funapp 1443 57))
                                            (display "\n")
                                            (x x))))
                                        (begin
                                          (write '(funapp 1443 65))
                                          (display "\n")
                                          (x7873 z)))))
                                     (begin
                                       ...
                                       (λ x7874 x7872)))))
                                  (begin
                                    (write '(funapp 1445 35))
                                    (display "\n")
                                    (f x7871)))))
                               (begin
                                 (write '(funapp 1446 32))
                                 (display "\n")
                                 (λ x7875 x7870))))
                             (x7862
                              (letrec*
                                ...
                                (x7863
                                 (letrec*
                                     ...
                                     ((x7867
                                      ...
                                      (x7865
                                       (letrec*
                                        ((x7866
                                          (begin
                                            (write '(funapp 1456 57))
                                            (display "\n")
                                            (x x))))
                                        (begin
                                          (write '(funapp 1456 65))
                                          (display "\n")
                                          (x7866 z)))))
                                     (begin
                                  ...
                                  (begin
                                    ...
                                    (f x7864)))))
                               (begin
                                 (write '(funapp 1459 32))
                                 (display "\n")
                                 (λ x7868 x7863)))))
                            (begin
                              (write '(funapp 1460 29))
                              (display "\n")
                              (x7869 x7862)))))
                         (begin
                                 ...
                                 (letrec*
                                  ...
                                  (if x-cnd7882
                                    ...
                                    (letrec*
                                     ((x7884
                                       (begin
                                         (write '(funapp 1485 54))
                                         (display "\n")
                                         (cdr x))))
                                     (begin
                                       (write '(funapp 1485 64))
                                       (display "\n")
                                       (f x7884)))))))
                               (begin
                                 (write '(funapp 1486 32))
                                 (display "\n")
                                 (λ x7885 x7881)))))
                            (begin
                              (write '(funapp 1487 29))
                              (display "\n")
                              (λ x7886 x7880)))))
                         (begin
                           (write '(funapp 1488 26))
                           (display "\n")
                           (Y x7879)))))
                      (begin
