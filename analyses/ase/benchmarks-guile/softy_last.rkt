                                       ...
                                       (letrec*
                                        ((x7868
                                          (begin
                                            ...
                                            (x x))))
                                        (begin
                                          (write '(funapp 1434 65))
                                          (display "\n")
                                          (x7868 z)))))
                                     (begin
                                       (write '(funapp 1435 38))
                                       (display "\n")
                                       (λ x7869 x7867)))))
                                  (begin
                                  ...
                                  ((x7859
                                    (letrec*
                                     ...
                                     (begin
                                       ...
                                       (λ x7862 x7860)))))
                                  (begin
                                    (write '(funapp 1449 35))
                                    (display "\n")
                                    (f x7859)))))
                               (begin
                                 (write '(funapp 1450 32))
                                 (display "\n")
                                 (λ x7863 x7858)))))
                            (begin
                              (write '(funapp 1451 29))
                              (display "\n")
                              (x7864 x7857)))))
                         (begin
                           (write '(funapp 1452 26))
                           (display "\n")
                           (x7856 y)))))
                      (begin
                               ...
                               ((x7880
                                ...
                                (x7876
                                 (letrec*
                                  ...
                                  (if x-cnd7877
                                    (begin
                                      (write '(funapp 1475 37))
                                      (display "\n")
                                      (car x))
                                    (letrec*
                                     ((x7879
                                       (begin
                                         (write '(funapp 1476 54))
                                         (display "\n")
                                         (cdr x))))
                                     (begin
                                       (write '(funapp 1476 64))
                                       (display "\n")
                                       (f x7879)))))))
                               (begin
                                 (write '(funapp 1477 32))
                                 (display "\n")
                                 (λ x7880 x7876)))))
                            (begin
                              (write '(funapp 1478 29))
                              (display "\n")
                              (λ x7881 x7875)))))
                         (begin
