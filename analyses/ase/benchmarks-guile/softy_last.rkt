                  ...
                  (lambda (f)
                    (letrec*
                     ((g7840
                       (letrec*
                        ((x7857
                          (begin (write '(funapp 1354 33)) (display "\n") (y)))
                         (x7841
                          (letrec*
                           ((x7842
                             (letrec*
                                         ...
                                         (letrec*
                                          ((x7854
                                            (begin
                                              ...
                                              (x x))))
                                          (begin
                                            (write '(funapp 1368 67))
                                            (display "\n")
                                            (x7854 z)))))
                                       (begin
                                         (write '(funapp 1369 40))
                                         (display "\n")
                                         (λ x7855 x7853)))))
                                    (begin
                                      (write '(funapp 1370 37))
                                      (display "\n")
                                      (f x7852)))))
                                 (begin
                                   (write '(funapp 1371 34))
                                   (display "\n")
                                   (λ x7856 x7851))))
                               (x7843
                                (letrec*
                                       ...
                                       ((x7848
                                        ...
                                        (x7846
                                         (letrec*
                                          ((x7847
                                            (begin
                                              (write '(funapp 1381 59))
                                              (display "\n")
                                              (x x))))
                                          (begin
                                            (write '(funapp 1381 67))
                                            (display "\n")
                                            (x7847 z)))))
                                       (begin
                                         (write '(funapp 1382 40))
                                         (display "\n")
                                         (λ x7848 x7846)))))
                                    (begin
                                      (write '(funapp 1383 37))
                                      (display "\n")
                                      (f x7845)))))
                                 (begin
                                   (write '(funapp 1384 34))
                                   (display "\n")
                                   (λ x7849 x7844)))))
                              (begin
                                ...
                                (x7850 x7843)))))
                           (begin
                             (write '(funapp 1386 28))
                             (display "\n")
                             (x7842 y)))))
                        (begin
                          (write '(funapp 1387 25))
                          (display "\n")
                          (λ x7857 x7841)))))
                     g7840)))
                 (last
                               ...
                               (x7861
                                (letrec*
                                   ...
                                   (letrec*
                                    ((x-cnd7863
                                      (letrec*
                                       ((x7864
                                         (begin
                                           (write '(funapp 1406 48))
                                           (display "\n")
                                           (cdr x))))
                                       (begin
                                         (write '(funapp 1407 40))
                                         (display "\n")
                                         (empty? x7864)))))
                                    (if x-cnd7863
                                      (begin
                                        (write '(funapp 1409 39))
                                        (display "\n")
                                        (car x))
                                      (letrec*
                                       ((x7865
                                 ...
                                 (begin
                                   ...
                                   (λ x7866 x7862)))))
                              (begin
                                (write '(funapp 1412 31))
                                (display "\n")
                                (λ x7867 x7861)))))
                           (begin
                             (write '(funapp 1413 28))
                             (display "\n")
                             (Y x7860)))))
                        (begin
                          (write '(funapp 1414 25))
                          (display "\n")
                          (x7859 l)))))
                     g7858))))
                (letrec*
                                            ...
                                            (letrec*
                                             ((x7876
                                               (begin
                                                 ...
                                                 (listof any/c))))
                                             (begin
                                               (write '(funapp 1434 44))
                                               (display "\n")
                                               (cons/c any/c x7876)))))
                                          (begin
                                            (write '(funapp 1435 41))
                                            (display "\n")
                                            (x7875 j7328 k7329 g7327)))))
                                       (begin
                                         (write '(funapp 1436 38))
                                         (display "\n")
                                         (f7330 x7874)))))
                                    (begin
                                      (write '(funapp 1437 35))
                                      (display "\n")
                                      (any/c j7328 k7329 x7873)))))
                                 g7872))))
                            g7871))
                         (begin
                           (write '(funapp 1440 23))
                           (display "\n")
                           'module)
                         (begin
