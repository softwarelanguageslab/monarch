            ...
            (g7436
             (letrec*
                       ...
                       (letrec*
                        ((g8006
                          (letrec*
                           ((x8007
                             (begin
                               (write '(funapp 1706 30))
                               (display "\n")
                               ((lambda (x)
                                  (letrec*
                                   ((g8011
                                     (begin
                                       (write '(funapp 1709 36))
                                       (display "\n")
                                       (f
                                        (lambda (z)
                                          (letrec*
                                             ...
                                             (letrec*
                                              ((x8010
                                                (begin
                                                  ...
                                                  (x x))))
                                              (begin
                                                (write '(funapp 1723 67))
                                                (display "\n")
                                                (x8010 z)))))
                                           g8009))))))
                                   g8008))))))
                           (begin
                             (write '(funapp 1726 28))
                             (display "\n")
                             (x8007 y)))))
                        g8006))))
                   g8005)))
              ...
              (letrec*
               ((g8021
                 (begin
                   (write '(funapp 1756 18))
                   (display "\n")
                   (parallel
                    (begin
                      (write '(funapp 1757 19))
                      (display "\n")
                      (parallel
                       (letrec*
                        ((x8023
                          (letrec*
                           ((xj7402
                             (begin
                               (write '(funapp 1761 33))
                               (display "\n")
                               (loc
                                (begin
                                  (write '(funapp 1761 37))
                                  (display "\n")
                                  'module))))
                            (xk7403
                             (begin
                               (write '(funapp 1761 56))
                               (display "\n")
                               (loc
                                (begin
                                  (write '(funapp 1761 60))
                                  (display "\n")
                                  'importer)))))
                           (letrec*
                            ((g8024
                              (begin
                                (write '(funapp 1764 27))
                                (display "\n")
                                                 ...
                                                 (letrec*
                                                  ...
                                                  (begin
                                                    ...
                                                    (x8029
                                                     ...
                                                     g7404)))))
                                               (begin
                                                 (write '(funapp 1780 42))
                                                 (display "\n")
                                                 (f7407 x8028)))))
                                            (begin
                                              (write '(funapp 1781 39))
                                              (display "\n")
                                              (any/c j7405 k7406 x8027)))))
                                         g8026))))
                                    g8025))
                                 xj7402
                                 xk7403
