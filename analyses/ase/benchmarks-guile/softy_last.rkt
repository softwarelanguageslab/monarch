                                       ...
                                       (letrec*
                                        ((x7902
                                          (begin
                                            ...
                                            (x x))))
                                        (begin
                                          (write '(funapp 1490 65))
                                          (display "\n")
                                          (x7902 z)))))
                                     (begin
                                       (write '(funapp 1491 38))
                                       (display "\n")
                                       (λ x7903 x7901)))))
                                  (begin
                                ...
                                (x7892
                                 (letrec*
                                  ...
                                  (begin
                                    ...
                                    (f x7893)))))
                               (begin
                                 (write '(funapp 1506 32))
                                 (display "\n")
                                 (λ x7897 x7892)))))
                            (begin
                              (write '(funapp 1507 29))
                              (display "\n")
                              (x7898 x7891)))))
                         (begin
                               ...
                               ((x7914
                                ...
                                (x7910
                                 (letrec*
                                  ...
                                  (if x-cnd7911
                                    (begin
                                      (write '(funapp 1531 37))
                                      (display "\n")
                                      (car x))
                                    (letrec*
                                     ((x7913
                                       (begin
                                         (write '(funapp 1532 54))
                                         (display "\n")
                                         (cdr x))))
                                     (begin
                                       (write '(funapp 1532 64))
                                       (display "\n")
                                       (f x7913)))))))
                               (begin
                                 (write '(funapp 1533 32))
                                 (display "\n")
                                 (λ x7914 x7910)))))
                            (begin
                 ...
                 (letrec*
                  ((x7918
                    (letrec*
                     ((xj7349
                       (begin
                         (write '(funapp 1543 31))
                         (display "\n")
                         (loc
                          (begin
                            (write '(funapp 1543 35))
                            (display "\n")
                            'module))))
                      (xk7350
                       (begin
                         (write '(funapp 1543 54))
                         (display "\n")
                         (loc
                          (begin
                            (write '(funapp 1543 58))
                            (display "\n")
                            'importer)))))
                     (letrec*
                      ((g7919
                        (begin
                          (write '(funapp 1546 25))
                          (display "\n")
                                              ...
                                              (letrec*
                                               ((x7925
                                                 (begin
                                                   ...
                                                   (listof any/c))))
                                               (begin
                                                 (write '(funapp 1560 46))
                                                 (display "\n")
                                                 (cons/c any/c x7925)))))
                                            (begin
                                              (write '(funapp 1561 43))
                                              (display "\n")
                                              (x7924 j7352 k7353 g7351)))))
                                         (begin
