                                  ...
                                  ((x7864
                                    (letrec*
                                     ...
                                     (begin
                                       ...
                                       (λ x7867 x7865)))))
                                  (begin
                                    (write '(funapp 1457 35))
                                    (display "\n")
                                    (f x7864)))))
                               (begin
                                 (write '(funapp 1458 32))
                                 (display "\n")
                                 (λ x7868 x7863)))))
                            (begin
                              (write '(funapp 1459 29))
                              (display "\n")
                              (x7869 x7862)))))
                         (begin
                           (write '(funapp 1460 26))
                           (display "\n")
                           (x7861 y)))))
                      (begin
                        (write '(funapp 1461 23))
                        (display "\n")
                        (λ x7876 x7860)))))
                   g7859)))
               (last
                               ...
                               ((x7885
                                ...
                                (x7881
                                 (letrec*
                                  ...
                                  (if x-cnd7882
                                    (begin
                                      (write '(funapp 1483 37))
                                      (display "\n")
                                      (car x))
                                    (letrec*
                                     ((x7884
                                       (begin
                                         (write '(funapp 1484 54))
                                         (display "\n")
                                         (cdr x))))
                                     (begin
                                       (write '(funapp 1484 64))
                                       (display "\n")
                                       (f x7884)))))))
                               (begin
                                 (write '(funapp 1485 32))
                                 (display "\n")
                                 (λ x7885 x7881)))))
                            (begin
                              ...
                              (λ x7886 x7880)))))
                         (begin
                           (write '(funapp 1487 26))
                           (display "\n")
                           (Y x7879)))))
                      (begin
                        (write '(funapp 1488 23))
                        (display "\n")
                        (x7878 l)))))
                   g7877))))
              (letrec*
                               ...
                               ((g7891
                                 (letrec*
                                  ...
                                  (begin
                                    ...
                                    (display "\n")
                                    (any/c j7332 k7333 x7892)))))
                               g7891))))
                          g7890))
                       (begin (write '(funapp 1514 21)) (display "\n") 'module)
                       (begin
                         (write '(funapp 1515 21))
                         (display "\n")
                         'importer)
                       last)))
                   (x7888 (input)))
