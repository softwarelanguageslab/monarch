                                          ...
                                          (letrec*
                                           ((g8011
                                             (letrec*
                                              ((x8012
                                                (begin
                                                  (write '(funapp 1712 59))
                                                  (display "\n")
                                                  (x x))))
                                              (begin
                                                (write '(funapp 1712 67))
                                                (display "\n")
                                                (x8012 z)))))
                                           g8011))))))
                                   g8010))
                                             ...
                                             (letrec*
                                              ((x8009
                                                (begin
                                                  ...
                                                  (x x))))
                                              (begin
                                                (write '(funapp 1722 67))
                                                (display "\n")
                                                (x8009 z)))))
                                           g8008))))))
                                   g8007))))))
                           (begin
                             (write '(funapp 1725 28))
                             (display "\n")
                             (x8006 y)))))
                        g8005))))
                   g8004)))
                                        ...
                                        (letrec*
                                         ((x8019
                                           (begin
                                             ...
                                             (cdr x))))
                                         (begin
                                           (write '(funapp 1748 66))
                                           (display "\n")
                                           (f x8019)))))))
                                   g8016))))
                              g8015))))))
                      (begin
                        (write '(funapp 1751 23))
                        (display "\n")
                        (x8014 l)))))
                   g8013))))
              (letrec*
               ((g8020
                 (begin
                   (write '(funapp 1755 18))
                   (display "\n")
                   (parallel
                    (begin
                      (write '(funapp 1756 19))
                      (display "\n")
                      (parallel
                       (letrec*
                        ((x8022
