                                          ...
                                          (letrec*
                                           ((g7985
                                             (letrec*
                                              ((x7986
                                                (begin
                                                  (write '(funapp 1682 59))
                                                  (display "\n")
                                                  (x x))))
                                              (begin
                                                (write '(funapp 1682 67))
                                                (display "\n")
                                                (x7986 z)))))
                                           g7985))))))
                                   g7984))))))
                           (begin
                             (write '(funapp 1685 28))
                             (display "\n")
                             (x7983 y)))))
                        g7982))))
                   g7981)))
                                        ...
                                        (letrec*
                                         ((x7996
                                           (begin
                                             ...
                                             (cdr x))))
                                         (begin
                                           (write '(funapp 1708 66))
                                           (display "\n")
                                           (f x7996)))))))
                                   g7993))))
                              g7992))))))
                      (begin
                        (write '(funapp 1711 23))
                        (display "\n")
                        (x7991 l)))))
                   g7990))))
              (letrec*
