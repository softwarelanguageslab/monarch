                                     ...
                                     ((x7876
                                      ...
                                      (x7874
                                       (letrec*
                                        ((x7875
                                          (begin
                                            (write '(funapp 1418 57))
                                            (display "\n")
                                            (x x))))
                                        (begin
                                          (write '(funapp 1418 65))
                                          (display "\n")
                                          (x7875 z)))))
                                     (begin
                                       (write '(funapp 1419 38))
                                       (display "\n")
                                       (λ x7876 x7874)))))
                                  (begin
                                ...
                                (x7865
                                 (letrec*
                                  ...
                                  (begin
                                    ...
                                    (f x7866)))))
                               (begin
                                 (write '(funapp 1434 32))
                                 (display "\n")
                                 (λ x7870 x7865)))))
                            (begin
                              (write '(funapp 1435 29))
                              (display "\n")
                              (x7871 x7864)))))
                         (begin
                               ...
                               ((x7887
                                ...
                                (x7883
                                 (letrec*
                                  ...
                                  (if x-cnd7884
                                    (begin
                                      (write '(funapp 1459 37))
                                      (display "\n")
                                      (car x))
                                    (letrec*
                                     ((x7886
                                       (begin
                                         (write '(funapp 1460 54))
                                         (display "\n")
                                         (cdr x))))
                                     (begin
                                       (write '(funapp 1460 64))
                                       (display "\n")
                                       (f x7886)))))))
                               (begin
                                 (write '(funapp 1461 32))
                                 (display "\n")
                                 (λ x7887 x7883)))))
                            (begin
                              (write '(funapp 1462 29))
                              (display "\n")
                              (λ x7888 x7882)))))
                         (begin
