                 ...
                 (letrec*
                  ((x7919
                    (letrec*
                     ((xj7349
                       (begin
                         (write '(funapp 1528 31))
                         (display "\n")
                         (loc
                          (begin
                            (write '(funapp 1528 35))
                            (display "\n")
                            'module))))
                      (xk7350
                       (begin
                         (write '(funapp 1528 54))
                         (display "\n")
                         (loc
                          (begin
                            (write '(funapp 1528 58))
                            (display "\n")
                            'importer)))))
                     (letrec*
                      ((g7920
                        (begin
                          (write '(funapp 1531 25))
                          (display "\n")
                                       ...
                                       (x7923
                                        (letrec*
                                         ...
                                         (begin
                                           ...
                                           (f7354 x7924)))))
                                      (begin
                                        (write '(funapp 1543 37))
                                        (display "\n")
                                        (x7925 j7352 k7353 x7923)))))
                                   g7922))))
                              g7921))
                           xj7349
                           xk7350
                 ...
                 (letrec*
                  ((x7927
                    (letrec*
                     ((xj7355
                       (begin
                         (write '(funapp 1556 31))
                         (display "\n")
                         (loc
                          (begin
                            (write '(funapp 1556 35))
                            (display "\n")
                            'module))))
                      (xk7356
                       (begin
                         (write '(funapp 1556 54))
                         (display "\n")
                         (loc
                          (begin
                            (write '(funapp 1556 58))
                            (display "\n")
                            'importer)))))
                     (letrec*
                      ((g7928
                        (begin
                          (write '(funapp 1559 25))
                          (display "\n")
                                     ...
                                     (letrec*
                                      ((x7933
                                        (letrec*
                                         ((x7934
                                           (begin
                                             (write '(funapp 1568 48))
                                             (display "\n")
                                             (cons/c integer?/c integer?/c))))
                                         (begin
                                           (write '(funapp 1569 40))
                                           (display "\n")
                                           (listof x7934))))
                                       (x7931
                                        (letrec*
                                         ((x7932
                                           (begin
                                             (write '(funapp 1572 48))
                                             (display "\n")
                                             (integer?/c j7358 k7359 g7357))))
                                         (begin
                                           (write '(funapp 1573 40))
                                           (display "\n")
                                           (f7360 x7932)))))
                                      (begin
                                        (write '(funapp 1574 37))
                                        (display "\n")
                                        (x7933 j7358 k7359 x7931)))))
                                   g7930))))
                              g7929))
                           xj7355
                           xk7356
