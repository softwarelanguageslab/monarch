                     ...
                     (letrec*
                      ((x-cnd7859
                        (letrec*
                         ((x7861
                           (begin
                             (write '(funapp 1422 34))
                             (display "\n")
                             (empty? xs)))
                          (x7860
                           (begin
                             (write '(funapp 1422 54))
                             (display "\n")
                             (empty? ys))))
                         (begin
                           ...
                           (and x7861 x7860)))))
                      (if x-cnd7859
                        (letrec* ((g7862 empty)) g7862)
                        (letrec*
                         ((x-cnd7863
                           (letrec*
                            ((x7865
                              (begin
                                (write '(funapp 1429 37))
                                (display "\n")
                                (cons? xs)))
                             (x7864
                              (begin
                                (write '(funapp 1429 56))
                                (display "\n")
                                (cons? ys))))
                            (begin
                              (write '(funapp 1430 29))
                              (display "\n")
                              (and x7865 x7864)))))
                         (if x-cnd7863
                           (letrec*
                              ...
                              (letrec*
                               ((x7870
                                 (letrec*
                                  ((x7872
                                    (begin
                                      (write '(funapp 1437 43))
                                      (display "\n")
                                      (car xs)))
                                   (x7871
                                    (begin
                                      (write '(funapp 1437 60))
                                      (display "\n")
                                      (car ys))))
                                  (begin
                  ...
                  (letrec*
                   ((g7878
                     (letrec*
                      ((xs
                        (begin
                          (write '(funapp 1464 28))
                          (display "\n")
                          (mk-list n))))
                      (letrec*
                       ((g7879
                         (begin
                           (write '(funapp 1465 40))
                           (display "\n")
                           (zip xs xs))))
                       g7879))))
                   g7878))))
                                 ...
                                 (letrec*
                                  ((x7895
                                    (letrec*
                                     ((x7896
                                       (begin
                                         (write '(funapp 1503 44))
                                         (display "\n")
                                         (cons/c integer?/c integer?/c))))
                                     (begin
                                       (write '(funapp 1504 36))
                                       (display "\n")
                                       (listof x7896))))
                                   (x7893
                                    (letrec*
                                  ...
                                  (begin
                                    ...
                                    (display "\n")
                                    (x7895 j7333 k7334 x7893)))))
                               g7892))))
                          g7891))
                       (begin (write '(funapp 1512 21)) (display "\n") 'module)
                       (begin
                         (write '(funapp 1513 21))
                         (display "\n")
                         'importer)
                       main)))
                   (x7889 (input)))
