                       ...
                       (letrec*
                        ((val7244
                          (begin
                            ...
                            (display "\n")
                            (= x y))))
                        (letrec* ((g7426 (if val7244 val7244 #f))) g7426)))))
                   g7425))))
               g7423)))
           (<=
            (lambda (x y)
                       ...
                       (letrec*
                        ((val7246
                          (begin
                            ...
                            (display "\n")
                            (= x y))))
                        (letrec* ((g7431 (if val7246 val7246 #f))) g7431)))))
                   g7430))))
               g7428)))
           (>
            (lambda (x y)
                     ...
                     (letrec*
                      ((x-cnd7448
                        (begin
                          (write '(funapp 148 25))
                          (display "\n")
                          ((lambda (v) (letrec* ((g7449 #t)) g7449)) g7272))))
                      (if x-cnd7448
                        g7272
                        (begin
                     ...
                     (letrec*
                      ((x-cnd7451
                        (begin
                          (write '(funapp 157 25))
                          (display "\n")
                          ((lambda (v) (letrec* ((g7452 #t)) g7452)) g7275))))
                      (if x-cnd7451
                        g7275
                        (begin
                  ...
                  (letrec*
                   ((g8012
                     (letrec*
                      ((xs
                        (begin
                          (write '(funapp 1709 28))
                          (display "\n")
                          (mk-list n))))
                      (letrec*
                       ((g8013
                         (begin
                           (write '(funapp 1710 40))
                           (display "\n")
                           (zip xs xs))))
                       g8013))))
                   g8012))))
