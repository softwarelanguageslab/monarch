                               ...
                               ((x7875
                                ...
                                (x7872
                                 (letrec*
                                  ((x7874
                                    (begin
                                      (write '(funapp 1450 43))
                                      (display "\n")
                                      (cdr xs)))
                                   (x7873
                                    (begin
                                      (write '(funapp 1450 60))
                                      (display "\n")
                                      (cdr ys))))
                                  (begin
                                    (write '(funapp 1451 35))
                                    (display "\n")
                                    (zip x7874 x7873)))))
                               (begin
                                 (write '(funapp 1452 32))
                                 (display "\n")
                                 (cons x7875 x7872)))))
                            g7871)
                           (letrec*
                  ...
                  (letrec*
                   ((g7883
                     (letrec*
                      ((xs
                        (begin
                          (write '(funapp 1473 28))
                          (display "\n")
                          (mk-list n))))
                      (letrec*
                       ((g7884
                         (begin
                           (write '(funapp 1474 40))
                           (display "\n")
                           (zip xs xs))))
                       g7884))))
                   g7883))))
                          ...
                          ((g7889
                            (lambda (g7331)
                              (letrec*
                               ...
                               g7890))))
                          g7889))
                       (begin (write '(funapp 1495 21)) (display "\n") 'module)
                       (begin
                         (write '(funapp 1496 21))
                         (display "\n")
                         'importer)
                       mk-list)))
                   (x7887 (input)))
                  (begin
                    (write '(funapp 1499 19))
                    (display "\n")
                    (x7888 x7887))))
                (g7886
                 (letrec*
