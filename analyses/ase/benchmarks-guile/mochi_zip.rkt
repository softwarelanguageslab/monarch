                     ...
                     (letrec*
                      ((x-cnd7864
                        (letrec*
                         ((x7866
                           (begin
                             (write '(funapp 1430 34))
                             (display "\n")
                             (empty? xs)))
                          (x7865
                           (begin
                             (write '(funapp 1430 54))
                             (display "\n")
                             (empty? ys))))
                         (begin
                           (write '(funapp 1431 26))
                           (display "\n")
                           (and x7866 x7865)))))
                      (if x-cnd7864
                        (letrec* ((g7867 empty)) g7867)
                        (letrec*
                         ((x-cnd7868
                           (letrec*
                            ((x7870
                              (begin
                                (write '(funapp 1437 37))
                                (display "\n")
                                (cons? xs)))
                             (x7869
                              (begin
                                ...
                                (x7872
                                 (letrec*
                                  ((x7874
                                   ...
                                   (x7873
                                    (begin
                                      (write '(funapp 1449 60))
                                      (display "\n")
                                      (cdr ys))))
                                  (begin
                                    (write '(funapp 1450 35))
                                    (display "\n")
                                    (zip x7874 x7873)))))
                               (begin
                                 (write '(funapp 1451 32))
                                 (display "\n")
                                 (cons x7875 x7872)))))
                            g7871)
                           (letrec*
                  ...
                  (letrec*
                   ((g7883
                     (letrec*
                      ((xs
                        (begin
                          (write '(funapp 1472 28))
                          (display "\n")
                          (mk-list n))))
                      (letrec*
                       ((g7884
                         (begin
                           (write '(funapp 1473 40))
                           (display "\n")
                           (zip xs xs))))
                       g7884))))
                   g7883))))
                                  ...
                                  ((x7893
                                   ...
                                   (x7891
                                    (letrec*
                                     ...
                                     (begin
                                       (write '(funapp 1490 36))
                                       (display "\n")
                                       (f7334 x7892)))))
                                  (begin
                                    (write '(funapp 1491 33))
                                    (display "\n")
                                    (x7893 j7332 k7333 x7891)))))
                               g7890))))
                          g7889))
                       (begin (write '(funapp 1494 21)) (display "\n") 'module)
                       (begin
                                 ...
                                 (letrec*
                                  ((x7900
                                    (letrec*
                                     ((x7901
                                       (begin
                                         (write '(funapp 1511 44))
                                         (display "\n")
                                         (cons/c integer?/c integer?/c))))
                                     (begin
                                       (write '(funapp 1512 36))
                                       (display "\n")
                                       (listof x7901))))
                                   (x7898
                                    (letrec*
                                     ...
                                     (begin
                                       (write '(funapp 1516 36))
                                       (display "\n")
                                       (f7338 x7899)))))
                                  (begin
                                    (write '(funapp 1517 33))
                                    (display "\n")
                                    (x7900 j7336 k7337 x7898)))))
                               g7897))))
                          g7896))
                       (begin (write '(funapp 1520 21)) (display "\n") 'module)
                       (begin
                         (write '(funapp 1521 21))
                         (display "\n")
                         'importer)
                       main)))
                   (x7894 (input)))
