                                       ...
                                       (letrec*
                                        ((x7877
                                          (begin
                                            ...
                                            (listof any/c))))
                                        (begin
                                          (write '(funapp 1430 39))
                                          (display "\n")
                                          (x7877 j7329 k7330 g7327))))
                                      (x7874
                                       (letrec*
                                        ((x7875
                                          (begin
                                            ...
                                            (listof any/c))))
                                        (begin
                                          (write '(funapp 1434 39))
                                          (display "\n")
                                          (x7875 j7329 k7330 g7328)))))
                                     (begin
                                       (write '(funapp 1435 36))
                                       (display "\n")
                                       (f7331 x7876 x7874)))))
                                  (begin
                                    (write '(funapp 1436 33))
                                    (display "\n")
                                    (x7878 j7329 k7330 x7873)))))
                               g7872))))
                          g7871))
                       (begin (write '(funapp 1439 21)) (display "\n") 'module)
                       (begin
