            ...
            (g7341
             (letrec*
              ((empty (begin (write '(funapp 56 22)) (display "\n") '()))
               ...
               (id
                (letrec*
                 ((x7850 (begin (write '(funapp 1415 37)) (display "\n") (x))))
                 (begin (write '(funapp 1415 43)) (display "\n") (λ x7850 x))))
               (blur
                (letrec*
                 ((x7851 (begin (write '(funapp 1416 39)) (display "\n") (y))))
                 (begin (write '(funapp 1416 45)) (display "\n") (λ x7851 y))))
               (lp
                (letrec*
                 ((x7863 (begin (write '(funapp 1419 26)) (display "\n") (a)))
                  (x7852
                   (letrec*
                    ((x7862
                      (begin (write '(funapp 1422 29)) (display "\n") (n)))
                     (x7853
                      (letrec*
                       ((x-cnd7854
                         (begin
                          ...
                          ((r
                           ...
                           (s
                            (letrec*
                             ((x7856
                               (begin
                                 (write '(funapp 1430 48))
                                 (display "\n")
                                 (blur id))))
                             (begin
                               (write '(funapp 1430 60))
                               (display "\n")
                               (x7856 #f)))))
                          (letrec*
                           ((g7857
                                   ...
                                   (letrec*
                                    ((x7861
                                      (begin
                                        ...
                                        (blur lp))))
                                    (begin
                                      (write '(funapp 1437 65))
                                      (display "\n")
                                      (x7861 s))))
                                  (x7859
                                   (begin
                                     (write '(funapp 1438 42))
                                     (display "\n")
                                     (sub1 n))))
                                 (begin
                                   (write '(funapp 1439 34))
                                   (display "\n")
                                   (x7860 x7859)))))
                              (begin
                                (write '(funapp 1440 31))
                                (display "\n")
                                (not x7858)))))
                           g7857))))))
                    (begin
              ...
              (letrec*
               ((g7864
                 (letrec*
                  ((x7865
                    (begin (write '(funapp 1445 41)) (display "\n") (lp #f))))
                  (begin (write '(funapp 1445 51)) (display "\n") (x7865 2)))))
               g7864))))
           g7341))))
       g7339)))
    g7338)))
