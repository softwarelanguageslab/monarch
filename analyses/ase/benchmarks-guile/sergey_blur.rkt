             ...
             (letrec*
                      ...
                      (if x-cnd7995
                        ...
                        (letrec*
                         ...
                         (begin
                           ...
                           (gcd b x7996)))))))
                   g7994)))
               (id (lambda (x) (letrec* ((g7997 x)) g7997)))
               (blur (lambda (y) (letrec* ((g7998 y)) g7998)))
               (lp
                (lambda (a)
                  (letrec*
                   ((g7999
                                       ...
                                       (letrec*
                                        ((x8008
                                          (begin
                                            ...
                                            (blur lp))))
                                        (begin
                                          (write '(funapp 1717 69))
                                          (display "\n")
                                          (x8008 s))))
                                      (x8006
                                       (begin
                                         (write '(funapp 1718 46))
                                         (display "\n")
                                         (sub1 n))))
                                     (begin
                                       (write '(funapp 1719 38))
                                       (display "\n")
                                       (x8007 x8006)))))
                                  (begin
              ...
              (letrec*
               ((g8009
                 (letrec*
                  ((x8010
                    (begin (write '(funapp 1725 41)) (display "\n") (lp #f))))
                  (begin (write '(funapp 1725 51)) (display "\n") (x8010 2)))))
               g8009))))
           g7430))))
       g7413)))
    g7412)))
