               ...
               (letrec*
                ((empty (begin (write '(funapp 57 24)) (display "\n") '()))
                 ...
                 (id
                  (letrec*
                   ((x7836
                     (begin (write '(funapp 1349 39)) (display "\n") (x))))
                   (begin
                 ...
                 (blur
                  (letrec*
                   ((x7837
                     (begin (write '(funapp 1350 41)) (display "\n") (y))))
                   (begin
                 ...
                 (lp
                  (letrec*
                   ((x7849
                     (begin (write '(funapp 1353 28)) (display "\n") (a)))
                    (x7838
                     (letrec*
                      ((x7848
                        (begin (write '(funapp 1356 31)) (display "\n") (n)))
                       (x7839
                        (letrec*
                         ((x-cnd7840
                           (begin
                           ...
                           (letrec*
                            ((r
                              (letrec*
                               ((x7841
                                 (begin
                                   (write '(funapp 1363 50))
                                   (display "\n")
                                   (blur id))))
                               (begin
                                 (write '(funapp 1363 62))
                                 (display "\n")
                                 (x7841 #t))))
                             (s
                              (letrec*
                                     ...
                                     (letrec*
                                      ((x7847
                                        (begin
                                          ...
                                          (blur lp))))
                                      (begin
                                        (write '(funapp 1371 67))
                                        (display "\n")
                                        (x7847 s))))
                                    (x7845
                                     (begin
                                       (write '(funapp 1372 44))
                                       (display "\n")
                                       (sub1 n))))
                                   (begin
                                     (write '(funapp 1373 36))
                                     (display "\n")
                                     (x7846 x7845)))))
                                (begin
                                  (write '(funapp 1374 33))
                                  (display "\n")
                                  (not x7844)))))
                             g7843))))))
                      (begin
