            ...
            (g7344
             (letrec*
              ((empty (begin (write '(funapp 56 22)) (display "\n") '()))
               ...
               (id
                (letrec*
                 ((x7855 (begin (write '(funapp 1423 37)) (display "\n") (x))))
                 (begin (write '(funapp 1423 43)) (display "\n") (λ x7855 x))))
               (blur
                (letrec*
                 ((x7856 (begin (write '(funapp 1424 39)) (display "\n") (y))))
                 (begin (write '(funapp 1424 45)) (display "\n") (λ x7856 y))))
               (lp
                (letrec*
                 ((x7868 (begin (write '(funapp 1427 26)) (display "\n") (a)))
                  (x7857
                   (letrec*
                    ((x7867
                      (begin (write '(funapp 1430 29)) (display "\n") (n)))
                     (x7858
                      (letrec*
                       ((x-cnd7859
                         (begin
                              ...
                              ((x7863
                                (letrec*
                                 ((x7865
                                  ...
                                  (x7864
                                   (begin
                                     (write '(funapp 1446 42))
                                     (display "\n")
                                     (sub1 n))))
                                 (begin
                                   (write '(funapp 1447 34))
                                   (display "\n")
                                   (x7865 x7864)))))
                              (begin
                                (write '(funapp 1448 31))
                                (display "\n")
                                (not x7863)))))
                           g7862))))))
                    (begin
              ...
              (letrec*
               ((g7869
                 (letrec*
                  ((x7870
                    (begin (write '(funapp 1453 41)) (display "\n") (lp #f))))
                  (begin (write '(funapp 1453 51)) (display "\n") (x7870 2)))))
               g7869))))
           g7344))))
       g7342)))
    g7341)))
