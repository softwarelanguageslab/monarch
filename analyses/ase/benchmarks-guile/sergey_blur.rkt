             ...
             (letrec*
                      ...
                      (if x-cnd7997
                        ...
                        (letrec*
                         ...
                         (begin
                           ...
                           (gcd b x7998)))))))
                   g7996)))
               (id (lambda (x) (letrec* ((g7999 x)) g7999)))
               (blur (lambda (y) (letrec* ((g8000 y)) g8000)))
               (lp
                (lambda (a)
                  (letrec*
                   ((g8001
                             ...
                             (letrec*
                              ((r
                                (letrec*
                                 ((x8004
                                   (begin
                                     (write '(funapp 1711 52))
                                     (display "\n")
                                     (blur id))))
                                 (begin
                                   (write '(funapp 1711 64))
                                   (display "\n")
                                   (x8004 #t))))
                               (s
                                (letrec*
                                 ((x8005
                                   (begin
                                     (write '(funapp 1712 52))
                                     (display "\n")
                                     (blur id))))
                                 (begin
                                   (write '(funapp 1712 64))
                                   (display "\n")
                                   (x8005 #f)))))
                              (letrec*
                               ((g8006
                                    ...
                                    (letrec*
                                     ((x8009
                                       (letrec*
                                        ((x8010
                                          (begin
                                            (write '(funapp 1719 57))
                                            (display "\n")
                                            (blur lp))))
                                        (begin
                                          (write '(funapp 1719 69))
                                          (display "\n")
                                          (x8010 s))))
                                      (x8008
                                       (begin
                                         (write '(funapp 1720 46))
                                         (display "\n")
                                         (sub1 n))))
                                     (begin
                                       (write '(funapp 1721 38))
                                       (display "\n")
                                       (x8009 x8008)))))
                                  (begin
              ...
              (letrec*
               ((g8011
                 (letrec*
                  ((x8012
                    (begin (write '(funapp 1727 41)) (display "\n") (lp #f))))
                  (begin (write '(funapp 1727 51)) (display "\n") (x8012 2)))))
               g8011))))
           g7430))))
       g7413)))
    g7412)))
