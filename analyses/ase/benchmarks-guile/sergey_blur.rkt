             ...
             (letrec*
                      ...
                      (if x-cnd7996
                        ...
                        (letrec*
                         ...
                         (begin
                           ...
                           (gcd b x7997)))))))
                   g7995)))
               (id (lambda (x) (letrec* ((g7998 x)) g7998)))
               (blur (lambda (y) (letrec* ((g7999 y)) g7999)))
               (lp
                (lambda (a)
                  (letrec*
                   ((g8000
                             ...
                             (letrec*
                              ((r
                                (letrec*
                                 ((x8003
                                   (begin
                                     (write '(funapp 1710 52))
                                     (display "\n")
                                     (blur id))))
                                 (begin
                                   (write '(funapp 1710 64))
                                   (display "\n")
                                   (x8003 #t))))
                               (s
                                (letrec*
                                    ...
                                    (letrec*
                                     ((x8008
                                       (letrec*
                                        ((x8009
                                          (begin
                                            (write '(funapp 1718 57))
                                            (display "\n")
                                            (blur lp))))
                                        (begin
                                          (write '(funapp 1718 69))
                                          (display "\n")
                                          (x8009 s))))
                                      (x8007
                                       (begin
                                         (write '(funapp 1719 46))
                                         (display "\n")
                                         (sub1 n))))
                                     (begin
                                       (write '(funapp 1720 38))
                                       (display "\n")
                                       (x8008 x8007)))))
                                  (begin
              ...
              (letrec*
               ((g8010
                 (letrec*
                  ((x8011
                    (begin (write '(funapp 1726 41)) (display "\n") (lp #f))))
                  (begin (write '(funapp 1726 51)) (display "\n") (x8011 2)))))
               g8010))))
           g7430))))
       g7413)))
    g7412)))
