               ...
               (tak-main
                (lambda (x y z)
                  (letrec*
                   ((g8016
                     (begin
                       (write '(funapp 1740 22))
                       (display "\n")
                       (tak x y z (lambda (x) (letrec* ((g8017 x)) g8017))))))
                   g8016))))
              (letrec*
               ((g8018
                 (begin
                                            ...
                                            ((x8026
                                              (letrec*
                                               ...
                                               (begin
                                                 ...
                                                 (display "\n")
                                                 (f7409 x8029 x8028 x8027)))))
                                            (begin
                                              (write '(funapp 1768 39))
                                              (display "\n")
                                              (integer?/c
                                               j7407
                                               k7408
