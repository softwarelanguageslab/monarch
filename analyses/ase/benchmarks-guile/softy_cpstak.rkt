                              ...
                              (letrec*
                               ((g7864
                                 (letrec*
                                  ((x7868
                                    (begin
                                      (write '(funapp 1442 41))
                                      (display "\n")
                                      (- y 1))))
                                  (begin
                                    (write '(funapp 1443 33))
                                    (display "\n")
                                    (tak
                                     x7868
                                     z
                                  ...
                                  ((x7880
                                    (letrec*
                                     ((x7883
                                      ...
                                      (x7881
                                       (begin
                                         (write '(funapp 1486 44))
                                         (display "\n")
                                         (integer?/c j7334 k7335 g7333))))
                                     (begin
                                       (write '(funapp 1487 36))
                                       (display "\n")
                                       (f7336 x7883 x7882 x7881)))))
                                  (begin
                                    (write '(funapp 1488 33))
                                    (display "\n")
                                    (integer?/c j7334 k7335 x7880)))))
                               g7879))))
                          g7878))
                       (begin (write '(funapp 1491 21)) (display "\n") 'module)
                       (begin
                         (write '(funapp 1492 21))
                         (display "\n")
                         'importer)
                       tak-main)))
                   (x7876 (input))
