                     ...
                     (letrec*
                      ((x-cnd7891
                        (letrec*
                         ((x7892
                           (begin
                             (write '(funapp 1475 52))
                             (display "\n")
                             (< y x))))
                         (begin
                           (write '(funapp 1475 62))
                           (display "\n")
                           (not x7892)))))
                      (if x-cnd7891
                     ...
                     ((xj7349
                      ...
                      (xk7350
                       (letrec*
                        ((x7908
                          (begin
                            (write '(funapp 1524 41))
                            (display "\n")
                            (loc))))
                        (begin
                          (write '(funapp 1524 49))
                          (display "\n")
                          (cons
                           (begin
                             (write '(funapp 1524 54))
                             (display "\n")
                             'importer)
                           x7908)))))
                     (letrec*
                                      ...
                                      ((x7912
                                        (letrec*
                                         ((x7915
                                          ...
                                          (x7913
                                           (begin
                                             (write '(funapp 1538 48))
                                             (display "\n")
                                             (integer?/c j7354 k7355 g7353))))
                                         (begin
                                           (write '(funapp 1539 40))
                                           (display "\n")
                                           (f7356 x7915 x7914 x7913)))))
                                      (begin
                                        (write '(funapp 1540 37))
                                        (display "\n")
                                        (integer?/c j7354 k7355 x7912)))))
                                   g7911))))
                              g7910))
                           xj7349
                           xk7350
