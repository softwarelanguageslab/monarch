                     ...
                     (letrec*
                      ((x-cnd8006
                        (letrec*
                         ((x8007
                           (begin
                             (write '(funapp 1700 52))
                             (display "\n")
                             (< y x))))
                         (begin
                           (write '(funapp 1700 62))
                           (display "\n")
                           (not x8007)))))
                      (if x-cnd8006
               ...
               (tak-main
                (lambda (x y z)
                  (letrec*
                   ((g8014
                     (begin
                       (write '(funapp 1738 22))
                       (display "\n")
                       (tak x y z (lambda (x) (letrec* ((g8015 x)) g8015))))))
                   g8014))))
              (letrec*
               ((g8016
                 (begin
