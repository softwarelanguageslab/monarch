                       ...
                       (letrec*
                        ...
                        (if x-cnd7841
                          (letrec*
                           ((x7843
                             (begin
                               (write '(funapp 1356 44))
                               (display "\n")
                               (cdr x))))
                           (begin
                             (write '(funapp 1356 54))
                             (display "\n")
                             (lastpair x7843)))
                          x))))
                     g7840))))
                                   ...
                                   (letrec*
                                    ((x7849
                                      (letrec*
                                       ((x7850
                                         (begin
                                           (write '(funapp 1372 46))
                                           (display "\n")
                                           (pair? j7328 k7329 g7327))))
                                       (begin
                                         (write '(funapp 1373 38))
                                         (display "\n")
                                         (f7330 x7850)))))
                                    (begin
                                      (write '(funapp 1374 35))
                                      (display "\n")
                                      (pair? j7328 k7329 x7849)))))
                                 g7848))))
                            g7847))
                         (begin
