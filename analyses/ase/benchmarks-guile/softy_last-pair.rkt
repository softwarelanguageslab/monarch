                                  ...
                                  ((x7870
                                    (letrec*
                                     ...
                                     (begin
                                       ...
                                       (f7330 x7871)))))
                                  (begin
                                    (write '(funapp 1424 33))
                                    (display "\n")
                                    (pair? j7328 k7329 x7870)))))
                               g7869))))
                          g7868))
                       (begin (write '(funapp 1427 21)) (display "\n") 'module)
                       (begin
                         (write '(funapp 1428 21))
                         (display "\n")
                         'importer)
                       lastpair)))
                   (x7866 (input)))
                  (begin
                    (write '(funapp 1431 19))
                    (display "\n")
                    (x7867 x7866)))))
               g7865))))
           g7344))))
