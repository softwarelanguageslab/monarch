                                    ...
                                    (letrec*
                                     ((x7864
                                       (begin
                                         ...
                                         (display "\n")
                                         (pair? j7329 k7330 g7328))))
                                     (begin
                                       (write '(funapp 1439 36))
                                       (display "\n")
                                       (f7331 x7864)))))
                                  (begin
                                    (write '(funapp 1440 33))
                                    (display "\n")
                                    (pair? j7329 k7330 x7863)))))
                               g7862))))
                          g7861))
                       (begin (write '(funapp 1443 21)) (display "\n") 'module)
                       (begin
