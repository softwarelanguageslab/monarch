            ...
            (g7427
             (letrec*
              ...
              (letrec*
               ((g7985
                 (begin
                   (write '(funapp 1664 18))
                   (display "\n")
                   (parallel
                    (begin
                      (write '(funapp 1665 19))
                      (display "\n")
                      (parallel
                       (letrec*
                        ((x7987
                           ...
                           ((xj7394
                            ...
                            (xk7395
                             (begin
                               ...
                               (loc
                                (begin
                                  (write '(funapp 1669 60))
                                  (display "\n")
                                  'importer)))))
                           (letrec*
                            ((g7988
                              (begin
                                (write '(funapp 1672 27))
                                (display "\n")
                                           ...
                                           (letrec*
                                            ((x7991
                                              (letrec*
                                               ...
                                               (begin
                                                 (write '(funapp 1682 42))
                                                 (display "\n")
                                                 (f7399 x7992)))))
                                            (begin
                                              (write '(funapp 1683 39))
                                              (display "\n")
