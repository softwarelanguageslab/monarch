                                   ...
                                   (letrec*
                                    ((x7914
                                      (letrec*
                                       ((x7915
                                         (begin
                                           (write '(funapp 1545 46))
                                           (display "\n")
                                           (integer?/c j7342 k7343 g7341))))
                                       (begin
                                         (write '(funapp 1546 38))
                                         (display "\n")
                                         (f7344 x7915)))))
                                    (begin
                                      (write '(funapp 1547 35))
                                      (display "\n")
