    ...
    (nonzero?
     (lambda (v)
       (letrec*
        ((g7375
          (letrec*
           ((x7376 (begin (write '(funapp 37 42)) (display "\n") (= v 0))))
      ...
      (letrec*
       ((g7378
         (letrec*
          ...
          (letrec*
           ((g7379 (begin (write '(funapp 53 19)) (display "\n") '()))
            (g7380
             (letrec*
                    ...
                    (letrec*
                     ((xj7349
                       (letrec*
                        ((x7916
                          (begin
                            (write '(funapp 1503 48))
                            (display "\n")
                            (loc))))
                        (begin
                          (write '(funapp 1503 56))
                          (display "\n")
                          (cons
                           (begin
                      ...
                      (xk7350
                       (letrec*
                        ((x7917
                          (begin
                            (write '(funapp 1505 41))
                            (display "\n")
                            (loc))))
                        (begin
                          (write '(funapp 1505 49))
                          (display "\n")
                          (cons
                           (begin
                             (write '(funapp 1505 54))
                             (display "\n")
                             'importer)
                           x7917)))))
                     (letrec*
                                         ...
                                         ((x7924
                                          ...
                                          (x7922
                                           (letrec*
                                            ((x7923
                                              (begin
                                                (write '(funapp 1546 51))
                                                (display "\n")
                                                (listof any/c))))
                                            (begin
                                              (write '(funapp 1547 43))
                                              (display "\n")
                                              (x7923 j7353 k7354 g7352)))))
                                         (begin
                                           (write '(funapp 1548 40))
                                           (display "\n")
                                           (f7355 x7924 x7922)))))
                                      (begin
                                        (write '(funapp 1549 37))
                                        (display "\n")
                                        (x7930 j7353 k7354 x7921)))))
                                   g7920))))
                              g7919))
                           xj7349
                           xk7350
                                        ...
                                        (letrec*
                                         ((x7942
                                           (letrec*
                                            ((x7943
                                              (begin
                                                (write '(funapp 1580 51))
                                                (display "\n")
                                                (listof any/c))))
                                            (begin
                                              (write '(funapp 1581 43))
                                              (display "\n")
                                              (x7943 j7364 k7365 g7362))))
                                          (x7940
                                           (letrec*
                                            ((x7941
                                              (begin
                                                (write '(funapp 1584 51))
                                                (display "\n")
                                                (listof any/c))))
                                            (begin
                                              (write '(funapp 1585 43))
                                              (display "\n")
                                              (x7941 j7364 k7365 g7363)))))
                                         (begin
                                           (write '(funapp 1586 40))
                                           (display "\n")
                                           (f7366 x7942 x7940)))))
                                      (begin
                                        (write '(funapp 1587 37))
                                        (display "\n")
                                        (x7944 j7364 k7365 x7939)))))
                                   g7938))))
                              g7937))
                           xj7360
                           xk7361
