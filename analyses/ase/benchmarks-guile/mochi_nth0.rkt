            ...
            (g7436
             (letrec*
              ...
              (letrec*
               ((g8016
                 (begin
                   (write '(funapp 1736 18))
                   (display "\n")
                   (parallel
                    (begin
                      (write '(funapp 1737 19))
                      (display "\n")
                      (parallel
                       (letrec*
                        ((x8018
