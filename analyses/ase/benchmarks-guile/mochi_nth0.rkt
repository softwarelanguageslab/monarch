                                    ...
                                    ((x7856
                                      (letrec*
                                       ...
                                       (begin
                                         ...
                                         (f7330 x7857)))))
                                    (begin
                                      (write '(funapp 1402 35))
                                      (display "\n")
                                      (integer?/c j7328 k7329 x7856)))))
                                 g7855))))
                            g7854))
                         (begin
                           ...
                           'module)
                         (begin
                           (write '(funapp 1406 23))
                           (display "\n")
                           'importer)
                         main)))
                     (x7852 (input)))
                    (begin
                      (write '(funapp 1409 21))
                      (display "\n")
                      (x7853 x7852)))))
                 g7851))))
             g7344))))
