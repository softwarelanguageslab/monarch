                              ...
                              (letrec*
                               ((g7863
                                 (letrec*
                                  ((c
                                    (begin
                                      (write '(funapp 1440 39))
                                      (display "\n")
                                      (f2 #f))))
                                  (letrec*
                                   ((g7864
                                     (begin
                                       (write '(funapp 1441 52))
                                       (display "\n")
                                       (f2 #t))))
                                   g7864))))
                               g7863))))
                             ...
                             (letrec*
                              ((x7857
                                (letrec*
                                 ((x7859
                                   (begin
                                     (write '(funapp 1451 42))
                                     (display "\n")
                                     (z)))
                                  (x7858
                                   (begin
                                     (write '(funapp 1451 54))
                                     (display "\n")
                                     (z x1 x2))))
                                 (begin
                                   (write '(funapp 1452 34))
                                   (display "\n")
                                   (λ x7859 x7858))))
                               (x7855
                                (letrec*
                                 ...
                                 (begin
                                   ...
                                   (λ x7856 y1)))))
                              (begin
                                (write '(funapp 1455 31))
                                (display "\n")
                                (x7857 x7855)))))
                           (begin
                             (write '(funapp 1456 28))
                             (display "\n")
                             (λ x7860 x7854)))))
                        (begin
                          (write '(funapp 1457 25))
                          (display "\n")
                          (x7861 x7853)))))
                     (begin
                       (write '(funapp 1458 22))
                       (display "\n")
                       (λ x7866 x7852)))))
                  (begin
                    (write '(funapp 1459 19))
                    (display "\n")
                    (x7867 x7851)))))
               g7850))))
           g7341))))
