               ...
               ((g7855
                 (letrec*
                  ((x7872
                    (letrec*
                     ((x7875
                       (begin (write '(funapp 1429 30)) (display "\n") (f1)))
                      (x7873
                       (letrec*
                        ((a
                          (begin
                            (write '(funapp 1432 29))
                            (display "\n")
                            (f1 #t))))
                        (letrec*
                         ((g7874
                         ...
                         g7874))))
                     (begin
                       (write '(funapp 1434 22))
                       (display "\n")
                       (λ x7875 x7873))))
                   (x7856
                    (letrec*
                     ((x7871
                       (begin (write '(funapp 1437 30)) (display "\n") (x1)))
                      (x7857
                       (letrec*
                        ((x7866
                          (letrec*
                              ...
                              (letrec*
                               ((g7868
                                 (letrec*
                                  ((c
                                    (begin
                                      (write '(funapp 1449 39))
                                      (display "\n")
                                      (f2 #f))))
                                  (letrec*
                                   ((g7869
                                     (begin
                                       (write '(funapp 1450 52))
                                       (display "\n")
                                       (f2 #t))))
                                   g7869))))
                               g7868))))
                              ...
                              ((x7862
                               ...
                               (x7860
                                (letrec*
                                 ((x7861
                                   (begin
                                     (write '(funapp 1463 50))
                                     (display "\n")
                                     (y1 y2))))
                                 (begin
                                   (write '(funapp 1463 60))
                                   (display "\n")
                                   (λ x7861 y1)))))
                              (begin
                                (write '(funapp 1464 31))
                                (display "\n")
                                (x7862 x7860)))))
                           (begin
                             (write '(funapp 1465 28))
                             (display "\n")
                             (λ x7865 x7859)))))
                        (begin
                          (write '(funapp 1466 25))
                          (display "\n")
                          (x7866 x7858)))))
                     (begin
                       (write '(funapp 1467 22))
                       (display "\n")
                       (λ x7871 x7857)))))
                  (begin
                    (write '(funapp 1468 19))
                    (display "\n")
                    (x7872 x7856)))))
               g7855))))
           g7344))))
