                              ...
                              (letrec*
                               ((g7895
                                 (letrec*
                                  ((c
                                    (begin
                                      (write '(funapp 1496 39))
                                      (display "\n")
                                      (f2 #f))))
                                  (letrec*
                                   ((g7896
                                     (begin
                                       (write '(funapp 1497 52))
                                       (display "\n")
                                       (f2 #t))))
                                   g7896))))
                               g7895))))
                           (begin
                             (write '(funapp 1499 28))
                             (display "\n")
                             (λ x7897 x7894))))
                         (x7885
                          (letrec*
                              ...
                              ((x7889
                                (letrec*
                                 ((x7891
                                  ...
                                  (x7890
                                   (begin
                                     (write '(funapp 1507 54))
                                     (display "\n")
                                     (z x1 x2))))
                                 (begin
                                   (write '(funapp 1508 34))
                                   (display "\n")
                                   (λ x7891 x7890))))
                               (x7887
                                (letrec*
                                 ...
                                 (begin
                                   ...
                                   (λ x7888 y1)))))
                              (begin
                                (write '(funapp 1511 31))
                                (display "\n")
                                (x7889 x7887)))))
                           (begin
                             (write '(funapp 1512 28))
                             (display "\n")
                             (λ x7892 x7886)))))
                        (begin
