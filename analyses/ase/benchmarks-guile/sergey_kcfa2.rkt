               ...
               ((g7882
                 (letrec*
                  ((x7899
                    (letrec*
                     ((x7902
                       (begin (write '(funapp 1475 30)) (display "\n") (f1)))
                      (x7900
                       (letrec*
                        ((a
                          (begin
                        ...
                        (letrec*
                         ...
                         g7901))))
                     (begin
                       (write '(funapp 1480 22))
                       (display "\n")
                       (λ x7902 x7900))))
                   (x7883
                    (letrec*
                     ((x7898
                       (begin (write '(funapp 1483 30)) (display "\n") (x1)))
                      (x7884
                       (letrec*
                        ((x7893
                          (letrec*
                              ...
                              ((x7889
                               ...
                               (x7887
                                (letrec*
                                 ((x7888
                                   (begin
                                     (write '(funapp 1509 50))
                                     (display "\n")
                                     (y1 y2))))
                                 (begin
                                   (write '(funapp 1509 60))
                                   (display "\n")
                                   (λ x7888 y1)))))
                              (begin
                                (write '(funapp 1510 31))
                                (display "\n")
                                (x7889 x7887)))))
                           (begin
                             (write '(funapp 1511 28))
                             (display "\n")
                             (λ x7892 x7886)))))
                        (begin
                          (write '(funapp 1512 25))
                          (display "\n")
                          (x7893 x7885)))))
                     (begin
                       (write '(funapp 1513 22))
                       (display "\n")
                       (λ x7898 x7884)))))
                  (begin
                    (write '(funapp 1514 19))
                    (display "\n")
                    (x7899 x7883)))))
               g7882))))
           g7362))))
