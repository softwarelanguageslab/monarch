                              ...
                              (letrec*
                               ((g7870
                                 (letrec*
                                  ((c
                                    (begin
                                      (write '(funapp 1424 39))
                                      (display "\n")
                                      (f2 #f))))
                                  (letrec*
                                   ((g7871
                                     (begin
                                       (write '(funapp 1425 52))
                                       (display "\n")
                                       (f2 #t))))
                                   g7871))))
                               g7870))))
                               ...
                               (x7862
                                (letrec*
                                 ...
                                 (begin
                                   ...
                                   (λ x7863 y1)))))
                              (begin
                                (write '(funapp 1439 31))
                                (display "\n")
                                (x7864 x7862)))))
                           (begin
                             (write '(funapp 1440 28))
                             (display "\n")
                             (λ x7867 x7861)))))
                        (begin
                          ...
                          (x7868 x7860)))))
                     (begin
                       (write '(funapp 1442 22))
                       (display "\n")
                       (λ x7873 x7859)))))
                  (begin
                    (write '(funapp 1443 19))
                    (display "\n")
                    (x7874 x7858)))))
               g7857))))
           g7340))))
