                       ...
                       (letrec*
                        ((val7245
                          (begin
                            ...
                            (display "\n")
                            (= x y))))
                        (letrec* ((g7420 (if val7245 val7245 #f))) g7420)))))
                   g7419))))
               g7417)))
           (<=
            (lambda (x y)
                       ...
                       (letrec*
                        ((val7247
                          (begin
                            ...
                            (display "\n")
                            (= x y))))
                        (letrec* ((g7425 (if val7247 val7247 #f))) g7425)))))
                   g7424))))
               g7422)))
           (>
            (lambda (x y)
                     ...
                     (letrec*
                      ((x-cnd7442
                        (begin
                          (write '(funapp 148 25))
                          (display "\n")
                          ((lambda (v) (letrec* ((g7443 #t)) g7443)) g7273))))
                      (if x-cnd7442
                        g7273
                        (begin
                     ...
                     (letrec*
                      ((x-cnd7445
                        (begin
                          (write '(funapp 157 25))
                          (display "\n")
                          ((lambda (v) (letrec* ((g7446 #t)) g7446)) g7276))))
                      (if x-cnd7445
                        g7276
                        (begin
