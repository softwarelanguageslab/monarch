                       ...
                       (letrec*
                        ((g
                          (letrec*
                           ((x7852
                             (begin
                               (write '(funapp 1423 46))
                               (display "\n")
                               (z))))
                           (begin
                             (write '(funapp 1423 52))
                             (display "\n")
                             (λ x7852 z)))))
                        (letrec*
                         ((g7853
                           (letrec*
                            ((f
                              (letrec*
                               ((x7855
                                 (begin
                                   (write '(funapp 1429 40))
                                   (display "\n")
                                   (k)))
                                (x7854
                                 (if b
                                   (begin
                                     (write '(funapp 1429 58))
                                     (display "\n")
                                     (k 1))
                                   (begin
                                     (write '(funapp 1429 64))
                                     (display "\n")
                                     (k 2)))))
                               (begin
                                   ...
                                   ((x7857
                                     (letrec*
                                      ...
                                      (begin
                                        ...
                                        (λ x7858 x)))))
                                   (begin
                                     (write '(funapp 1438 36))
                                     (display "\n")
                                     (f x7857)))))
                                (letrec*
                                 ((g7859
                                   (begin
                                     (write '(funapp 1439 50))
                                     (display "\n")
                                     (g y))))
                                 g7859))))
                             g7856))))
