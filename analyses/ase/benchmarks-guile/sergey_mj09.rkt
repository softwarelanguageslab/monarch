                         ...
                         (letrec*
                          ((g
                            (letrec*
                             ((x7838
                               (begin
                                 (write '(funapp 1357 48))
                                 (display "\n")
                                 (z))))
                             (begin
                               (write '(funapp 1357 54))
                               (display "\n")
                               (λ x7838 z)))))
                          (letrec*
                           ((g7839
                             (letrec*
                              ((f
                                (letrec*
                                 ((x7841
                                   (begin
                                     (write '(funapp 1363 42))
                                     (display "\n")
                                     (k)))
                                  (x7840
                                   (if b
                                     (begin
                                       (write '(funapp 1363 60))
                                       (display "\n")
                                       (k 1))
                                     (begin
                                       (write '(funapp 1363 66))
                                       (display "\n")
                                       (k 2)))))
                                 (begin
                                   (write '(funapp 1364 34))
                                   (display "\n")
                                   (λ x7841 x7840)))))
                              (letrec*
                               ((g7842
                                    ...
                                    (letrec*
                                     ((x7843
                                       (letrec*
                                        ((x7844
                                          (begin
                                            (write '(funapp 1371 57))
                                            (display "\n")
                                            (x))))
                                        (begin
                                          (write '(funapp 1371 63))
                                          (display "\n")
                                          (λ x7844 x)))))
                                     (begin
