                           ...
                           (letrec*
                            ((f
                              (letrec*
                               ((x7862
                                 (begin
                                   (write '(funapp 1413 40))
                                   (display "\n")
                                   (k)))
                                (x7861
                                 (if b
                                   (begin
                                     (write '(funapp 1413 58))
                                     (display "\n")
                                     (k 1))
                                   (begin
                                     (write '(funapp 1413 64))
                                     (display "\n")
                                     (k 2)))))
                               (begin
                                 (write '(funapp 1414 32))
                                 (display "\n")
                                 (λ x7862 x7861)))))
                            (letrec*
                             ((g7863
