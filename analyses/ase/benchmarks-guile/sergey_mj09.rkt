                  ...
                  ((h
                    (lambda (b)
                      (letrec*
                       ((g7998
                         (letrec*
                          ((g (lambda (z) (letrec* ((g7999 z)) g7999))))
                          (letrec*
                           ((g8000
                             (letrec*
                              ((f
                                 ...
                                 (letrec*
                                  ((y
                                    (begin
                                      ...
                                      (f
                                       (lambda (x)
                                         (letrec* ((g8003 x)) g8003))))))
                                  (letrec*
                                   ((g8004
                                     (begin
                                       (write '(funapp 1719 52))
                                       (display "\n")
                                       (g y))))
                                   g8004))))
                               g8002))))
                  ...
                  (letrec*
                   ((g8005
                     (letrec*
                      ((x
                        (begin
                          (write '(funapp 1726 27))
                          (display "\n")
                          (h #t)))
                       (y
                        (begin
                          (write '(funapp 1726 38))
                          (display "\n")
                          (h #f))))
                      (letrec* ((g8006 y)) g8006))))
                   g8005))))
               g7997))))
           g7430))))
       g7413)))
