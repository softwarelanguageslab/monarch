              ...
              ((empty (begin (write '(funapp 56 22)) (display "\n") '()))
                                   ...
                                   (letrec*
                                    ...
                                    (if x-cnd7870
                                      ...
                                      (letrec*
                                       ((x-cnd7871
                                         (begin
                                           (write '(funapp 1442 50))
                                           (display "\n")
                                           (eq?
                                            (begin
                                              (write '(funapp 1442 54))
                                              (display "\n")
                                              'closed)
                                            v7333))))
                                       (if x-cnd7871
               ...
               (loop
                (lambda ()
                  (letrec*
                   ((g7872
                     (begin (write '(funapp 1461 50)) (display "\n") (loop))))
                   g7872)))
               (readit
                (lambda (st)
                  (letrec*
                  ...
                  (letrec*
                   ((g7889
                     (letrec*
                      ((x-cnd7890
                        (begin
                          (write '(funapp 1505 35))
                          (display "\n")
                          (equal?
                           (begin
                             (write '(funapp 1505 42))
                             (display "\n")
                             'init)
                           st))))
                      (if x-cnd7890
                        (begin
                          (write '(funapp 1506 36))
                          (display "\n")
                          'opened)
                        (begin
                      ...
                      (if x-cnd7896
                        ...
                        (begin
                          ...
                          (g
                           ...
                           #f
                           (begin
                             (write '(funapp 1524 63))
                             (display "\n")
                             'init))))))
                    (g7895
                     (begin (write '(funapp 1525 27)) (display "\n") 'unit)))
                   g7895))))
              (letrec*
               ((g7897
                 (letrec*
                          ...
                          ((g7901
                            (lambda (g7337 g7338)
                              (letrec*
                               ...
                               g7902))))
                          g7901))
                       (begin (write '(funapp 1546 21)) (display "\n") 'module)
                       (begin
