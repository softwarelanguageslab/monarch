                         ...
                         ((x7863
                          ...
                          (x7861
                           (letrec*
                            ((x7862
                              (begin
                                (write '(funapp 1441 51))
                                (display "\n")
                                (car l))))
                            (begin
                              (write '(funapp 1441 61))
                              (display "\n")
                              (cons x7862 ac)))))
                         (begin
                           (write '(funapp 1442 26))
                           (display "\n")
                           (reverse x7863 x7861)))))))
                   g7859)))
               (mk-list
                           ...
                           (letrec*
                            ((x7867
                              (begin
                                ...
                                (- n 1))))
                            (begin
                              (write '(funapp 1453 61))
                              (display "\n")
                              (mk-list x7867)))))
                         (begin
                           (write '(funapp 1454 26))
                           (display "\n")
                           (cons n x7866)))))))
                   g7864))))
              (letrec*
