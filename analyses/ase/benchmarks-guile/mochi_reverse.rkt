                         ...
                         (letrec*
                          ((x-cnd7988
                            (letrec*
                             ((x7989
                               (begin
                                 (write '(funapp 1670 46))
                                 (display "\n")
                                 (= len 0))))
                             (begin
                               (write '(funapp 1670 58))
                               (display "\n")
                               (not x7989)))))
                          (if x-cnd7988
                            (letrec*
                             ((x7990
                               (begin
                                 (write '(funapp 1672 46))
                                 (display "\n")
                                 (reverse xs empty))))
                             (begin
                               (write '(funapp 1672 67))
                               (display "\n")
                               (car x7990)))
                            0))))
                       g7987))))
                         ...
                         ((x7995
                          ...
                          (x7993
                           (letrec*
                            ((x7994
                              (begin
                                (write '(funapp 1686 51))
                                (display "\n")
                                (car l))))
                            (begin
                              (write '(funapp 1686 61))
                              (display "\n")
                              (cons x7994 ac)))))
                         (begin
                           (write '(funapp 1687 26))
                           (display "\n")
                           (reverse x7995 x7993)))))))
                   g7991)))
               (mk-list
                        ...
                        (letrec*
                         ((x7998
                           (letrec*
                            ((x7999
                              (begin
                                (write '(funapp 1698 51))
                                (display "\n")
                                (- n 1))))
                            (begin
                              (write '(funapp 1698 61))
                              (display "\n")
                              (mk-list x7999)))))
                         (begin
                           (write '(funapp 1699 26))
                           (display "\n")
                           (cons n x7998)))))))
                   g7996))))
              (letrec*
