                           ...
                           (letrec*
                            ((x-cnd7842
                              (letrec*
                               ((x7843
                                 (begin
                                   (write '(funapp 1359 48))
                                   (display "\n")
                                   (= len 0))))
                               (begin
                                 (write '(funapp 1359 60))
                                 (display "\n")
                                 (not x7843)))))
                            (if x-cnd7842
                              (letrec*
                               ((x7844
                                 (begin
                                   (write '(funapp 1362 40))
                                   (display "\n")
                                   (reverse xs empty))))
                               (begin
                                 (write '(funapp 1363 32))
                                 (display "\n")
                                 (car x7844)))
                              0))))
                         g7841))))
                          ...
                          (letrec*
                           ((x7852
                             (letrec*
                              ((x7853
                                (begin
                                  (write '(funapp 1391 47))
                                  (display "\n")
                                  (- n 1))))
                              (begin
                                (write '(funapp 1391 57))
                                (display "\n")
                                (mk-list x7853)))))
                           (begin
                             (write '(funapp 1392 28))
                             (display "\n")
                             (cons n x7852)))))))
                     g7850))))
                (letrec*
                                   ...
                                   (letrec*
                                    ((x7859
                                      (letrec*
                                       ((x7860
                                         (begin
                                           (write '(funapp 1407 46))
                                           (display "\n")
                                           (integer?/c j7328 k7329 g7327))))
                                       (begin
                                         (write '(funapp 1408 38))
                                         (display "\n")
                                         (f7330 x7860)))))
                                    (begin
                                      (write '(funapp 1409 35))
                                      (display "\n")
                                      (integer?/c j7328 k7329 x7859)))))
                                 g7858))))
                            g7857))
                         (begin
