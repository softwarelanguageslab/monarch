                         ...
                         ((x7897
                          ...
                          (x7895
                           (letrec*
                            ((x7896
                              (begin
                                (write '(funapp 1497 51))
                                (display "\n")
                                (car l))))
                            (begin
                              (write '(funapp 1497 61))
                              (display "\n")
                              (cons x7896 ac)))))
                         (begin
                           (write '(funapp 1498 26))
                           (display "\n")
                           (reverse x7897 x7895)))))))
                   g7893)))
               (mk-list
                 ...
                 (letrec*
                  ((x7904
                    (letrec*
                     ((xj7349
                       (begin
                         (write '(funapp 1517 31))
                         (display "\n")
                         (loc
                          (begin
                            (write '(funapp 1517 35))
                            (display "\n")
                            'module))))
                      (xk7350
                       (begin
                         (write '(funapp 1517 54))
                         (display "\n")
                         (loc
                          (begin
                            (write '(funapp 1517 58))
                            (display "\n")
                            'importer)))))
                     (letrec*
                      ((g7905
                        (begin
                          (write '(funapp 1520 25))
                          (display "\n")
                                     ...
                                     (letrec*
                                      ((x7908
                                        (letrec*
                                         ((x7909
                                           (begin
                                             (write '(funapp 1529 48))
                                             (display "\n")
                                             (integer?/c j7352 k7353 g7351))))
                                         (begin
                                           (write '(funapp 1530 40))
                                           (display "\n")
                                           (f7354 x7909)))))
                                      (begin
                                        (write '(funapp 1531 37))
                                        (display "\n")
                                        (integer?/c j7352 k7353 x7908)))))
                                   g7907))))
                              g7906))
                           xj7349
                           xk7350
