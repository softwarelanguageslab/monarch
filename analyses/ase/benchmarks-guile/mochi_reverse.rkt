                         ...
                         (letrec*
                          ...
                          (if x-cnd7983
                            (letrec*
                             ((x7985
                               (begin
                                 (write '(funapp 1664 46))
                                 (display "\n")
                                 (reverse xs empty))))
                             (begin
                               (write '(funapp 1664 67))
                               (display "\n")
                               (car x7985)))
                            0))))
                       g7982))))
                         ...
                         ((x7990
                          ...
                          (x7988
                           (letrec*
                            ((x7989
                              (begin
                                (write '(funapp 1678 51))
                                (display "\n")
                                (car l))))
                            (begin
                              (write '(funapp 1678 61))
                              (display "\n")
                              (cons x7989 ac)))))
                         (begin
                        ...
                        (letrec*
                         ((x7993
                           (letrec*
                            ((x7994
                              (begin
                                (write '(funapp 1690 51))
                                (display "\n")
                                (- n 1))))
                            (begin
                              (write '(funapp 1690 61))
                              (display "\n")
                              (mk-list x7994)))))
                         (begin
                           (write '(funapp 1691 26))
                           (display "\n")
                           (cons n x7993)))))))
                   g7991))))
              (letrec*
