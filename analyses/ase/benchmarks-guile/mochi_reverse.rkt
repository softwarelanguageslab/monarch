                         ...
                         (letrec*
                          ((x-cnd7983
                            (letrec*
                             ((x7984
                               (begin
                                 (write '(funapp 1666 46))
                                 (display "\n")
                                 (= len 0))))
                             (begin
                               (write '(funapp 1666 58))
                               (display "\n")
                               (not x7984)))))
                          (if x-cnd7983
                            (letrec*
                         ...
                         ((x7990
                          ...
                          (x7988
                           (letrec*
                            ((x7989
                              (begin
                                (write '(funapp 1682 51))
                                (display "\n")
                                (car l))))
                            (begin
                              (write '(funapp 1682 61))
                              (display "\n")
                              (cons x7989 ac)))))
                         (begin
                        ...
                        (letrec*
                         ((x7993
                           (letrec*
                            ((x7994
                              (begin
                                (write '(funapp 1694 51))
                                (display "\n")
                                (- n 1))))
                            (begin
                              (write '(funapp 1694 61))
                              (display "\n")
                              (mk-list x7994)))))
                         (begin
                           (write '(funapp 1695 26))
                           (display "\n")
                           (cons n x7993)))))))
                   g7991))))
              (letrec*
               ((g7995
                 (begin
                   (write '(funapp 1699 18))
                   (display "\n")
                   (parallel
                    (begin
                      (write '(funapp 1700 19))
                      (display "\n")
                      (parallel
                       (letrec*
                        ((x7997
