                         ...
                         (letrec*
                          ((x-cnd7861
                            (letrec*
                             ((x7862
                               (begin
                                 (write '(funapp 1434 46))
                                 (display "\n")
                                 (= len 0))))
                             (begin
                               (write '(funapp 1434 58))
                               (display "\n")
                               (not x7862)))))
                          (if x-cnd7861
                            (letrec*
                             ((x7863
                               (begin
                                 (write '(funapp 1436 46))
                                 (display "\n")
                                 (reverse xs empty))))
                             (begin
                               (write '(funapp 1436 67))
                               (display "\n")
                               (car x7863)))
                            0))))
                       g7860))))
                                  ...
                                  ((x7878
                                    (letrec*
                                     ...
                                     (begin
                                       ...
                                       (f7334 x7879)))))
                                  (begin
                                    (write '(funapp 1480 33))
                                    (display "\n")
                                    (integer?/c j7332 k7333 x7878)))))
                               g7877))))
                          g7876))
                       (begin (write '(funapp 1483 21)) (display "\n") 'module)
                       (begin
