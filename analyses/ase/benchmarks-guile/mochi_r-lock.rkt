                      ...
                      (if x-cnd8166
                        ...
                        (letrec*
                         ...
                         (begin
                           ...
                           (gcd b x8167)))))))
                   g8165)))
               (lock (lambda (st) (letrec* ((g8168 1)) g8168)))
               (unlock (lambda (st) (letrec* ((g8169 0)) g8169)))
               (f
                (lambda (n st)
                  (letrec*
                   ((g8170
                       ...
                       (letrec*
                        ((x8178
                          (letrec*
                           ((xj7623
                             (begin
                               (write '(funapp 1501 33))
                               (display "\n")
                               (loc
                                (begin
                                  (write '(funapp 1501 37))
                                  (display "\n")
                                  'module))))
                            (xk7624
                             (begin
                               ...
                               (loc
                                (begin
                                  (write '(funapp 1501 60))
                                  (display "\n")
                                  'importer)))))
                           (letrec*
                            ((g8179
                              (begin
                                (write '(funapp 1504 27))
                                (display "\n")
                                            ...
                                            ((x8182
                                              (letrec*
                                               ...
                                               (begin
                                                 ...
                                                 (f7628 x8183)))))
                                            (begin
                                              (write '(funapp 1516 39))
                                              (display "\n")
                                              ((lambda (g7632 g7633 g7634)
                                                 (letrec*
                                                  ((g8184
                                                    (letrec*
                                                     ((x-cnd8185
