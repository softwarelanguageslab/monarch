            ...
            (g7442
             (letrec*
                      ...
                      (if x-cnd8009
                        ...
                        (letrec*
                         ...
                         (begin
                           ...
                           (gcd b x8010)))))))
                   g8008)))
               (lock (lambda (st) (letrec* ((g8011 1)) g8011)))
               (unlock (lambda (st) (letrec* ((g8012 0)) g8012)))
               (f
                (lambda (n st)
                  (letrec*
                   ((g8013
              ...
              (letrec*
               ((g8019
                 (begin
                   (write '(funapp 1722 18))
                   (display "\n")
                   (parallel
                    (begin
                      (write '(funapp 1723 19))
                      (display "\n")
                      (parallel
                       (letrec*
                        ((x8021
