            ...
            (g7419
             (letrec*
                      ...
                      (if x-cnd7985
                        ...
                        (letrec*
                         ...
                         (begin
                           ...
                           (gcd b x7986)))))))
                   g7984)))
               (lock (lambda (st) (letrec* ((g7987 1)) g7987)))
               (unlock (lambda (st) (letrec* ((g7988 0)) g7988)))
               (f
                (lambda (n st)
                  (letrec*
                   ((g7989
              ...
              (letrec*
               ((g7995
                 (begin
                   (write '(funapp 1681 18))
                   (display "\n")
                   (parallel
                    (begin
                      (write '(funapp 1682 19))
                      (display "\n")
                      (parallel
                       (letrec*
                        ((x7997
                          (letrec*
                           ((xj7394
                             (begin
                               (write '(funapp 1686 33))
                               (display "\n")
                               (loc
                                (begin
                                  (write '(funapp 1686 37))
                                  (display "\n")
                                  'module))))
                            (xk7395
                             (begin
