                      ...
                      (parallel
                       (letrec*
                        ((xj7397
                         ...
                         (xk7398
                          (begin
                            (write '(funapp 1677 53))
                            (display "\n")
                            (loc
                             (begin
                               (write '(funapp 1677 57))
                               (display "\n")
                               'importer)))))
                        (letrec*
                         ((g7992
                           (begin
                             (write '(funapp 1680 24))
                             (display "\n")
                                          ...
                                          ((g7995
                                            (letrec*
                                             ((x7997
                                              ...
                                              (x7996
                                               (begin
                                                 (write '(funapp 1700 48))
                                                 (display "\n")
                                                 (f7402 x7403))))
                                             (begin
                                               (write '(funapp 1701 40))
                                               (display "\n")
                                               (x7997 j7400 k7401 x7996)))))
                                          g7995))))
                                      g7994))))
                                 g7993))
                              xj7397
