                                    ...
                                    (letrec*
                                     ((x7871
                                       (letrec*
                                        ((x7872
                                          (begin
                                            (write '(funapp 1430 47))
                                            (display "\n")
                                            (listof any/c))))
                                        (begin
                                          (write '(funapp 1431 39))
                                          (display "\n")
                                          (x7872 j7328 k7329 g7327)))))
                                     (begin
                                       (write '(funapp 1432 36))
                                       (display "\n")
                                       (f7330 x7871)))))
                                  (begin
                                    (write '(funapp 1433 33))
                                    (display "\n")
                                    (x7873 j7328 k7329 x7870)))))
                               g7869))))
                          g7868))
                       (begin (write '(funapp 1436 21)) (display "\n") 'module)
                       (begin
