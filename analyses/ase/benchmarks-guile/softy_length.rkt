                                       ...
                                       (letrec*
                                        ((x7865
                                          (begin
                                            ...
                                            (listof any/c))))
                                        (begin
                                          (write '(funapp 1447 39))
                                          (display "\n")
                                          (x7865 j7329 k7330 g7328)))))
                                     (begin
                                       (write '(funapp 1448 36))
                                       (display "\n")
                                       (f7331 x7864)))))
                                  (begin
                                    (write '(funapp 1449 33))
                                    (display "\n")
                                    (x7866 j7329 k7330 x7863)))))
                               g7862))))
                          g7861))
                       (begin (write '(funapp 1452 21)) (display "\n") 'module)
                       (begin
