                                   ...
                                   (letrec*
                                    ((x7852
                                      (letrec*
                                       ((x7853
                                         (begin
                                           (write '(funapp 1374 46))
                                           (display "\n")
                                           (>=/c 0))))
                                       (begin
                                         (write '(funapp 1375 38))
                                         (display "\n")
                                         (and/c integer?/c x7853))))
                                     (x7849
                                      (letrec*
                                       ((x7850
                                         (letrec*
                                          ((x7851
                                            (begin
                                              (write '(funapp 1380 49))
                                              (display "\n")
                                              (listof any/c))))
                                          (begin
                                            (write '(funapp 1381 41))
                                            (display "\n")
                                            (x7851 j7328 k7329 g7327)))))
                                       (begin
                                         (write '(funapp 1382 38))
                                         (display "\n")
                                         (f7330 x7850)))))
                                    (begin
                                      (write '(funapp 1383 35))
                                      (display "\n")
                                      (x7852 j7328 k7329 x7849)))))
                                 g7848))))
                            g7847))
                         (begin
