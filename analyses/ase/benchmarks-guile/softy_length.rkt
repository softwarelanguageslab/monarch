                                        ...
                                        (letrec*
                                         ((x7904
                                           (begin
                                             ...
                                             (>=/c 0))))
                                         (begin
                                           (write '(funapp 1502 40))
                                           (display "\n")
                                           (and/c integer?/c x7904))))
                                       (x7900
                                        (letrec*
                                         ((x7901
                                           (letrec*
                                            ((x7902
                                              (begin
                                                (write '(funapp 1507 51))
                                                (display "\n")
                                                (listof any/c))))
                                            (begin
                                              (write '(funapp 1508 43))
                                              (display "\n")
                                              (x7902 j7352 k7353 g7351)))))
                                         (begin
