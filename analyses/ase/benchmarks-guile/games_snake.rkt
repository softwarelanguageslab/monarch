    ...
    (nonzero?
     (lambda (v)
       (letrec*
        ((g7462
          (letrec*
           ((x7463 (begin (write '(funapp 38 42)) (display "\n") (= v 0))))
      ...
      (letrec*
       ((g7465
         (letrec*
                       ...
                       (letrec*
                        ((val7245
                          (begin
                            ...
                            (display "\n")
                            (= x y))))
                        (letrec* ((g7471 (if val7245 val7245 #f))) g7471)))))
                   g7470))))
               g7468)))
           (<=
            (lambda (x y)
                       ...
                       (letrec*
                        ((val7247
                          (begin
                            ...
                            (display "\n")
                            (= x y))))
                        (letrec* ((g7476 (if val7247 val7247 #f))) g7476)))))
                   g7475))))
               g7473)))
           (>
            (lambda (x y)
          ...
          (letrec*
           ((g7481 (begin (write '(funapp 101 19)) (display "\n") '()))
            (g7482
             (letrec*
              ((empty (begin (write '(funapp 104 22)) (display "\n") '()))
                     ...
                     (letrec*
                      ((x-cnd7493
                        (begin
                          (write '(funapp 148 25))
                          (display "\n")
                          ((lambda (v) (letrec* ((g7494 #t)) g7494)) g7277))))
                      (if x-cnd7493
                        g7277
                        (begin
                     ...
                     (letrec*
                      ((x-cnd7496
                        (begin
                          (write '(funapp 157 25))
                          (display "\n")
                          ((lambda (v) (letrec* ((g7497 #t)) g7497)) g7280))))
                      (if x-cnd7496
                        g7280
                        (begin
                   ...
                   ((g7542
                     (lambda (g7311 g7312 g7313)
                       (letrec*
                        ...
                        g7543))))
                   g7542)))
               (meta (lambda (v) (letrec* ((g7546 v)) g7546)))
               (+
                (letrec*
                 ((xj7314
               ...
               (ref-set set-car!)
               (void (lambda () (letrec* ((g7724 #f)) g7724)))
               (cddr
                (lambda (x)
                  (letrec*
                   ((g7725
                         ...
                         (if x-cnd7941
                           ...
                           (letrec*
                            ...
                            (begin
                              ...
                              (assq k x7943)))))))))
                   g7938)))
               (not (lambda (x) (letrec* ((g7944 (if x #f #t))) g7944)))
               (__toplevel_append
                (lambda (l1 l2)
                  (letrec*
                   ((g7945
                   ...
                   ((g8014
                     (letrec*
                      ...
                      (begin
                        ...
                        (car x8015)))))
                   g8014)))
               (newline (lambda () (letrec* ((g8018 #f)) g8018)))
               (lcm
                (lambda (m n)
                  (letrec*
                   ((g8019
                      ...
                      ((x8204
                        (letrec*
                         ...
                         (begin
                           ...
                           (display "\n")
                           (snake-change-direction x8205 dir))))
                       (x8203
                        (begin
                       ...
                       (x8227
                        (letrec*
                         ...
                         (begin
                           ...
                           (display "\n")
                           (food+scene x8228 BACKGROUND)))))
                      (begin
                        (write '(funapp 2266 23))
                        (display "\n")
                        (snake+scene x8229 x8227)))))
                   g8226)))
               (food+scene
                (lambda (f scn)
                  (letrec*
                   ((g8230
                     (letrec*
                      ...
                      (begin
                        ...
                        (display "\n")
                        (place-image-on-grid FOOD-IMAGE x8232 x8231 scn)))))
                   g8230)))
               (place-image-on-grid
                (lambda (img x y scn)
                  (letrec*
                       ...
                       (x8234
                        (letrec*
                         ...
                         (begin
                           ...
                           (display "\n")
                           (- BOARD-HEIGHT-PIXELS x8235)))))
                      (begin
                        (write '(funapp 2286 23))
                        (display "\n")
                        (place-image img x8236 x8234 scn)))))
                   g8233)))
               (snake+scene
                (lambda (snk scn)
                  (letrec*
                             ...
                             (x8243
                              (letrec*
                               ...
                               (begin
                                 ...
                                 (display "\n")
                                 (segment+scene x8244 scn)))))
                            (begin
                              (write '(funapp 2312 29))
                              (display "\n")
                              (segments+scene x8245 x8243)))))
                         g8242)))))
                   g8239)))
               (segment+scene
                (lambda (seg scn)
                   ...
                   ((g8246
                     (letrec*
                      ...
                      (begin
                        ...
                        (display "\n")
                        (place-image-on-grid SEGMENT-IMAGE x8248 x8247 scn)))))
                   g8246))))
              (letrec*
               ((g8249
                 (begin
                       ...
                       (letrec*
                        ((xj7430
                          (begin
                            ...
                            (loc
                             (begin
                               (write '(funapp 2328 34))
                               (display "\n")
                               'module))))
                         (xk7431
                          (begin
                            (write '(funapp 2328 53))
                            (display "\n")
                            (loc
                             (begin
                               (write '(funapp 2328 57))
                               (display "\n")
                               'importer)))))
                        (letrec*
                         ((g8250
                           (begin
                             (write '(funapp 2330 30))
                             (display "\n")
                             (real?/c xj7430 xk7431 GRID-SIZE))))
                         g8250))
                       (letrec*
                        ((xj7432
                          (begin
                            (write '(funapp 2333 30))
                            (display "\n")
                            (loc
                             (begin
                               (write '(funapp 2333 34))
                               (display "\n")
                               'module))))
                         (xk7433
                          (begin
                            (write '(funapp 2333 53))
                            (display "\n")
                            (loc
                             (begin
                               (write '(funapp 2333 57))
                               (display "\n")
                               'importer)))))
                        (letrec*
                         ((g8251
                           (begin
                             (write '(funapp 2335 30))
                             (display "\n")
                             (real?/c xj7432 xk7433 BOARD-HEIGHT-PIXELS))))
                         g8251))
                       (letrec*
                        ((xj7434
                          (begin
                            (write '(funapp 2338 30))
                            (display "\n")
                            (loc
                             (begin
                         ...
                         (xk7435
                          (begin
                            (write '(funapp 2338 53))
                            (display "\n")
                            (loc
                             (begin
                               (write '(funapp 2338 57))
                               (display "\n")
                               'importer)))))
                        (letrec*
                         ((g8252
                           (begin
                             ...
                             (display "\n")
                             (real?/c xj7434 xk7435 BOARD-WIDTH))))
                         g8252))
                       (letrec*
                        ((xj7436
                          (begin
                            (write '(funapp 2343 30))
                            (display "\n")
                            (loc
                             (begin
                               (write '(funapp 2343 34))
                               (display "\n")
                               'module))))
                         (xk7437
                          (begin
                            (write '(funapp 2343 53))
                            (display "\n")
                            (loc
                             (begin
                               (write '(funapp 2343 57))
                               (display "\n")
                               'importer)))))
                        (letrec*
                         ((g8253
                           (begin
                             (write '(funapp 2345 30))
                             (display "\n")
                             (real?/c xj7436 xk7437 BOARD-HEIGHT))))
                         g8253))))))))
               g8249))))
           g7482))))
       g7465)))
