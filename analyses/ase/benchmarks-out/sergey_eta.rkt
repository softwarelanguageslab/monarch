(letrec ((any? (lambda (v) (letrec ((g7397 #t)) g7397)))
                      ...
                      (letrec ((g7400
                                (letrec ((x-e7401 lst))
                                  (match
                                   ...
                                   ((() #f)
                                    ((pair v1 vs)
                                     (letrec ((x-cnd7402 (eq? v v1)))
                                       (if x-cnd7402 #t (member v vs)))))))))
                        g7400)))
              g7399)))
         (unconstrained/c #f)
         (actor?
         ...
         (nonzero?
          (lambda (v)
            (letrec ((g7405 (letrec ((x7406 (= v 0))) (not x7406)))) g7405))))
  (letrec ((g7407
            (letrec ((g7408
                      (letrec ((assert
                                (lambda (cnd)
                        ...
                        (letrec ((g7424 '())
                                 (g7425
                                  (letrec ((empty '())
                                           ...
                                           (do-something
                                            (lambda ()
                                              (letrec ((g7980 10)) g7980)))
                                           (id
                                            (lambda (y)
                                              (letrec ((g7981 (do-something))
                                                       (g7982 y))
                                                g7982))))
                                    (letrec ((g7983
                                              (letrec ((x7985
