                        ...
                        (letrec ((g7420 '())
                                 (g7421
                                  (letrec ((empty '())
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g7882 (if x #f #t)))
                                                g7882)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g7883 (append l1 l2)))
                                                g7883)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g7884
                                           ...
                                           (do-something
                                            (lambda ()
                                              (letrec ((g7975 10)) g7975)))
                                           (id
                                            (lambda (y)
                                              (letrec ((g7976 (do-something))
                                                       (g7977 y))
                                                g7977))))
                                    (letrec ((g7978
                                              (letrec ((x7980
