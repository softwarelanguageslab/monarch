(letrec ((any? (lambda (v) (letrec ((g7647 #t)) g7647)))
                      ...
                      (letrec ((g7650
                                (letrec ((x-e7651 lst))
                                  (match
                                   ...
                                   ((() #f)
                                    ((pair v1 vs)
                                     (letrec ((x-cnd7652 (eq? v v1)))
                                       (if x-cnd7652 #t (member v vs)))))))))
                        g7650)))
              g7649)))
         (unconstrained/c #f)
         (actor?
         ...
         (nonzero?
          (lambda (v)
            (letrec ((g7655 (letrec ((x7656 (= v 0))) (not x7656)))) g7655))))
  (letrec ((g7657
            (letrec ((g7658
                      (letrec ((orig-+ +)
                               (orig-- -)
                        ...
                        (letrec ((g7659 '())
                                 (g7660
                                  (letrec ((empty '())
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g8083 (if x #f #t)))
                                                g8083)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g8084 (append l1 l2)))
                                                g8084)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g8085
