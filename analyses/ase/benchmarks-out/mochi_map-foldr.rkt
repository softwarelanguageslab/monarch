(letrec ((any? (lambda (v) (letrec ((g7422 #t)) g7422)))
                      ...
                      (letrec ((g7425
                                (letrec ((x-e7426 lst))
                                  (match
                                   ...
                                   ((() #f)
                                    ((pair v1 vs)
                                     (letrec ((x-cnd7427 (eq? v v1)))
                                       (if x-cnd7427 #t (member v vs)))))))))
                        g7425)))
              g7424)))
         (unconstrained/c #f)
         (actor?
         ...
         (nonzero?
          (lambda (v)
            (letrec ((g7430 (letrec ((x7431 (= v 0))) (not x7431)))) g7430))))
  (letrec ((g7432
            (letrec ((g7433
                      (letrec ((assert
                                (lambda (cnd)
