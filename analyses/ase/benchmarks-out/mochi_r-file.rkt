(letrec ((any? (lambda (v) (letrec ((g7342 #t)) g7342)))
                      ...
                      (letrec ((g7345
                                (letrec ((x-e7346 lst))
                                  (match
                                   ...
                                   ((() #f)
                                    ((pair v1 vs)
                                     (letrec ((x-cnd7347 (eq? v v1)))
                                       (if x-cnd7347 #t (member v vs)))))))))
                        g7345)))
              g7344)))
         (unconstrained/c #f)
         (actor?
         ...
         (nonzero?
          (lambda (v)
            (letrec ((g7350 (letrec ((x7351 (= v 0))) (not x7351)))) g7350))))
  (letrec ((g7352
            (letrec ((g7353
                      (letrec ((orig-+ +)
                               (orig-- -)
                        ...
                        (letrec ((g7354 '())
                                 (g7355
                                  (letrec ((empty '())
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g7769 (if x #f #t)))
                                                g7769)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g7770 (append l1 l2)))
                                                g7770)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g7771
