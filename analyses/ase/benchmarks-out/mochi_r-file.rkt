                        ...
                        (letrec ((g7442 '())
                                 (g7443
                                  (letrec ((empty '())
                                           ...
                                           (string=?
                                            (lambda (s1 s2)
                                              (letrec ((g7698 (bool-top)))
                                                g7698)))
                                           ($pc '())
                                           (ref-set set-car!)
                                           (void
                                            (lambda ()
                                              (letrec ((g7699 #f)) g7699)))
                                           (cddr
                                            (lambda (x)
                                              (letrec ((g7700
                                                        (letrec ((x7701
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g7919 (if x #f #t)))
                                                g7919)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g7920 (append l1 l2)))
                                                g7920)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g7921
