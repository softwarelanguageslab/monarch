(letrec ((any? (lambda (v) (letrec ((g7635 #t)) g7635)))
                      ...
                      (letrec ((g7638
                                (letrec ((x-e7639 lst))
                                  (match
                                   ...
                                   ((() #f)
                                    ((pair v1 vs)
                                     (letrec ((x-cnd7640 (eq? v v1)))
                                       (if x-cnd7640 #t (member v vs)))))))))
                        g7638)))
              g7637)))
         (unconstrained/c #f)
         (actor?
         ...
         (nonzero?
          (lambda (v)
            (letrec ((g7643 (letrec ((x7644 (= v 0))) (not x7644)))) g7643))))
  (letrec ((g7645
            (letrec ((g7646
                      (letrec ((orig-+ +)
                               (orig-- -)
                        ...
                        (letrec ((g7647 '())
                                 (g7648
                                  (letrec ((empty '())
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g8071 (if x #f #t)))
                                                g8071)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g8072 (append l1 l2)))
                                                g8072)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g8073
                                           ...
                                           (lock
                                            (lambda (st)
                                              (letrec ((g8168 1)) g8168)))
                                           (unlock
                                            (lambda (st)
                                              (letrec ((g8169 0)) g8169)))
                                           (f
                                            (lambda (n st)
                                              (letrec ((g8170
                                                        (letrec ((x-cnd8171
