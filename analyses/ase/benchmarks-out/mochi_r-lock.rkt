                        ...
                        (letrec ((g7349 '())
                                 (g7350
                                  (letrec ((empty '())
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g7749 (if x #f #t)))
                                                g7749)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g7750 (append l1 l2)))
                                                g7750)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g7751
                                           ...
                                           (lock
                                            (lambda (st)
                                              (letrec ((g7846 1)) g7846)))
                                           (unlock
                                            (lambda (st)
                                              (letrec ((g7847 0)) g7847)))
                                           (f
                                            (lambda (n st)
                                              (letrec ((g7848
                                                        (letrec ((x-cnd7849
