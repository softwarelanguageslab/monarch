                        ...
                        (letrec ((g7353 '())
                                 (g7354
                                  (letrec ((empty '())
                                           ...
                                           (lock
                                            (lambda (st)
                                              (letrec ((g7865 1)) g7865)))
                                           (unlock
                                            (lambda (st)
                                              (letrec ((g7866 0)) g7866)))
                                           (f
                                            (lambda (n st)
                                              (letrec ((g7867
                                                        (letrec ((x-cnd7868
