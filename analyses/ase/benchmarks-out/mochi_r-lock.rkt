                        ...
                        (letrec ((g7441 '())
                                 (g7442
                                  (letrec ((empty '())
                                           ...
                                           (string=?
                                            (lambda (s1 s2)
                                              (letrec ((g7696 (bool-top)))
                                                g7696)))
                                           ($pc '())
                                           (ref-set set-car!)
                                           (void
                                            (lambda ()
                                              (letrec ((g7697 #f)) g7697)))
                                           (cddr
                                            (lambda (x)
                                              (letrec ((g7698
                                                        (letrec ((x7699
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g7917 (if x #f #t)))
                                                g7917)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g7918 (append l1 l2)))
                                                g7918)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g7919
                                           ...
                                           (lock
                                            (lambda (st)
                                              (letrec ((g8010 1)) g8010)))
                                           (unlock
                                            (lambda (st)
                                              (letrec ((g8011 0)) g8011)))
                                           (f
                                            (lambda (n st)
                                              (letrec ((g8012
                                                        (letrec ((x-cnd8013
