(letrec ((any? (lambda (v) (letrec ((g7793 #t)) g7793)))
                      ...
                      (letrec ((g7796
                                (letrec ((x-e7797 lst))
                                  (match
                                   ...
                                   ((() #f)
                                    ((pair v1 vs)
                                     (letrec ((x-cnd7798 (eq? v v1)))
                                       (if x-cnd7798 #t (member v vs)))))))))
                        g7796)))
              g7795)))
         (unconstrained/c #f)
         (actor?
         ...
         (nonzero?
          (lambda (v)
            (letrec ((g7801 (letrec ((x7802 (= v 0))) (not x7802)))) g7801))))
  (letrec ((g7803
            (letrec ((g7804
                      (letrec ((orig-+ +)
                               (orig-- -)
                        ...
                        (letrec ((g7805 '())
                                 (g7806
                                  (letrec ((empty '())
                                           ...
                                           (meta
                                            (lambda (v)
                                              (letrec ((g7848 v)) g7848)))
                                           (+
                                            (letrec ((xj7567 'server)
                                                     (xk7568 'client))
                                              (letrec ((g7849
                                                        ((lambda (j7571
                                                                  k7572
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g8229 (if x #f #t)))
                                                g8229)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g8230 (append l1 l2)))
                                                g8230)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g8231
