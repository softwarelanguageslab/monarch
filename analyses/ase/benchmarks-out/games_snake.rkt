(letrec ((any? (lambda (v) (letrec ((g7519 #t)) g7519)))
                      ...
                      (letrec ((g7522
                                (letrec ((x-e7523 lst))
                                  (match
                                   ...
                                   ((() #f)
                                    ((pair v1 vs)
                                     (letrec ((x-cnd7524 (eq? v v1)))
                                       (if x-cnd7524 #t (member v vs)))))))))
                        g7522)))
              g7521)))
         (unconstrained/c #f)
         (actor?
         ...
         (nonzero?
          (lambda (v)
            (letrec ((g7527 (letrec ((x7528 (= v 0))) (not x7528)))) g7527))))
  (letrec ((g7529
            (letrec ((g7530
                      (letrec ((orig-+ +)
                               (orig-- -)
                        ...
                        (letrec ((g7531 '())
                                 (g7532
                                  (letrec ((empty '())
                                           ...
                                           (meta
                                            (lambda (v)
                                              (letrec ((g7574 v)) g7574)))
                                           (+
                                            (letrec ((xj7293 'server)
                                                     (xk7294 'client))
                                              (letrec ((g7575
                                                        ((lambda (j7297
                                                                  k7298
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g7955 (if x #f #t)))
                                                g7955)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g7956 (append l1 l2)))
                                                g7956)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g7957
