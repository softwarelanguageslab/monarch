                        ...
                        (letrec ((g7444 '())
                                 (g7445
                                  (letrec ((empty '())
                                           ...
                                           (string=?
                                            (lambda (s1 s2)
                                              (letrec ((g7700 (bool-top)))
                                                g7700)))
                                           ($pc '())
                                           (ref-set set-car!)
                                           (void
                                            (lambda ()
                                              (letrec ((g7701 #f)) g7701)))
                                           (cddr
                                            (lambda (x)
                                              (letrec ((g7702
                                                        (letrec ((x7703
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g7921 (if x #f #t)))
                                                g7921)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g7922 (append l1 l2)))
                                                g7922)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g7923
