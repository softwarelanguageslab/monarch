(letrec ((any? (lambda (v) (letrec ((g7653 #t)) g7653)))
                      ...
                      (letrec ((g7656
                                (letrec ((x-e7657 lst))
                                  (match
                                   ...
                                   ((() #f)
                                    ((pair v1 vs)
                                     (letrec ((x-cnd7658 (eq? v v1)))
                                       (if x-cnd7658 #t (member v vs)))))))))
                        g7656)))
              g7655)))
         (unconstrained/c #f)
         (actor?
         ...
         (nonzero?
          (lambda (v)
            (letrec ((g7661 (letrec ((x7662 (= v 0))) (not x7662)))) g7661))))
  (letrec ((g7663
            (letrec ((g7664
                      (letrec ((assert
                                (lambda (cnd)
                        ...
                        (letrec ((g7680 '())
                                 (g7681
                                  (letrec ((empty '())
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g8143 (if x #f #t)))
                                                g8143)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g8144 (append l1 l2)))
                                                g8144)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g8145
