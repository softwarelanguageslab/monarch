                        ...
                        (letrec ((g7684 '())
                                 (g7685
                                  (letrec ((empty '())
                                           ...
                                           (string=?
                                            (lambda (s1 s2)
                                              (letrec ((g7940 (bool-top)))
                                                g7940)))
                                           ($pc '())
                                           (ref-set set-car!)
                                           (void
                                            (lambda ()
                                              (letrec ((g7941 #f)) g7941)))
                                           (cddr
                                            (lambda (x)
                                              (letrec ((g7942
                                                        (letrec ((x7943
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g8161 (if x #f #t)))
                                                g8161)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g8162 (append l1 l2)))
                                                g8162)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g8163
