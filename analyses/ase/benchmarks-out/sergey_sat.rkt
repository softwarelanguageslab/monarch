                        ...
                        (letrec ((g7340 '())
                                 (g7341
                                  (letrec ((empty '())
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g7740 (if x #f #t)))
                                                g7740)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g7741 (append l1 l2)))
                                                g7741)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g7742
