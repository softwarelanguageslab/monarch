                        ...
                        (letrec ((g7433 '())
                                 (g7434
                                  (letrec ((empty '())
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g7896 (if x #f #t)))
                                                g7896)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g7897 (append l1 l2)))
                                                g7897)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g7898
