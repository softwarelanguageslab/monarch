                        ...
                        (letrec ((g7437 '())
                                 (g7438
                                  (letrec ((empty '())
                                           ...
                                           (string=?
                                            (lambda (s1 s2)
                                              (letrec ((g7693 (bool-top)))
                                                g7693)))
                                           ($pc '())
                                           (ref-set set-car!)
                                           (void
                                            (lambda ()
                                              (letrec ((g7694 #f)) g7694)))
                                           (cddr
                                            (lambda (x)
                                              (letrec ((g7695
                                                        (letrec ((x7696
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g7914 (if x #f #t)))
                                                g7914)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g7915 (append l1 l2)))
                                                g7915)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g7916
