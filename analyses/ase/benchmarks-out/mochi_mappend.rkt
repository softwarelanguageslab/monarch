                        ...
                        (letrec ((g7447 '())
                                 (g7448
                                  (letrec ((empty '())
                                           ...
                                           (string=?
                                            (lambda (s1 s2)
                                              (letrec ((g7703 (bool-top)))
                                                g7703)))
                                           ($pc '())
                                           (ref-set set-car!)
                                           (void
                                            (lambda ()
                                              (letrec ((g7704 #f)) g7704)))
                                           (cddr
                                            (lambda (x)
                                              (letrec ((g7705
                                                        (letrec ((x7706
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g7924 (if x #f #t)))
                                                g7924)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g7925 (append l1 l2)))
                                                g7925)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g7926
