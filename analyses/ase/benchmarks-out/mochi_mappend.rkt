(letrec ((any? (lambda (v) (letrec ((g7641 #t)) g7641)))
                      ...
                      (letrec ((g7644
                                (letrec ((x-e7645 lst))
                                  (match
                                   ...
                                   ((() #f)
                                    ((pair v1 vs)
                                     (letrec ((x-cnd7646 (eq? v v1)))
                                       (if x-cnd7646 #t (member v vs)))))))))
                        g7644)))
              g7643)))
         (unconstrained/c #f)
         (actor?
         ...
         (nonzero?
          (lambda (v)
            (letrec ((g7649 (letrec ((x7650 (= v 0))) (not x7650)))) g7649))))
  (letrec ((g7651
            (letrec ((g7652
                      (letrec ((orig-+ +)
                               (orig-- -)
                        ...
                        (letrec ((g7653 '())
                                 (g7654
                                  (letrec ((empty '())
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g8077 (if x #f #t)))
                                                g8077)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g8078 (append l1 l2)))
                                                g8078)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g8079
