(letrec ((any? (lambda (v) (letrec ((g7640 #t)) g7640)))
                      ...
                      (letrec ((g7643
                                (letrec ((x-e7644 lst))
                                  (match
                                   ...
                                   ((() #f)
                                    ((pair v1 vs)
                                     (letrec ((x-cnd7645 (eq? v v1)))
                                       (if x-cnd7645 #t (member v vs)))))))))
                        g7643)))
              g7642)))
         (unconstrained/c #f)
         (actor?
         ...
         (nonzero?
          (lambda (v)
            (letrec ((g7648 (letrec ((x7649 (= v 0))) (not x7649)))) g7648))))
  (letrec ((g7650
            (letrec ((g7651
                      (letrec ((orig-+ +)
                               (orig-- -)
