(letrec ((any? (lambda (v) (letrec ((g7593 #t)) g7593)))
                        ...
                        (letrec ((g7605 '())
                                 (g7606
                                  (letrec ((empty '())
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g8005 (if x #f #t)))
                                                g8005)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g8006 (append l1 l2)))
                                                g8006)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g8007
