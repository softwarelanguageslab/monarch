(letrec ((any? (lambda (v) (letrec ((g7773 #t)) g7773)))
                      ...
                      (letrec ((g7776
                                (letrec ((x-e7777 lst))
                                  (match
                                   ...
                                   ((() #f)
                                    ((pair v1 vs)
                                     (letrec ((x-cnd7778 (eq? v v1)))
                                       (if x-cnd7778 #t (member v vs)))))))))
                        g7776)))
              g7775)))
         (unconstrained/c #f)
         (actor?
         ...
         (nonzero?
          (lambda (v)
            (letrec ((g7781 (letrec ((x7782 (= v 0))) (not x7782)))) g7781))))
  (letrec ((g7783
            (letrec ((g7784
                      (letrec ((assert
                                (lambda (cnd)
                        ...
                        (letrec ((g7800 '())
                                 (g7801
                                  (letrec ((empty '())
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g8263 (if x #f #t)))
                                                g8263)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g8264 (append l1 l2)))
                                                g8264)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g8265
