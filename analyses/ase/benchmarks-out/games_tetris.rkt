                        ...
                        (letrec ((g7605 '())
                                 (g7606
                                  (letrec ((empty '())
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g8026 (if x #f #t)))
                                                g8026)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g8027 (append l1 l2)))
                                                g8027)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g8028
