(letrec ((any? (lambda (v) (letrec ((g7634 #t)) g7634)))
                      ...
                      (letrec ((g7637
                                (letrec ((x-e7638 lst))
                                  (match
                                   ...
                                   ((() #f)
                                    ((pair v1 vs)
                                     (letrec ((x-cnd7639 (eq? v v1)))
                                       (if x-cnd7639 #t (member v vs)))))))))
                        g7637)))
              g7636)))
         (unconstrained/c #f)
         (actor?
         ...
         (nonzero?
          (lambda (v)
            (letrec ((g7642 (letrec ((x7643 (= v 0))) (not x7643)))) g7642))))
  (letrec ((g7644
            (letrec ((g7645
                      (letrec ((orig-+ +)
                               (orig-- -)
                        ...
                        (letrec ((g7646 '())
                                 (g7647
                                  (letrec ((empty '())
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g8070 (if x #f #t)))
                                                g8070)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g8071 (append l1 l2)))
                                                g8071)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g8072
