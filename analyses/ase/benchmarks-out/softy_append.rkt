(letrec ((any? (lambda (v) (letrec ((g7401 #t)) g7401)))
                      ...
                      (letrec ((g7404
                                (letrec ((x-e7405 lst))
                                  (match
                                   ...
                                   ((() #f)
                                    ((pair v1 vs)
                                     (letrec ((x-cnd7406 (eq? v v1)))
                                       (if x-cnd7406 #t (member v vs)))))))))
                        g7404)))
              g7403)))
         (unconstrained/c #f)
         (actor?
         ...
         (nonzero?
          (lambda (v)
            (letrec ((g7409 (letrec ((x7410 (= v 0))) (not x7410)))) g7409))))
  (letrec ((g7411
            (letrec ((g7412
                      (letrec ((orig-+ +)
                               (orig-- -)
                        ...
                        (letrec ((g7413 '())
                                 (g7414
                                  (letrec ((empty '())
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g7885 (if x #f #t)))
                                                g7885)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g7886 (append l1 l2)))
                                                g7886)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g7887
