(letrec ((any? (lambda (v) (letrec ((g7628 #t)) g7628)))
                      ...
                      (letrec ((g7631
                                (letrec ((x-e7632 lst))
                                  (match
                                   ...
                                   ((() #f)
                                    ((pair v1 vs)
                                     (letrec ((x-cnd7633 (eq? v v1)))
                                       (if x-cnd7633 #t (member v vs)))))))))
                        g7631)))
              g7630)))
         (unconstrained/c #f)
         (actor?
         ...
         (nonzero?
          (lambda (v)
            (letrec ((g7636 (letrec ((x7637 (= v 0))) (not x7637)))) g7636))))
  (letrec ((g7638
            (letrec ((g7639
                      (letrec ((orig-+ +)
                               (orig-- -)
                        ...
                        (letrec ((g7640 '())
                                 (g7641
                                  (letrec ((empty '())
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g8064 (if x #f #t)))
                                                g8064)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g8065 (append l1 l2)))
                                                g8065)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g8066
