                        ...
                        (letrec ((g7429 '())
                                 (g7430
                                  (letrec ((empty '())
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g7892 (if x #f #t)))
                                                g7892)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g7893 (append l1 l2)))
                                                g7893)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g7894
