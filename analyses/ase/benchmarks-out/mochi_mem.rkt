(letrec ((any? (lambda (v) (letrec ((g7423 #t)) g7423)))
                      ...
                      (letrec ((g7426
                                (letrec ((x-e7427 lst))
                                  (match
                                   ...
                                   ((() #f)
                                    ((pair v1 vs)
                                     (letrec ((x-cnd7428 (eq? v v1)))
                                       (if x-cnd7428 #t (member v vs)))))))))
                        g7426)))
              g7425)))
         (unconstrained/c #f)
         (actor?
         ...
         (nonzero?
          (lambda (v)
            (letrec ((g7431 (letrec ((x7432 (= v 0))) (not x7432)))) g7431))))
  (letrec ((g7433
            (letrec ((g7434
                      (letrec ((assert
                                (lambda (cnd)
                        ...
                        (letrec ((g7450 '())
                                 (g7451
                                  (letrec ((empty '())
                                           ...
                                           (string=?
                                            (lambda (s1 s2)
                                              (letrec ((g7704 (bool-top)))
                                                g7704)))
                                           ($pc '())
                                           (ref-set set-car!)
                                           (void
                                            (lambda ()
                                              (letrec ((g7705 #f)) g7705)))
                                           (cddr
                                            (lambda (x)
                                              (letrec ((g7706
                                                        (letrec ((x7707
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g7925 (if x #f #t)))
                                                g7925)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g7926 (append l1 l2)))
                                                g7926)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g7927
