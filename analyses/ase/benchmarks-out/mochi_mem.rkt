                        ...
                        (letrec ((g7450 '())
                                 (g7451
                                  (letrec ((empty '())
                                           ...
                                           (string=?
                                            (lambda (s1 s2)
                                              (letrec ((g7705 (bool-top)))
                                                g7705)))
                                           ($pc '())
                                           (ref-set set-car!)
                                           (void
                                            (lambda ()
                                              (letrec ((g7706 #f)) g7706)))
                                           (cddr
                                            (lambda (x)
                                              (letrec ((g7707
                                                        (letrec ((x7708
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g7926 (if x #f #t)))
                                                g7926)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g7927 (append l1 l2)))
                                                g7927)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g7928
