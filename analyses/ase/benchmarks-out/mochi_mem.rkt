                        ...
                        (letrec ((g7446 '())
                                 (g7447
                                  (letrec ((empty '())
                                           ...
                                           (not
                                            (lambda (x)
                                              (letrec ((g7909 (if x #f #t)))
                                                g7909)))
                                           (__toplevel_append
                                            (lambda (l1 l2)
                                              (letrec ((g7910 (append l1 l2)))
                                                g7910)))
                                           (memq
                                            (lambda (e l)
                                              (letrec ((g7911
