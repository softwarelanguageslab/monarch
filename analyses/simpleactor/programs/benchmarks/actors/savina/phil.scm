...
(letrec ((N 3)
         ...
         (rounds M)
         (num-forks N)
         (counter-actor (behavior (n)
                               ((add (m) (become counter-actor (+ n m)))
                               (finish () (display n) (terminate)))))
         (arbitrator-actor (behavior (forks num-exited)
                                  ((hungry (p id)
         ...
         (philosopher-actor (behavior (id rounds-so-far local-counter)
                                   ((denied ()
                                           (displayln 'denied)
         ...
         (arbitrator (spawn arbitrator-actor
                             (vector #f #f #f)
                             0))
