        ...
        (letrec ((ping-behavior
                         ...
                         (parametrize
                          ((send^
                            (lambda (rcv7404 msg7405)
                              (old-send7407 kc7403 (pair rcv7404 msg7405)))))
                          (begin
                            (send^ sender (pair 'pong self^))
                 ...
                 (pong-behavior
                  (lambda ()
                    (receive
                     (((pair 'pong sender)
                       (begin (send^ sender (pair 'ping self^))))
                      ((pair
                        'enhanced
                         ...
                         (parametrize
                          ((send^
                            (lambda (rcv7411 msg7412)
                              (old-send7414 kc7410 (pair rcv7411 msg7412)))))
                          (begin
                            (old-send7414 kc7410 'finish)
                            (send^ sender (pair 'ping self^))))))))))
