                    ...
                    (letrec ((result10208
                      ...
                      (if result10208
                        ...
                        (blame
                         k10186
                         (position-in-file-loc
                          "programs/test/actor-cc/forward-flow.fail.rkt"
                          3
                          1)))))))
               (pick-service
                (lambda (services)
                     ...
                     (receive
                      (('main
                       ...
                       ((cons 'reply answer)
                        ...
                        (displayln answer)
                        (terminate))
                       ((cons 'enhanced (cons k10209 (cons j10213 'main)))
                        (letrec ((kc10210 (k10209 j10213))
                                 (old-send10214 (dyn send^)))
                          (parametrize
                           ((send^
                             (lambda (rcv10211 msg10212)
                               (old-send10214
                                kc10210
                                (cons rcv10211 msg10212)))))
                           (begin
                             (trace 'main)
                             (router (cons 'request (dyn self)))
                             (old-send10214 kc10210 'finish)
                             (client-behavior router)))))
                       ((cons
                         'enhanced
                         (cons k10215 (cons j10219 (cons 'reply answer))))
                        (letrec ((kc10216 (k10215 j10219))
                                 (old-send10220 (dyn send^)))
                          (parametrize
                           ((send^
                             (lambda (rcv10217 msg10218)
                               (old-send10220
                                kc10216
                                (cons rcv10217 msg10218)))))
                           (begin
                             (trace 'reply)
                             (displayln answer)
                             (old-send10220 kc10216 'finish)
                             (terminate)))))))))))
               (router-behavior
                (lambda (services)
                  (letrec ((real-self (self^)))
                    (parametrize
                     ...
                     (receive
                      (((cons 'request sender)
                       ...
                       ((cons
                         'enhanced
                         (cons k10221 (cons j10225 (cons 'request sender))))
                    ...
                    (parametrize
                     ...
                     (receive
                      (((cons 'request sender)
                       ...
                       ((cons
                         'enhanced
                         (cons k10227 (cons j10231 (cons 'request sender))))
                        (letrec ((kc10228 (k10227 j10231))
                          ...
                          (parametrize
                           ...
                           (begin
                             (trace 'request-in-service)
                             'do-work
                             (old-send10232 kc10228 'finish)
                             (service-behavior)))))
                       ((cons
                         'enhanced
                         (cons k10233 (cons j10237 (cons 'reply answer))))
                        (letrec ((kc10234 (k10233 j10237))
                          ...
                          (parametrize
                           ...
                           (begin
                             (trace 'reply-wrong)
                             (old-send10238 kc10234 'finish)
                             (service-behavior)))))))))))
               (service
                (letrec ((act (spawn^ (service-behavior))))
                  (lambda (msg) ((dyn send^) act msg))))
               (router
                (letrec ((xj10239 (loc 'client)) (xk10240 (loc 'server)))
                  (router/c
                   xj10239
                   xk10240
                   (letrec ((act
