...
parseFromString' :: Maybe String -> String -> Either String Exp
parseFromString' filename = fmap head . parseSexp' filename >=> compile
...
-- For ANF programs
compile ex@(Atom "letrec" _ ::: bds ::: e1 ::: SNil _) = do
   checkDuplicates bds
   Letrec <$> smapM compileBdn bds <*> compile e1 <*> pureSpan ex
